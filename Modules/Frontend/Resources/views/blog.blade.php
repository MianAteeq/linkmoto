...
<body>
  ...
  <div class="page-title-area">
    <img src="assets/img/home-one/footer-car.png" alt="Title" class="img-fluid w-100">
    <div class="container">
          ...
          <div class="blog-item h-100">
            <div class="blog-top">
              ...
              <a href="blog-details.html">
                <img src="assets/img/home-one/blog/1.jpg" alt="Blog" class="img-fluid w-100">
              </a>
            </div>
        ...
        <div class="col-sm-6 col-lg-4 mb-4">
          <div class="blog-item h-100">
            <div class="blog-top">
              ...
              <a href="blog-details.html">
                <img src="assets/img/home-one/blog/2.jpg" alt="Blog" class="img-fluid w-100">
              </a>
            </div>
            <div class="blog-bottom">
              <h3>
        ...
        <div class="col-sm-6 col-lg-4 mb-4">
          <div class="blog-item h-100">
            <div class="blog-top">
              ...
              <a href="blog-details.html">
                <img src="assets/img/home-one/blog/3.jpg" alt="Blog" class="img-fluid w-100">
              </a>
            </div>
            <div class="blog-bottom">
              <h3>
        ...
        <div class="col-sm-6 col-lg-4 mb-4">
          <div class="blog-item h-100">
            <div class="blog-top">
              ...
              <a href="blog-details.html">
                <img src="assets/img/home-one/blog/4.jpg" alt="Blog" class="img-fluid w-100">
              </a>
            </div>
            <div class="blog-bottom">
              <h3>
                <a href="blog-details.html">The demand of BMW is going high to buy</a>
              </h3>
              <ul>
                <li>
                  <img src="assets/img/home-one/blog/1.png" alt="Blog">
        ...
        <div class="col-sm-6 col-lg-4 mb-4">
          <div class="blog-item h-100">
            <div class="blog-top">
              ...
              <a href="blog-details.html">
                <img src="assets/img/home-one/blog/5.jpg" alt="Blog" class="img-fluid w-100">
              </a>
            </div>
            <div class="blog-bottom">
              <h3>
                <a href="blog-details.html">You can buy best cars from watching details</a>
              </h3>
              <ul>
                <li>
                  <img src="assets/img/home-one/blog/2.png" alt="Blog">
        ...
        <div class="col-sm-6 col-lg-4 mb-4">
          <div class="blog-item h-100">
            <div class="blog-top">
              ...
              <a href="blog-details.html">
                <img src="assets/img/home-one/blog/6.jpg" alt="Blog" class="img-fluid w-100">
              </a>
            </div>
            <div class="blog-bottom">
              <h3>
                <a href="blog-details.html">Nowadays car is being increased everywhere</a>
              </h3>
              <ul>
                <li>
                  <img src="assets/img/home-one/blog/1.png" alt="Blog">
  ...
  <footer class="footer-area-two pt-100">
    <div class="footer-img">
      <img src="assets/img/home-one/footer-car.png" alt="Footer" class="img-fluid">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-4 mb-lg-0">
          <div class="footer-item">
            <div class="footer-logo">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam nobis et praesentium architecto ex
                laudantium voluptates in dolore</p>
              <ul>
                <li>
      ...
      <div class="copyright-area">
        <div class="row align-items-center">
          <div class="col-lg-7 text-center text-lg-left mb-3 mb-lg-0">
            <div class="copyright-item">
              <p class="mb-0">Copyright @<script>
                document.write(new Date().getFullYear())
                </script> Audeck. Designed By <a href="https://hibootstrap.com/" target="_blank">HiBootstrap</a></p>
            </div>
          </div>
          <div class="col-lg-5 text-center text-lg-right">
            <div class="copyright-item copyright-right">
              <ul class="mb-0 justify-content-center justify-content-lg-end d-flex flex-wrap">
                <li class="mx-2">
