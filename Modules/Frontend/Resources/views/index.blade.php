...
@section('content')
    <div class="address-area responsive-margin-top px-3 px-md-0">
        <div class="containers container">
            <h2 class="text-center text-md-center">Join the Motonos Closed Beta</h2>
            ...
            <div class="section mb-4">
                ...
                <ul>
                    <li><img src="https://api.iconify.design/mdi:calendar-check.svg?color=%23f26522" alt="Calendar"
                            style="width: 1.2em; height: 1.2em; vertical-align: middle; margin-right: 6px;"> Booking & Job
                        Management create, schedule, and track customer bookings and jobs</li>
                    <li><img src="https://api.iconify.design/mdi:car.svg?color=%23f26522" alt="Vehicle"
                            style="width: 1.2em; height: 1.2em; vertical-align: middle; margin-right: 6px;"> Vehicle Records
                        store vehicle details and link them to customer history</li>
                    <li><img src="https://api.iconify.design/mdi:account-group.svg?color=%23f26522" alt="Customer"
                            style="width: 1.2em; height: 1.2em; vertical-align: middle; margin-right: 6px;"> Customer
                        Records manage customer details alongside their vehicles</li>
                    <li><img src="https://api.iconify.design/mdi:file-document-multiple.svg?color=%23f26522" alt="Quotes"
                            style="width: 1.2em; height: 1.2em; vertical-align: middle; margin-right: 6px;"> Quotes &
                        Invoicesgenerate and share directly with customers</li>
                    <li><img src="https://api.iconify.design/mdi:bell.svg?color=%23f26522" alt="Notifications"
                            style="width: 1.2em; height: 1.2em; vertical-align: middle; margin-right: 6px;"> Notifications –
                        keep customers updated on progress</li>
                    <li><img src="https://api.iconify.design/mdi:cellphone.svg?color=%23f26522" alt="Mobile"
                            style="width: 1.2em; height: 1.2em; vertical-align: middle; margin-right: 6px;"> Mobile-Friendly
                        Access use the app in your garage, on the move, or at a customer’s location
                    </li>
                </ul>
            ...
            <div class="section mb-4">
                ...
                <p class="text-center text-md-start">Ready to join the Motonos Closed Beta? Click the button below to go to
                    the
            ...
            <div class="section mb-4">
                ...
                <p><img src="https://api.iconify.design/mdi:hand-pointing-right.svg?color=%23f26522" alt="Point Right"
                        style="width: 1.2em; height: 1.2em; vertical-align: middle; margin-right: 6px;"> Whether you’re a
                    garage, mobile mechanic, or service provider, you’ll be able to test the platform in
                    real-world use and share feedback that helps us shape future features.</p>
            </div>

            <div class="section mb-4">
                <h3 class="text-center text-md-start">Questions?</h3>
                <p class="text-center text-md-start">Do you have any questions? Click the button below to get in touch with
                    us.
                </p>
                <div style="text-align:center">
