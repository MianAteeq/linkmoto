...
@section('content')
    ...
    <!--                    <p> @if (!empty($setting['description']))
    {{ $setting['description'] }}
    @endif
    </p>
    -->
    ...
    <div class="address-area" style="margin-top:100px;">
        <div class="containers">
            <h2>Join the Motonos Closed Beta</h2>
            ...
            <div class="section">
                ...
                <p>Ready to join the Motonos Closed Beta? Click the button below to go to the
                    registration page and submit your details.</p>
                <div style="text-align:center"><a href="https://Motonos-dev.fissionmonster.com/register"
                        class="btn">Register Your Interest</a></div>
            </div>
            ...
            <div class="section">
                ...
                <div style="text-align:center">
                    <a href="https://Motonos-dev.fissionmonster.com/contact" class="btn">Get in Touch</a>
                </div>
            </div>
            <!--<div class="row">-->
            ...
            <!--        <h3>Location</h3>-->
            <!--        <span> @if (!empty($setting['homelocation']))
    {{ $setting['homelocation'] }}
    @endif
    </span>-->
            <!--    </div>-->
            <!--</div>-->
