...
@section('content')
    <div class="address-area" style="margin-top:100px;margin-bottom:200px;">
        <div class="containers" style="max-width: 700px;">
            ...
            <p style="text-align:center">You’re now on the list to join the Motonos Closed Beta!</p>
            <p style="text-align:center">Thank you for registering your interest in joining the Motonos Closed Beta. Our team
