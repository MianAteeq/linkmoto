...
<div class="content-body">
  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-12 col-md-4 mb-4 mb-md-0">
      <div style="border-radius: 7px;border: 2px solid black;">
        ...
        <p style="padding-left: 10px; padding-right: 10px;">
          The Beta Terms & Conditions
          sets out the rules for beta
    ...
    <div class="col-12 col-md-8" style="border: 2px solid black;border-radius: 8px;padding:inherit">
      <form action="{{ route('vender.profile.terms', ['requestType' => 'term']) }}" method="POST" id="contens">
        @csrf
            ...
            <div
              ...
              <p data-start="248" data-end="494">
                <font color="#000000" style="">At Motonos, we value your privacy and are
                  committed to protecting your personal data. This Beta T&Cs explains how we
              ...
              <div class="col-md-12">
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="is_term"
                    {{ $user['profile']['is_term'] == 1 ? 'checked' : '' }} name="is_term" value="1" required>
