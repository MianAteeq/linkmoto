    ...
    <div class="col-12 col-md-4 mb-4 mb-md-0">
      <div style="border-radius: 7px;border: 2px solid black;">
        ...
        <p style="padding-left: 10px; padding-right: 10px;">
          ...
          and that any future subscription will be optional and subject to full Subscription Terms & Conditions.
        </p>
      </div>
    </div>

    <div class="col-12 col-md-8" style="border: 2px solid black;border-radius: 8px;padding:inherit">
      <form action="{{ route('vender.profile.terms', ['requestType' => 'sub_term']) }}" method="POST" id="contens">
        @csrf
        ...
        <div class="link-body" style="padding: 10px">
          <div class="form-group">
            ...
            <div
              ...
              <h2 data-start="190" data-end="211" class=""><span data-start="193" data-end="211" style="">
                  <font color="#000000" style="">Subscription T&Cs</font>
                </span></h2>
              <p data-start="213" data-end="246">
                <font color="#000000" style=""><strong data-start="213" data-end="230">Last Updated:</strong> October 6,
                  2025</font>
              </p>
              <p data-start="248" data-end="494">
                <font color="#000000" style="">At Motonos, we value your privacy and are
                  committed to protecting your personal data. This Subscription T&Cs explains how we
                  collect, use, and protect the information you provide to us when you use our
                  website, products, or services.</font>
              </p>
              <h3 data-start="501" data-end="534" class=""><span data-start="505" data-end="534" style="">
                  <font color="#000000">1. Information We Collect</font>
                </span></h3>
              <p data-start="535" data-end="585">
                <font color="#000000" style="">We may collect the following types of information:</font>
              </p>
              <ul>
                <li>
                  <font color="#000000" style=""><strong data-start="588" data-end="613">Personal Information:</strong>
                    Name, email address, phone
                    number, billing and shipping addresses, and payment details.</font>
                </li>
                <li>
                  <font color="#000000" style=""><strong data-start="704" data-end="728">Account Information:</strong>
                    Username, password, and preferences.</font>
                </li>
                <li>
                  <font color="#000000" style=""><strong data-start="768" data-end="783">Usage Data:</strong> IP
                    address, browser type, device information, and pages visited.</font>
                </li>
                <li>
                  <font color="#000000" style=""><strong data-start="851" data-end="876">Cookies and Tracking:</strong>
                    To improve user experience and analytics.</font>
                </li>
              </ul>
              <h3 data-start="925" data-end="963" class=""><span data-start="929" data-end="963" style="">
                  <font color="#000000">2. How We Use Your Information</font>
                </span></h3>
              <p data-start="964" data-end="1009">
                <font color="#000000" style="">We use your information for purposes such as:</font>
              </p>
              <p data-start="964" data-end="1009">
              ...
              <ul>
                ...
                <li>
                  <font color="#000000" style="">Sending important updates or promotional messages (with your consent).
                  </font>
                </li>
                <li>
                  <font color="#000000" style="">Improving our website and customer experience.</font>
                </li>
                <li>
                  <font color="#000000" style="">Complying with legal and regulatory obligations.</font>
                </li>
              </ul>
              <h3 data-start="1262" data-end="1288" class=""><span data-start="1266" data-end="1288" style="">
              ...
              <div class="col-md-12">
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="is_sub"
                    {{ $user['profile']['is_sub'] == 1 ? 'checked' : '' }} name="is_sub" value="1" required>
