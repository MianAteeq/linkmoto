  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-12 col-md-4 mb-4 mb-md-0">
      <div style="border-radius: 7px;border: 2px solid black;">
        ...
        {{-- <div class="footers">
                        ... (commented code preserved exactly as is) ...
                    </div> --}}
      </div>
    </div>
      ...
      <form action="{{ route('vender.profile.main.account') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="link-body" style="padding: 10px">
          ...
          <div class="form-group row">
            <label class="col-12 col-md-4 label-control" for="name">First name <span style="color: red">*</span>
            </label>
            <div class="col-12 col-md-8 mx-auto">
              <input type="tel" id="name" class="form-control" value="{{ $user['name'] }}" onkeyup="lookup(this);"
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-md-8 mx-auto">
              <input type="tel" id="middle_name" class="form-control" value="{{ $user['middle_name'] }}"
          ...
          <div class="form-group row">
            <label class="col-12 col-md-4 label-control" for="last_name">Last name <span style="color: red">*</span>
            </label>
            <div class="col-12 col-md-8 mx-auto">
          ...
          <div class="form-group row">
            <label class="col-12 col-md-4 label-control" for="email">Email <span style="color: red">*</span> </label>
            <div class="col-12 col-md-8 mx-auto">
              <input type="tel" id="email" class="form-control" value="{{ $user['email'] }}" onkeyup="lookup(this);"
          ...
          <div class="form-group row">
            <label class="col-12 col-md-4 label-control" for="phone_no">Mobile <span style="color: red">*</span>
            </label>
            <div class="col-12 col-md-8 mx-auto">
          ...
          <div class="form-group row">
            <label class="col-12 col-md-4 label-control">Role / position <span style="color: red">*</span> <a
                style="color: black" href="#collapsebusiness" data-toggle="collapse" aria-expanded="false"
                aria-controls="collapsebusiness">(?)</a></label>
            <div class="col-12 col-md-8 mx-auto">
              <div class="input-group">
                <select name="job_title" id="job_title" class="form-control select2" style="width: 100%!important">
                  <option value="Director" @if ($user['profile']['job_title']=='Director' ) selected @endif>Director
                  </option>
                  <option value="Owner" @if ($user['profile']['job_title']=='Owner' ) selected @endif>Owner</option>
          ...
          <div class="form-group row">
            <div class="col-12">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="confirm_authorised" name="confirm_authorised"
                  value="1" {{ $user['profile']['person_authorised'] == 1 ? 'checked' : null }} required>
              ...
              <p class="text-danger confirm_authorised" style="display:none; padding-left: 10px; margin-top: 5px;">
          ...
          <div class="form-group row" style="display: none">
            <label class="col-12 col-md-4 label-control">Is this person authorised to act on behalf of this
              business? <span style="color: red">*</span> (?)</label>
            <div class="col-12 col-md-8 mx-auto">
              <div class="input-group">
                <div class="d-inline-block custom-control custom-radio mr-1">
                  <input type="radio" name="person_authorised" class="custom-control-input" value="YES" @if
                    ($user['profile']['person_authorised']=='YES' ) checked @endif id="Yes">
                  <label class="custom-control-label" for="Yes">Yes</label>
                </div>
                <div class="d-inline-block custom-control custom-radio">
                  <input type="radio" name="person_authorised" class="custom-control-input" value="NO" @if
                    ($user['profile']['person_authorised']=='NO' ) checked @endif id="No">
          ...
          <div class="form-group row" style="display: none">
            <label class="col-12 col-md-4 label-control">Proof main contact person is
              authorised to act on behalf of this business <span style="color: red">*</span> <a style="color: black"
            ...
            <div class="col-12 col-md-8 mx-auto">
              ...
              <button type="button" class="btn btn-primary btn-sm mt-2 view-btn" @if
                ($user['profile']['proof_of_main_contact']==null) style="display: none" @endif> <a
        ...
        <div class="footers d-flex flex-wrap justify-content-end w-100" style="gap: 10px; padding: 10px;">
          ...
          <a href="{{ route('vender.profile.back', 3) }}">
