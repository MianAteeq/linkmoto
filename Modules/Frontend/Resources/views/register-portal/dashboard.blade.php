  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-12 col-md-4 mb-4 mb-md-0">
      <h4 class="h3"
        ...
        <img src="/home.png" style="width: 22px;margin-top: -5px;"> Overview
      </h4>
    </div>
    ...
    <div class="col-12 col-md-8" style="border: 2px solid black;border-radius: 8px;padding:inherit">
      ...
      <div class="footers" style="padding: 10px;">
        <form action="{{ route('vender.profile.start') }}" method="POST"
          class="d-flex flex-wrap justify-content-end w-100" style="gap: 10px;">
          @csrf
          <input type="hidden" id="is_save_later" name="is_save_later" value="0">

          <a onclick="saveforlater()" style="cursor: pointer;">
            <button type="button" class="btn btn-dark round btn-min-width mb-1">SAVE AND EXIT</button>
          </a>
          <button type="submit" class="btn btn-dark round btn-min-width mb-1">SAVE AND NEXT</button>
        </form>
      </div>
