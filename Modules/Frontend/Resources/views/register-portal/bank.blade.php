...
/* Responsive styling for Stripe Element */
.stripe-container {
  width: 100%;
  margin: 0 auto;
}
  ...
  <div class="row" style="margin-top: 10px;">
    <div class="col-12 col-md-4 mb-4 mb-md-0">
      <h4 class="h3"
        ...
        <img src="/home.png" style="width: 22px;margin-top: -5px;"> Stripe Direct Debit Mendate
      </h4>
    </div>

    <div class="col-12 col-md-8" style="border: 2px solid black;border-radius: 8px;padding:inherit">
      <form id="payment-form" @if ($user['profile']['package_id']==null || $user['profile']['customer_id']==null)
        style="display: none" @endif>
        <div class="link-body" style="padding: 10px">
          <h2 class="h3 mb-2"> Stripe Direct Debit Mendate</h2>

          @if ($user['subscription'])
          <div class="text-center">
            @if (isset($package) && $package['price'] > 0)
            <img src="{{ URL::to('paymentstatusreview.png') }}" alt="" class="img-fluid">
            @else
            ...
            <div class="row mt-4 mb-1">
              ...
              <div class="col-12 col-sm-7 text-secondary" style="text-align: left;">
          ...
          @else
          <main class="main">
            <ul class="o-vertical-spacing o-vertical-spacing--l list-unstyled">
          ...
          <div id="payment-element" class="stripe-container">
          </div>
          @endif
        </div>
        ...
        <div class="footers d-flex flex-wrap justify-content-end w-100" style="gap: 10px; padding: 10px;">
          <a href="{{ route('vender.profile.back', 4) }}">
            <button type="button" class="btn btn-dark round btn-min-width mb-1">PREVIOUS</button>
          </a>
          <a href="{{ route('vender.profile.term') }}?is_save_later=1">
            <button type="button" class="btn btn-dark round btn-min-width mb-1">SAVE AND EXIT</button>
          </a>
          @if ($user['subscription'])
          <a href="{{ route('vender.profile.term') }}">
            <button type="button" class="btn btn-dark round btn-min-width mb-1">NEXT</button>
          </a>
          @else
      ...
      <div style="padding: 10px;">
        <p class="mb-1"><span>Complusory Steps</span></p>
        <ul>
          <li>Main Conatct is In Complete</li>
          <li>Subscription is In Complete</li>
        </ul>
      </div>
      @endif
    </div>
