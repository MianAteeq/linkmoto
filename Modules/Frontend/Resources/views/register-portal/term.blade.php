        ...
        <div class="px-1 px-md-1">
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-12 col-lg-4 mb-2 mb-lg-0">
                    <div style="border-radius: 7px; border: 2px solid black;">
                        <h4 class="h3" style="padding: 10px; font-weight: 600; font-size: 17px; margin-bottom: 0;">
                            <img src="/home.png" style="width: 22px; margin-top: -5px;"> Agreements – Privacy Policy
                        </h4>
                        <p style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
                            The Privacy Policy explains what data we collect (business info, customer details, usage data),
                ...
                <div class="col-12 col-lg-8 body-height">
                    <form action="{{ route('vender.profile.terms') }}" method="POST" id="contens"
                        ...
                        <div class="link-body" style="padding: 10px; flex-grow: 1;">
                            <div class="form-group">
                                ...
                                <div
                                    ...
                                    <h3 data-start="501" data-end="534" class="">
                                        <span data-start="505" data-end="534" style="">
                                            <font color="#000000">1. Information We Collect</font>
                                        </span>
                                    </h3>
                                    <p data-start="535" data-end="585">
                                        <font color="#000000" style="">We may collect the following types of
                                            information:</font>
                                    </p>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            <font color="#000000" style=""><strong data-start="704"
                                                    data-end="728">Account Information:</strong> Username, password, and
                                                preferences.</font>
                                        </li>
                                        <li>
                                            <font color="#000000" style=""><strong data-start="768"
                                                    data-end="783">Usage Data:</strong> IP address, browser type, device
                                                information, and pages visited.</font>
                                        </li>
                                        <li>
                                            <font color="#000000" style=""><strong data-start="851"
                                                    data-end="876">Cookies and Tracking:</strong> To improve user experience
                                                and analytics.</font>
                                        </li>
                                    </ul>
                                    <h3 data-start="925" data-end="963" class="">
                                        <span data-start="929" data-end="963" style="">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <font color="#000000" style="">Improving our website and customer
                                                experience.</font>
                                        </li>
                                        <li>
                                    ...
                                    <h3 data-start="1262" data-end="1288" class="">
                                        <span data-start="1266" data-end="1288" style="">
...
@section('js')
    <script>
        ...
        $('input[type=checkbox]').change(function() {
            ...
            if (checked === true) {
                $('.agree').hide();
                $('.confirm_authorised').hide(); // Added to clear validation error automatically
            } else {
                $('.agree').show();
            }
        });
