        ...
        <div class="footers">
          ...
          <div id="accordionWrap1" role="tablist" aria-multiselectable="true">
            <div class="card accordion collapse-icon accordion-icon-rotate"
              ...
              <a id="ac_company_name" class="card-header info collapsed" data-toggle="collapse" href="#collapsec_name"
                aria-expanded="false" aria-controls="collapsec_name">
                <div class="card-title lead">Registered <span class="cname" @if ($user['profile']['organization_status']
                    !='Limited Company (Ltd)' ) style="display: none" @endif>company</span> name (?)</div>
              </a>
              <div id="collapsec_name" data-parent="#accordionWrap1" role="tabpanel" aria-labelledby="ac_company_name"
                class="collapse" style="">
                <div class="card-content">
                  <div class="card-body company_name_text">
                    This is the exact company name as registered at Companies House. It may be different from your
                    trading name (the name customers see). Check your official registration documents if you’re unsure.
                  </div>
                </div>
              </div>
              <hr>
              ...
              <a id="company_number" class="card-header info collapsed" data-toggle="collapse"
                ...
                <div class="card-title lead">Registered <span class="cname" @if ($user['profile']['organization_status']
                    !='Limited Company (Ltd)' ) style="display: none" @endif>company</span> number (?)</div>
              </a>
              <div id="collapsec_c_number" data-parent="#accordionWrap1" role="tabpanel"
                ...
                <div class="card-content">
                  <div class="card-body company_number_text">
                    This is your unique Companies House registration number (8 characters, usually letters and/or
                    numbers). It identifies your company officially and helps us verify your business.
                  </div>
                </div>
              </div>
              <hr>
              ...
              <a id="company_address" class="card-header info collapsed" data-toggle="collapse"
                ...
                <div class="card-title lead">Registered <span class="cname" @if ($user['profile']['organization_status']
                    !='Limited Company (Ltd)' ) style="display: none" @endif>company</span> address (?)</div>
              </a>
              <div id="collapsec_c_address" data-parent="#accordionWrap1" role="tabpanel"
                ...
                <div class="card-content">
                  <div class="card-body company_address_text">
                    This is the official address listed at Companies House. It may be different from your trading or
                    garage address where customers drop off vehicles.
                  </div>
                </div>
              </div>
      ...
      <form action="{{ route('vender.profile.business.info') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="link-body" style="padding: 10px">
          ...
          <div class="form-group row">
            <label class="col-12 col-md-4 label-control">Business setup <span style="color: red">*</span> </label>
            <div class="col-12 col-md-8 mx-auto">
              <div class="input-group">
                <select name="organization_status" id="organization_status" class="form-control select2"
                  style="width:100%!important;">
                  <option value="Limited Company (Ltd)" @if
                    ($user['profile']['organization_status']=='Limited Company (Ltd)' ) selected @endif>Limited Company
                    (Ltd)</option>
                  <option value="Sole Trader / Self-Employed" @if
                    ($user['profile']['organization_status']=='Sole Trader / Self-Employed' ) selected @endif>Sole
                    Trader / Self-Employed</option>
                  <option value="General Partnership" @if
                    ($user['profile']['organization_status']=='General Partnership' ) selected @endif>General
                    Partnership</option>
                  <option value="Limited Liability Partnership (LLP)" @if
                    ($user['profile']['organization_status']=='Limited Liability Partnership (LLP)' ) selected @endif>
          ...
          <div class="form-group row">
            <label class="col-12 col-md-4 label-control" for="company_name">Registered <span class="cname" @if
                ($user['profile']['organization_status'] !='Limited Company (Ltd)' ) style="display: none"
                @endif>company</span> name <span style="color: red">*</span> <a style="color: black"
                href="#collapsec_name" data-toggle="collapse" aria-expanded="false"
                aria-controls="collapsec_name">(?)</a></label>
            <div class="col-12 col-md-8 mx-auto">
              <input type="tel" id="company_name" value="{{ $user['profile']['company_name'] }}" class="form-control"
                onkeyup="lookup(this);" name="company_name" required placeholder=" ">
          ...
          <div class="form-group row company_feild">
            <label class="col-12 col-md-4 label-control" for="registration_no">Registered <span class="cname" @if
                ($user['profile']['organization_status'] !='Limited Company (Ltd)' ) style="display: none"
                @endif>company</span> number <span style="color: red">*</span> <a style="color: black"
                href="#collapsec_c_number" data-toggle="collapse" aria-expanded="false"
                aria-controls="company_number">(?)</a></label>
            <div class="col-12 col-md-8 mx-auto">
              <input type="text" id="registration_no" class="form-control"
                value="{{ $user['profile']['registration_no'] }}" onkeyup="lookup(this);" name="registration_no"
          ...
          <div class="form-group row company_feild">
            <label class="col-12 col-md-4 label-control" for="company_jurisdiction">Registered <span
                class="cjurisdiction cname" @if ($user['profile']['organization_status'] !='Limited Company (Ltd)' )
                style="display: none" @endif>company</span> Jurisdiction </label>
            <div class="col-12 col-md-8 mx-auto">
          ...
          <div class="form-group row">
            <label class="col-12 col-md-4 label-control">Registered <span class="cname" @if
                ($user['profile']['organization_status'] !='Limited Company (Ltd)' ) style="display: none"
                @endif>company</span> address <span style="color: red">*</span> <a style="color: black"
                href="#collapsec_c_address" data-toggle="collapse" aria-expanded="false"
            ...
            <div class="col-12 col-md-8 mx-auto">
              <input type="tel" id="address_line_1" onkeyup="lookup(this);" class="form-control" name="address_line_1"
                required value="{{ $user['profile']['address_line_1'] }}" placeholder="Address line one *">
              <input type="tel" id="address_line_2" class="form-control" name="address_line_2" required
                value="{{ $user['profile']['address_line_2'] }}" style="margin-top: 5px "
                placeholder="Address line two ">
              <input type="tel" class="form-control" name="address_line_3"
                value="{{ $user['profile']['address_line_3'] }}" style="margin-top: 5px "
                placeholder="Address line three ">
              <input type="tel" class="form-control" name="address_line_4"
              ...
              <input type="tel" id="city" class="form-control" onkeyup="lookup(this);" name="city" required
                value="{{ $user['profile']['city'] }}" style="margin-top: 5px " placeholder="City / Town *">
              <input type="tel" id="postcode" class="form-control" onkeyup="lookup(this);" name="postcode" required
                value="{{ $user['profile']['postcode'] }}" style="margin-top: 5px " placeholder="postcode *">
          ...
          <div class="form-group row" id="proof_doc" style="display: none">
            <label class="col-12 col-md-4 label-control">Proof of Sole Trader / Self Employed status <span
                style="color: red">*</span> <a style="color: black" href="#collapsec_c_proof" data-toggle="collapse"
                aria-expanded="false" aria-controls="collapsec_c_proof">(?)</a></label>
            <div class="col-12 col-md-8 mx-auto">
              <div>
                <input type="file" class="d-none" name="document_proof" accept="image/*,.doc, .docx,.pdf" id="">
                <input type="button" class="form-control form-btn mt-1 mt-md-0"
                  value="{{ $user['profile']['document_proof_name'] ?? 'Document Upload' }}" name="contact"
                  placeholder="Document Upload ">
                <button type="button" class="btn btn-primary btn-sm mt-2 view-btn" @if
                  ($user['profile']['document_proof_name']==null) style="display: none" @endif>
                  <a href="{{ URL::to($user['profile']['document_proof'] ?? '') }}" id="view_file" target="_blank"
                    style="color: white">View</a>
                </button>
              </div>
              <br><br>
              <p class="text-danger file_proof" style="padding-left: 10px;width:100%;display: none">Proof of Sole Trader
                / Self Employed status is Required !</p>
            </div>
          </div>
        </div>

        <div class="footers d-flex flex-wrap justify-content-end w-100" id="footers" style="gap: 10px; padding: 10px;">
          ...
          <button onclick="saveforlater()" type="button" class="btn btn-dark round btn-min-width mb-1">SAVE AND
            EXIT</button>
          <button type="button" class="btn btn-dark round btn-min-width mb-1" onclick="submitDetailsForm()">
            NEXT</button>
          @else
          <button type="button" class="btn btn-dark round btn-min-width mb-1" onclick="submitDetailsForm()">
            UPDATE</button>
...
async function lookup(arg) {
  ...
  if (id.indexOf("name") >= 0 || id.indexOf("city") >= 0 || id.indexOf("postcode") >= 0) {
    let first_name = $('#first_name').val();
    let last_name = $('#last_name').val();
    let middle_name = $('#middle_name').val();
    if (first_name !== undefined && first_name !== "" && last_name !== "" && middle_name !== "") {
      $(`.name`).hide();
    }
  }
}
