                                ...
                                <div id="collapsec_name" data-parent="#accordionWrap1" role="tabpanel"
                                    ...
                                    <div class="card-content">
                                        <div class="card-body company_name_text">
                                            This is the exact company name as registered at Companies House. It may be
                                            different from your
                                            trading name (the name customers see). Check your official registration
                                ...
                                <div id="collapsec_c_number" data-parent="#accordionWrap1" role="tabpanel"
                                    ...
                                    <div class="card-content">
                                        <div class="card-body company_number_text">
                                            This is your unique Companies House registration number (8 characters, usually
                                            letters and/or
                                            numbers). It identifies your company officially and helps us verify your
                                            business.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="collapsec_c_address" data-parent="#accordionWrap1" role="tabpanel"
                                    ...
                                    <div class="card-content">
                                        <div class="card-body company_address_text">
                                            This is the official address listed at Companies House. It may be different from
                                            your trading or
                            ...
                            <div class="col-12 col-lg-8 mx-auto">
                                <div class="input-group" style="width: 60%;">
                                    <select name="organization_status" id="organization_status" class="form-control select2"
                                        ...
                                        <option value="Limited Company (Ltd)" @selected($user['profile']['organization_status'] == 'Limited Company (Ltd)')>
                                            Limited Company (Ltd)
                                        </option>

                                        <option value="Sole Trader / Self-Employed" @selected($user['profile']['organization_status'] == 'Sole Trader / Self-Employed')>
                                            Sole Trader / Self-Employed
                                        </option>

                                        <option value="General Partnership" @selected($user['profile']['organization_status'] == 'General Partnership')>
                                            General Partnership
                                        </option>

                                        <option value="Limited Liability Partnership (LLP)" @selected($user['profile']['organization_status'] == 'Limited Liability Partnership (LLP)')>
                            ...
                            <div class="col-12 col-lg-8 mx-auto">
                                <div>
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm mt-2 view-btn"
                                        @if ($user['profile']['document_proof_name'] == null) style="display: none" @endif>
                                        <a href="{{ URL::to($user['profile']['document_proof'] ?? '') }}" id="view_file"
                                            target="_blank" style="color: white">View</a>
                                    </button>
                                </div>
                                <br><br>
                                <p class="text-danger file_proof" style="padding-left: 10px;width:100%;display: none">
                                    Proof of Sole Trader
                                    / Self Employed status is Required !</p>
                            </div>
                        </div>
                    </div>

                    <div class="footers d-flex flex-wrap justify-content-end w-100" id="footers"
                        ...
                        @if ($user['profile']['edit_step'] == 0)
                            ...
                            <button onclick="saveforlater()" type="button"
                                class="btn btn-dark round btn-min-width mb-1">SAVE AND
                                EXIT</button>
