    ...
    <div class="content-body pb-1">
        <div class="row" style="border-bottom: 3px solid #949494; margin-bottom: 15px;">
            <div class="col-xl-12 col-12 px-1 px-md-2">
                <h3 class="h3" style="font-weight: 800; font-size: 18px; color: black; margin-bottom: 14px;">Business
                    registration application @if($user['application_status'] == 'Request for Info' || $user['application_status'] == 'PENDING')
        ...
        <div class="px-1 px-md-1">
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-12 col-lg-4 mb-2 mb-lg-0" id="contens">
                    <div
                        @if (
                            $user['application_status'] == 'IN_REVIEW' &&
                                ...
                                $user['profile']['subscription_status'] != 3) style="border-radius: 7px;border: 2px solid black;padding: 10px;" 
@else
                        ...
                        @if (
                            ...
                            <div class="link-body">
                                <div style="padding-left: 30px">
                                        @if($user['application_status'] == 'Request for Info' || $user['application_status'] == 'PENDING')
                                            <span class="badge badge-info" style="padding: 0.5em 0.6em;font-size: 13px;"> Request
                                                for Info
                                            </span>
                                            @else
                                ...
                                <p style="justify-content: center;padding-bottom: 14px; padding-top: 14px;">
                                    @if($user['application_status'] == 'Request for Info')
                                        <p><strong>Reason: </strong>{{ $user['note'] }}</p>

                                        @elseif($user['application_status'] == 'DECLINE')
                                        <p><strong>Reason: </strong>{{ $user['note'] }}</p>
                                    @else
                                   
                                    You have answered all the required questions. Please review your supplied information.
                                    If
                                ...
                                <ul style="margin-left: -10px;">
                                    ...
                                    @if ($user['profile']['is_main_account'] == 0)
                                        <li style="color:red">Your Main Contact</li>
                                    @endif
                    ...
                    <div class="link-body">
                        <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;">
                            ...
                            <a id="headingCollapse14" class="card-header info collapsed"
                                @if ($user['profile']['business_status'] != 3) style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"
                            @else
                                        ...
                                        @if ($user['application_status'] != 'IN_REVIEW' || $user['profile']['business_status'] == 3)
                                            <div class="text-secondary" style="text-align: right">
                                                <a href="{{ route('vender.profile.step', 1) }}"
                                                    style="background-color: black !important; border-color: black !important; color: white !important;"
                            ...
                            <a id="headingCollaptr_name" class="card-header info mt-2"
                                @if ($user['profile']['trading_name_status'] != 3) style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"
                            @else
                            style="border: 2px solid red;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;" @endif
                            ...
                            <a id="headingCollapmain_conatct" class="card-header info mt-2"
                                @if ($user['profile']['main_account_status'] != 3) style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"
                            @else
                            style="border: 2px solid red;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;" @endif
                            ...
                            <a id="headingCollapsevat" class="card-header info mt-2"
                                @if ($user['profile']['vat_status'] != 3) style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"
                            @else
                            style="border: 2px solid red;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;" @endif
                            ...
                            <div id="collapsevats" role="tabpanel" aria-labelledby="headingCollapsevat"
                                class="collapse accordin_style"
                            ...
                            <a id="headingCollapsesubs" class="card-header info mt-2"
                                @if ($user['profile']['subscription_status'] != 3) style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"
                            @else
                            style="border: 2px solid red;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;" @endif
                                data-toggle="collapse" href="#collapsubs" aria-expanded="false"
                                aria-controls="collapsubs">
                                <div class="card-title lead collapsed">Subscription</div>
                            </a>
                            <div id="collapsubs" role="tabpanel" aria-labelledby="headingCollapsesubs"
                            ...
                            <a id="headingCollapseterm" class="card-header info mt-2"
                                @if ($user['profile']['is_privacy_policy'] === 1) style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"
                            @else
                            style="border: 2px solid red;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;" @endif
                            ...
                            <div id="term" role="tabpanel" aria-labelledby="headingCollapseterm"
                            ...
                            <a id="headingCollapseterm_beta" class="card-header info mt-2"
                                @if ($user['profile']['is_term'] === 1) style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"
                            @else
                            style="border: 2px solid red;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;" @endif
                                data-toggle="collapse" href="#term_beta" aria-expanded="false"
                                aria-controls="term_beta">
                                <div class="card-title lead collapsed"> Agreements – Beta T&Cs</div>
                            </a>
                            <div id="term_beta" role="tabpanel" aria-labelledby="headingCollapseterm_beta"
                           ...
                           <a id="headingCollapseterm_sub" class="card-header info mt-2"
                            ...
                            <div id="term_sub" role="tabpanel" aria-labelledby="headingCollapseterm_sub"
