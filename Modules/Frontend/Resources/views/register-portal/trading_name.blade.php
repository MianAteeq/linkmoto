...
<div class="content-body">
  ...
  <div class="row" style="margin-top: 10px;">
    ...
    <div class="col-12 col-md-8 body-height" style="border: 2px solid black;border-radius: 8px;padding: inherit;">
      <div id="contens" class="flex-column-container">
        <div class="link-body" style="padding: 10px; flex-grow: 1;">

          <div class="form-group row">
            <label class="col-12 col-md-4 label-control">Does your business use any trading names? <span
                style="color: red">*</span> (?)</label>
            <div class="col-12 col-md-8 mx-auto">
              <div class="input-group">
                <div class="d-inline-block custom-control custom-radio mr-1">
                  <input type="radio" name="is_trading_name" value="YES" @if ($user['profile']['is_trading_name']=='YES'
                    ) checked @endif class="custom-control-input" id="Yes">
                  <label class="custom-control-label" for="Yes">Yes</label>
                </div>
                <div class="d-inline-block custom-control custom-radio">
                  <input type="radio" name="is_trading_name" value="NO" @if ($user['profile']['is_trading_name']=='NO' )
          ...
          <div class="hide-form" @if ($user['profile']['is_trading_name']=='NO' ) style="display: none" @endif>
            <form action="{{ route('vender.profile.trading.name') }}" method="POST" enctype="multipart/form-data"
              id="form">
              @csrf
              <input type="hidden" id="is_save_later" name="is_save_later" value="0">

              <div class="form-group">
                <label for="name" style="width: 100%;">Trading names <span style="color: red">*</span>
                  <a style="color: black" href="#collapsebusiness_vat" data-toggle="collapse" aria-expanded="false"
                    aria-controls="collapsebusiness">(?)</a>
                </label>

                <div class="d-flex flex-wrap align-items-center" style="gap: 10px;">
                  <input type="text" id="name" style="flex: 1; min-width: 200px;" class="form-control" required
                    placeholder="Trading names" name="name">
            ...
            <div id="append_data">
              ...
              <div
                class="form-group rm-{{ $name['id'] }} d-flex flex-wrap align-items-center justify-content-between mb-2"
                style="width: 100%">
        ...
        <div class="footers d-flex flex-wrap justify-content-end w-100 mt-auto" id="footers"
          style="gap: 10px; padding: 10px; border-top: 2px solid rgba(0,0,0,0.1);">
          ...
          <button onclick="saveforlater()" type="button" class="btn btn-dark round btn-min-width mb-1">SAVE AND
            EXIT</button>
          <button type="button" class="btn btn-dark round btn-min-width mb-1" onclick="movetoNEXT()">NEXT</button>
          @else
          <button type="button" class="btn btn-dark round btn-min-width mb-1" onclick="movetoNEXT()">Update</button>
          @endif
        </div>
      </div>
    </div>
