                         ...
                         <div class="col-md-6">
                             <div class="formify_box">
                                 ...
                                 <p>Welcome! Please fill out the form below to register your interest in joining the Motonos
                                     Closed Beta. Once submitted, our team will review your application and contact you if
                                     you are selected.</p>
                                 <h5 class="form_title " id="busniess_title"
                                     style="font-size: 21px; font-size: 17px;color: #f26622;">1. Business Details</span>
                                 </h5>
                                     ...
                                     <div id="step_one">
                                         <div class="form-group col-md-12">
                                             ...
                                             <p class="text-danger trading_name" style="padding-left: 10px;display: none">
                                                 Please enter your business name.</p>
                                         </div>
                                         <div class="form-group col-md-12">
                                             <label class="input_title" for="inputName">
                                                 ...
                                                 <span data-toggle='tooltip'
                                                     title='Select the services your business provides'>(?)</span>
                                             </label>
                                         ...
                                         <div class="form-group col-md-12">
                                             ...
                                             <p style="margin: 0px 0;">Select all that apply to indicate how your business
                                                 provides its services</p>
                                             <div class="form-check">
                                                 <input class="form-check-input" type="checkbox" name="operation_type[]"
                                                     checked id="checkOnSite" value="On-site">
                                                 <label class="form-check-label" for="checkOnSite">On-site (e.g., from
                                                     garage workshop, shop)</label>
                                             </div>
                                             <div class="form-check">
                                                 <input class="form-check-input" type="checkbox" name="operation_type[]"
                                         ...
                                         <h5 class="form_title " id="busniess_title"
                                             style="font-size: 17px;color: #f26622;margin-top:15px;">2. Trading
                                             Address</span></h5>
                                         <p style="margin: 0px 0;">Provide your trading address so we can carry out an
                                             initial review and ensure your business meets our profile.</p>
                                   ...
                                   margin-top: -148px;width: 33%;background: white;z-index: 10000000;">
                                         ...
                                         <div id="address_operate"
                                             ...
                                             <div id="address_operate_div"
                                                 ...
                                                 <h5>Address</h5>
                                                 <p>This is the address the Motonos team
                                         ...
                                         <div class="form-group col-md-12">
                                             ...
                                             <p class="text-danger address" style="padding-left: 10px;display: none">
                                                 Please enter the first line of your business address </p>
                                         ...
                                         <p>Provide the details of the main contact for your business. This person will be
                                             used for follow-up and will receive the login information to access Motonos and
                                             manage other users.
                                         </p>
                                        ...
                                        ">
                                             ...
                                             <p class="text-danger name" style="padding-left: 10px;display: none">Please
                                                 enter first and last name of the main contact.</p>
                                         ...
                                         <div class="form-group col-md-12">
                                             ...
                                             <p class="text-danger email" style="padding-left: 10px;display: none">Please
                                                 enter a mobile number.</p>
                                         </div>

                                         <div class="form-group col-md-12" style="display:none;">
                                             <label class="input_title" for="inputName">Position or job title in relation
                                                 to this business <span style="color: red;padding-right: 3px">*</span>
                                             </label>
                                             <input type="text" class="form-control" onkeyup="lookup(this);"
                                         ...
                                         <div class="form-group col-md-12" style="display:none;">
                                             <label class="input_title" for="inputName">Please select the appropriate
                                                 organisation status for your business *<span data-toggle='tooltip'
                                                     title=''>(?)</span></label>
                                             <div>
                                                 ...
                                                 <div class="form-check form-check-inline">
                                                     ...
                                                     <label class="form-check-label" for="organization_status2">Sole
                                         ...
                                         <div class="form-group col-md-12" style="display:none;">
                                             <label class="input_title" for="inputName">Are you UK VAT registered? <span
                                                     style="color: red;padding-right: 3px">*</span><span
                                                     data-toggle='tooltip' title=''>(?)</span></label>
                                             <div>
                                                 <div class="form-check form-check-inline">
                                                 ...
                                                 <div class="form-check form-check-inline">
                                                     <input class="form-check-input" type="radio" checked
                                                         name="vat_register" id="vat_register2" value="NO">
                                 ...
                                 <div class="next_button text-right " id="next_btn" style="text-align: right">
                                     <button type="button" style="background: black" onclick="submitDetailsForm()"
                                         class="btn thm_btn red_btn next_tab">Submit
