...
Route::name('vender.')->middleware('auth:web')->group(function () {
    ...
    Route::delete('vender/service/provider/trading/unit/hub/setting/product/offer/delete/{id}/{trading_id}', [ServiceProviderHubSettingController::class, 'deleteProductOffer'])->name('service.provider.trading.unit.hub.setting.delete.product.offer');
