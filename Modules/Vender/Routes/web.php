...
Route::name('vender.')->middleware('auth:web')->group(function () {
    ...
    Route::get('vender/service/provider/trading/unit/hub/setting/edit/view/product/offer/{id}/{trading_id}', [ServiceProviderHubSettingController::class, 'viewProductOffer'])->name('service.provider.trading.unit.hub.setting.delete.product.offer');
    Route::delete('vender/service/provider/trading/unit/hub/setting/product/offer/delete/{id}/{trading_id}', [ServiceProviderHubSettingController::class, 'deleteProductOffer'])->name('service.provider.trading.unit.hub.setting.view.product.offer');
