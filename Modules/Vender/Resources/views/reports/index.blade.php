...
<style>
/* --- RESPONSIVE FIXES (Overrides safely without touching structure) --- */
...
.table td {
  white-space: nowrap;
  /* Prevents text from stacking vertically inside tight columns */
...
/* 3. Mobile adjustments for the filter form */
@media (max-width: 767px) {
  ...
  .users-list-filter .btn {
    width: 100%;
    /* Ensures button spans full width on mobile */
    margin-top: 5px;
  }
}
</style>
            ...
            <table id="users-list-datatable" class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $invoice['booking']['vehicle']['vrm'] }} {{ $invoice['booking']['vehicle']['vin_number'] }}
                  </td>
                  ...
                  <td><span class="badge badge-primary"
                      style="background-color: #f26622  !important">{{ $invoice['status'] }}</span></td>
                  @else
