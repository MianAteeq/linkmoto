                    ...
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left">
                                <h3 class="danger">{{ $quotations->count() }}</h3>
                                <h6>Total Quotes</h6>
                            </div>
                            <div>
        ...
        <form>
            <div class="row border border-light rounded py-2 mb-2">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <label for="users-list-verified">Quotation No</label>
                        ...
                        <table id="users-list-datatable" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $quotation['vehicle']['vrm'] }} {{ $quotation['vehicle']['vin_number'] }}</td>
                                    ...
                                    <td><span class="badge badge-primary" style="background-color: #f26622  !important">{{ $quotation['status'] }}</span></td>
                                    @else
                                    <td><span class="badge badge-light">{{ $quotation['status'] }}</span></td>

                                    @endif
                                    <td><a href="{{route('vender.print.invoice',$quotation['id'])}}"><i class="la la-eye"></i></a>
                                    </td>
                                </tr>
