    ...
    <section id="social-cards-glow">
            ...
            @foreach ($packages as $package)
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="card profile-card-with-cover"
                        style="box-shadow: 0 0 15px rgb(0 0 0 / 14%);border: 1px solid #dddddd;border-radius: 8px;-webkit-border-radius: 8px;padding: 18px;height: 100%;">
                        <div class="card-content card-deck text-center">
                            <div class="card box-shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><a type="button" href="{{ route('vender.package.checkout', $package['id']) }}"
                                            style="width: auto;font-weight: bold;font-size: 14px;border-radius: 60px;padding: 15px 24px;background: #159957;color: #fff !important;margin-top: 30px">
                                            Buy Nows</a></p>
                                    <ul class="list-unstyled mt-2 mb-2 list-check"
                                        style="padding-top: 40px;margin: 0 -18px;">
        ...
        <div class="row mt-2 mb-3">
            ...
            <div class="clearfix col-md-9 mt-3 info-outer">
                ...
                <p>All subscriptions will be automatically renewed from your selected payment method on a recurring basis
                    and
                    we'll
                    send you a receipt each time. We do not store your card details. You can upgrade, downgrade or cancel
                    anytime.
                    If the subscription is canceled, refunds and termination of access will follow the Terms of Service.
                    Prices
                    are
                    in US Dollars</p><br>
                <div class="row">
                    <div class="col-md-5">
                        <h4><a href="mailto:info@awebstar.com.sg"><i class="la la-envelope"></i> info@motonos.com</a></h4>
