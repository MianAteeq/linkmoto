                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div
                                            ...
                                            <input type="file" name="image"
                                                id="account-upload" onchange="loadFile(event)" hidden>
                            ...
                            <div class="tab-pane" id="information" aria-labelledby="information-tab"
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <h5 class="mb-1"><i
                                                class="ft-link mr-25"></i>Social Links</h5>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"
                                                name="trust_plot_link" type="text" value="">
                                            </div>
                                        </div>
                                    <div class="col-12 col-sm-6 mt-1 mt-sm-0">
                                        <h5 class="mb-1"><i
                                                class="ft-user mr-25"></i>Personal Info</h5>
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                <label>Phone</label>
                                                <input type="text"
                                                    class="form-control" name="phone_no"  placeholder="Phone number"
                                                    value="" ">
    </div>
    </div>
    <div class=" form-group">
