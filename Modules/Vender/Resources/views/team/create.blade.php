...
@section('css_custom')
<style>
/* 1. Make Tabs scrollable horizontally on small screens to prevent messy wrapping */
.nav-tabs {
  flex-wrap: nowrap;
  overflow-x: auto;
  overflow-y: hidden;
...
/* 2. Fix Roles Checkboxes for tablet (gives them 50% width instead of 25%) */
...
@media (max-width: 576px) {
  ...
  /* Stack Avatar Upload image and buttons */
  .users-edit .media {
  ...
  /* Roles take full width on mobile */
  .users-edit .col-md-3 {
    flex: 0 0 100%;
    max-width: 100%;
  }

  /* Ensure Save/Cancel buttons are full width for easier tapping */
  .justify-content-end {
...
<section class="users-edit">
      <div class="card">
            <div class="card-content">
                  <form novalidate method="POST" action="{{ route('vender.team.store') }}"
          ...
                          <ul class="nav nav-tabs mb-2" role="tablist">
            ...
                                <li class="nav-item">
                                      <a class="nav-link d-flex align-items-center" id="information-tab"
                data-toggle="tab" href="#information" aria-controls="information" role="tab" aria-selected="false">
          ...
                          <div class="tab-content">
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                                              <div class="media mb-2">
                                            <a class="mr-2" href="#">
                                                  <img
                    src="{{asset('/modules/vender')}}/app-assets/images/portrait/small/avatar-s-26.png"
                ...
                                            <div class="media-body">
                  ...
                                                 <div
                    ...
                                                    <label
                      class="btn btn-sm btn-primary ml-50 mb-50 mb-sm-0 cursor-pointer" for="account-upload">Upload new
                                                          photo</label>
                      ...
                                                                  <div class="col-md-3">
                                                                    <fieldset>
                                                                          <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox"
                              class="custom-control-input"  name="role_id[]" id="customCheck{{ $role['id'] }}"
                              value="{{ $role['id'] }}">
                ...
                                                <div class="col-12 col-sm-6 mt-1 mt-sm-0">
                  ...
                                                      <div class="form-group">
                                                            <div class="controls">
                                                                  <label>Phone</label>
                                                                  <input type="text" class="form-control"
                        name="phone_no"  placeholder="Phone number" value="" ">
                                        </div>
                                    </div>
                                    <div class=" form-group">
                                                              <div class="controls">
