...
@section('css_custom')
<style>
/* 1. Make Tabs scrollable horizontally on small screens */
.nav-tabs {
  flex-wrap: nowrap;
  overflow-x: auto;
  overflow-y: hidden;
...
/* 2. Fix Roles Checkboxes for mobile and tablet */
...
@media (max-width: 576px) {
  ...
  .users-edit .media .mr-2 {
    margin-right: 0 !important;
    margin-bottom: 1rem;
  }

  .users-edit .media-body .flex-column {
    align-items: center;
  }

  .users-edit .media-body .ml-50 {
    margin-left: 0 !important;
    margin-top: 10px;
    width: 100%;
  }

  /* 4. Roles full width on mobile */
  .users-edit .col-md-3 {
    flex: 0 0 100%;
    max-width: 100%;
  }

  /* 5. Full width Save/Cancel buttons */
  .justify-content-end {
            ...
            <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
              <div class="media mb-2">
                <a class="mr-2" href="#">
                  ...
                  <img src="{{URL::to($team['profile_pic'])}}" alt="users avatar"
                    class="users-avatar-shadow rounded-circle" id="output" height="64" width="64">
                  @else
                  <img src="{{URL::to('modules/vender/app-assets/images/portrait/small/avatar-s-26.png')}}"
                    alt="users avatar" class="users-avatar-shadow rounded-circle" id="output" height="64" width="64">
                ...
                <div class="media-body">
                  ...
                  <div class="col-12 px-0 d-flex flex-sm-row flex-column justify-content-start">
                    <label class="btn btn-sm btn-primary ml-50 mb-50 mb-sm-0 cursor-pointer" for="account-upload">Upload
                      new
                      photo</label>
                    <input type="file" name="image" id="account-upload" onchange="loadFile(event)" hidden>
                    <button class="btn btn-sm btn-secondary ml-50" type="button" onclick="reset()">Reset</button>
                  </div>
                </div>
              </div>
              <div class="row">
                  ...
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input type="email" class="form-control" name="email" placeholder="Email"
                        value="{{ $team['email'] }}" value="" required
                      ...
                      <div class="col-md-3">
                        <fieldset>
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" @foreach ($selected_roles as
                              $selected_role) @if($selected_role==$role['name']) checked @endif @endforeach
                              name="role_id[]" id="customCheck{{ $role['id'] }}" value="{{ $role['id'] }}">
              ...
              <div class="row">
                <div class="col-12 col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="facebook" value="{{ $team['profile']['facebook']??'' }}"
                      type="text" value="">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="instagram" type="text"
                      value="{{ $team['profile']['instagram']??'' }}">
                  </div>
                  <div class="form-group">
                    <label>Trust Plot Link</label>
                    <input class="form-control" name="trust_plot_link"
                      value="{{ $team['profile']['trust_plot_link']??'' }}" type="text" value="">
                  </div>
                </div>
                <div class="col-12 col-sm-6 mt-1 mt-sm-0">
                  ...
                  <div class="form-group">
                    <label>Country</label>
                    <input class="form-control" name="country" value="{{ $team['profile']['country']??'' }}" type="text"
                      value="">
                  </div>
                  ...
                  <div class=" form-group">
                    <div class="controls">
                      ...
                      <input type="text" class="form-control" name="address"
                        value="{{ $team['profile']['address']??'' }}" placeholder="Address">
                    </div>
                  </div>
                </div>
                <div class="col-12">
