...
<section class="users-edit">
    <div class="card">
        <div class="card-content">
            <form novalidate method="POST" action="{{ route('vender.team.update') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                            ...
                            <div class="media mb-2">
                                <a class="mr-2" href="#">
                                    @if($team['profile_pic']!=null)
                                    <img src="{{URL::to($team['profile_pic'])}}"
                                        alt="users avatar" class="users-avatar-shadow rounded-circle" id="output"
                                        height="64" width="64">
                                        @else
                                        <img src="{{URL::to('modules/vender/app-assets/images/portrait/small/avatar-s-26.png')}}" alt="users avatar" class="users-avatar-shadow rounded-circle" id="output"
                                            height="64" width="64">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="col-12 px-0 d-flex flex-sm-row flex-column justify-content-start">
                                        <label class="btn btn-sm btn-primary ml-50 mb-50 mb-sm-0 cursor-pointer"
                                            ...
                                            photo</label>
                                        <input type="file" name="image" id="account-upload" onchange="loadFile(event)"
                                            hidden>
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" name="last_name"
                                                placeholder="Last Name" value="{{ $team['last_name'] }}"required
                                            ...
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" @foreach ($selected_roles as $selected_role)
                                                        @if($selected_role==$role['name']) checked
                                                        @endif
                                                            
                                                        @endforeach name="role_id[]" id="customCheck{{ $role['id'] }}"
                                                            value="{{ $role['id'] }}">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="facebook" value="{{ $team['profile']['facebook']??'' }}" type="text" value="">
                                    </div>


                                    <div class="form-group">
                                        <label>Instagram</label>
                                        <input class="form-control" name="instagram" type="text" value="{{ $team['profile']['instagram']??'' }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Trust Plot Link</label>
                                        <input class="form-control" name="trust_plot_link" value="{{ $team['profile']['trust_plot_link']??'' }}" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 mt-1 mt-sm-0">
                                    ...
                                    <div class="form-group">
                                        <label>Country</label>
                                        <input class="form-control" name="country" value="{{ $team['profile']['country']??'' }}" type="text" value="">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" name="phone_no"
                                                placeholder="Phone number" value="{{ $team['profile']['phone_no']??'' }}">
                                        </div>
                                    </div>
                                    <div class=" form-group">
                                            <div class="controls">
                                                <label>Address</label>
                                                <input type="text" class="form-control" name="address" value="{{ $team['profile']['address']??'' }}"
                                                    placeholder="Address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>Website</label>
                                            <input type="text" class="form-control" name="website" value="{{ $team['profile']['website']??'' }}"
...
<link rel="stylesheet" type="text/css"
    href="{{ URL::to('modules/admin/app-assets/vendors/css/forms/icheck/icheck.css') }}">
<link rel="stylesheet" type="text/css"
    href="{{ URL::to('modules/admin/app-assets/vendors/css/forms/icheck/custom.css') }}">
<link rel="stylesheet" type="text/css"
    href="{{asset('/modules/admin')}}/app-assets/css/plugins/forms/validation/form-validation.css">
{{--
<link rel="stylesheet" type="text/css"
    href="{{asset('/modules/admin')}}/app-assets/vendors/css/forms/selects/select2.min.css"> --}}
{{--
<link rel="stylesheet" type="text/css"
    href="{{asset('/modules/admin')}}/app-assets/vendors/css/pickers/pickadate/pickadate.css"> --}}
<!-- END: Vendor CSS-->
...
<!-- BEGIN: Page CSS-->
<link rel="stylesheet" type="text/css"
    href="{{asset('/modules/admin')}}/app-assets/css/core/menu/menu-types/horizontal-menu.css">
<link rel="stylesheet" type="text/css"
    href="{{asset('/modules/admin')}}/app-assets/css/core/colors/palette-gradient.css">
{{--
<link rel="stylesheet" type="text/css" href="{{asset('/modules/admin')}}/app-assets/css/pages/page-users.css"> --}}

<link rel="stylesheet" type="text/css"
    href="{{ URL::to('modules/admin/app-assets/css/plugins/forms/checkboxes-radios.css') }}">
<!-- END: Page CSS-->
...
<script src="{{ URL::to('modules/admin/app-assets/vendors/js/forms/icheck/icheck.min.js') }}"></script>
...
{{-- <script src="{{asset('/modules/admin')}}/app-assets/js/scripts/pages/page-users.js"></script> --}}
{{-- <script src="{{asset('/modules/admin')}}/app-assets/js/scripts/navs/navs.js"></script> --}}
<script src="{{ URL::to('modules/admin/app-assets/js/scripts/forms/checkbox-radio.js') }}"></script>
<!-- END: Page JS-->
<script>
