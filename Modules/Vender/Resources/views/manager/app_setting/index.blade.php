...
@section('content')
    <div class="row">
        ...
        font-size: 17px; ">
                <img src="/business_manager.png" style="width: 22px;margin-top: -5px;"> Business Manager</h2>
        </div>
        <div class="col-md-9" id="contens"
            ...
            <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;">
                <a id="headingCollapse1" href="{{ route('vender.user.group') }}" class="card-header info mt-2"
