    ...
    <div class="container-fluid px-1 px-md-1 mt-1">
        <div class="row align-items-start m-0">
            ...
            <div class="col-12 col-lg-9 p-0">
                <form action="{{ route('vender.user.group.update') }}" id="contens" method="POST"
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="name" class="form-control"
                                    value="{{ str_replace('SVP_B_' . $vender_id, '', $role['name']) }}" onkeyup="lookup(this);"
                                    name="name" placeholder="User group name">
                                @if ($errors->has('name'))
                                ...
                                <div class="col-md-8">
                                    <div class="row m-0">
                                        @foreach ($permissions[$key] as $per)
                                            {{-- Stack checkboxes perfectly on smaller screens --}}
