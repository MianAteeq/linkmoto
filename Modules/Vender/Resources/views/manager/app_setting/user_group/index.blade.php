                ...
                <div class="card-content">
                    <div class="card-body" style="padding-left: 0px;padding-right: 0px;">
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                               ...
                                               <td>{{str_replace("SVP_B_".$vender_id,"",$role['name'])}}</td>
                                               <td>{{$role['group_type']}}</td>

                                               <td><a href="{{route('vender.user.group.edit',$role['id'])}}"><i class="ft-edit"></i></a> <a href="{{route('vender.user.group.view',$role['id'])}}"><i class="ft-eye"></i></a></td>
                                           </tr>
                        ...
                        <div class="footers">
                            ...
                            <a href="{{route('vender.user.group.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
