...
/* Ensure header text doesn't slide under the icons */
.card-header.info {
...
/* 2. Override the inline heights on the sidebar box to prevent overflow */
.col-md-3>div {
  height: auto !important;
  min-height: 180px;
  /* Provides a base size but allows growth */
  padding-bottom: 20px;
}
...
@media (max-width: 767px) {
  ...
  /* Adjust the Subscriptions/Invoices top navigation links */
      ...
                 <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
          ...
                          <li class="breadcrumb-item">Invoices
                            </li>
                          <li class="breadcrumb-item">{{$invoice['number']}}
                            </li>
...
<div class="row">
      <div class="col-md-3">
            <div @if($invoice['status']=="open" )  style="border-radius: 7px;border: 2px solid black;height: 240px "
      @else style="border-radius: 7px;border: 2px solid black;height: 180px " @endif>
      ...
                  <div class="footers" style="text-align: center;">
                      @if($invoice['status']=="open")  <a href="{{route('vender.invoice.pay',$invoice['id'])}}">
           <button type="button" style="width: 80%;" class="btn btn-dark round btn-min-width mr-1 mb-1"                
               >Pay</button></a>
                            @endif
                        <a href="{{$pdf}}">  <button type="button" style="width: 80%;"
            class="btn btn-dark round btn-min-width mr-1 mb-1"                    >Download</button></a>
...
            border-bottom-right-radius: 6px;"             class="collapse" aria-expanded="false">
      ...
                  <a id="headingCollapse14"  class="card-header info mt-2 collapsed"
        ...
                    </a>
                  <div id="total" role="tabpanel" aria-labelledby="headingCollapsebusinesss_info"             style="border-left: 2px solid black;
            margin-top: -4px;
            border-right: 2px solid black;
            border-bottom: 2px solid black;
            border-bottom-left-radius: 6px;
