...
<div class="row">
    <div class="col-md-3">
        <div @if($invoice['status']=="open")  style="border-radius: 7px;border: 2px solid black;height: 240px " @else style="border-radius: 7px;border: 2px solid black;height: 180px " @endif>
        ...
        <div style="margin: 30px;margin-top: 30px;font-weight: 500;font-size: 15px;">
            ...
            <div class="footers" style="text-align: center;">
              @if($invoice['status']=="open")  <a href="{{route('vender.invoice.pay',$invoice['id'])}}">  <button type="button" style="width: 80%;" class="btn btn-dark round btn-min-width mr-1 mb-1"
                    >Pay</button></a>
                    @endif
                <a href="{{$pdf}}">  <button type="button" style="width: 80%;" class="btn btn-dark round btn-min-width mr-1 mb-1"
                    >Download</button></a>
