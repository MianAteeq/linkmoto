...
@section('css_custom')
    ...
    <style>
        ...
        @media (max-width: 991px) {
            ...
            /* Ensures sidebar has breathing room when stacked above main content */
            .col-lg-3 {
                margin-bottom: 25px;
            }
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Initialize DataTable with destroy: true to prevent conflicts
            var oTable = $('.zero-configuration').DataTable({
                "destroy": true, // <-- THIS FIXES THE ERROR
