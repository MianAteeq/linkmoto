        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Subscriptions
                </li>
...
<div class="row">
    ...
    padding-right: 0;height:460px">
    <div class="row ">
        <a href="{{route('vender.subscription.index')}}"><h4 class="h3"  style="border-radius: 7px; border: 2px solid #ff6600; padding: 10px; font-weight: 600; font-size: 17px; color: #ff6600;margin-left: 15px;"> Subscriptions</h2></a>
         <a href="{{route('vender.invoice.index')}}"><h4 class="h3" style="border-radius: 7px; border: 2px solid black; padding: 10px; font-weight: 600; font-size: 17px; color: black;margin-left: 15px;"> Invoices</h2></a>
      ...
      <div style="border: 2px solid black;border-radius: 6px;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Subscriptions</h3>
            </div>
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         @foreach ($subscriptions as $account)
                            <tr>
                                ...
                                <td>Active</td>
                                <td><a href="{{route('vender.subscription.detail',$account['id'])}}"><i class="ft-eye"></i></a></td>
                            </tr>
