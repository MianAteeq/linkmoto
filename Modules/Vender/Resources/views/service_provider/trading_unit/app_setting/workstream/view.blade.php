    ...
    <div class="content-header bg-white">
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                <h3 class="h3">View Workstream</h3>
                <div class="breadcrumb-wrapper col-12 p-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">View Workstream
                        </li>
                    </ol>
                </div>
            </div>
            ...
            border-bottom-right-radius: 6px;"
                    ...
                    <div class="card-content">
                        ...
                        <div class="footers">
                            ...
                            <a
                                href="{{ route('vender.service.provider.trading.unit.edit.work.stream', [$workstream['id'], $trading_unit['id']]) }}">
