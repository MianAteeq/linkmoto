        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
            ...
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"> Workstream
                    </li>
    ...
    <div class="col-md-9" id="contens" style="border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;margin-top: 0px;">
        ...
        <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;margin-top: -6px;">
            ...
            <a id="headingCollapse1" href="{{redirect()->back()->getTargetUrl()}}" class="card-header info mt-2" style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;" data-toggle=""  aria-expanded="false" >
                <div class="card-title lead collapsed">Update Workstream</div>
            </a>
            ...
            class="collapse show" aria-expanded="false">
                <div class="card-content">
                    <form action="{{route('vender.service.provider.trading.unit.update.work.stream.submit')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens">
                        @csrf
                        <div class="link-body"  style="padding: 10px">

                            <input type="hidden" name="trading_unit_id" value="{{$trading_unit['id']}}">
                            <input type="hidden" name="id" value="{{$workstream['id']}}">
                            <div class="form-group row">
                                <label class="col-md-4 label-control" for="eventRegInput5">Workstream name  * </label>
                                <div class="col-md-8 mx-auto">
                                    <input type="text" id="workstream_name" class="form-control" value="{{$workstream['workstream_name']}}" onkeyup="lookup(this);" name="workstream_name" placeholder="Workstream name">
                                    @if($errors->has('workstream_name'))

                                    <p class="text-danger workstream_name" style="padding-left: 10px;width:100%;margin-bottom: -8px;">{{ $errors->first('workstream_name') }}</p>
                                    @else
                                    <p class="text-danger workstream_name" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                                @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="margin-bottom: 0.5rem ">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <select class="form-control" name="status" >
                                        <option value="ACTIVE" @if($workstream['status']=='ACTIVE') selected @endif >ACTIVE</option>
                                        <option value="INACTIVE" @if($workstream['status']=='INACTIVE') selected @endif>INACTIVE</option>
