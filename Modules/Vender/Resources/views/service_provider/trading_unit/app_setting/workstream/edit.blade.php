    ...
    <div class="content-header bg-white">
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                <h3 class="h3">Edit Workstream</h3>
                <div class="breadcrumb-wrapper col-12 p-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a style="color: black"
                                href="{{ url('vender/service/provider/trading/unit/app/setting/' . $trading_unit['id']) }}#collaptr_Workstream_info">Workstream
                            </a>
                        </li>
                        <li class="breadcrumb-item">
                            <a style="color: black"
                                href="{{ url('vender/service/provider/trading/unit/view/work/stream/7/' . $trading_unit['id']) }}">
                                View Workstream
                            </a>
                        </li>
                        <li class="breadcrumb-item">
        ...
        <div class="col-md-9" id="contens"
            ...
            border-bottom-right-radius: 6px;"
                    ...
                    <div class="card-content">
                        <form action="{{ route('vender.service.provider.trading.unit.update.work.stream.submit') }}"
                            id="contens" method="POST" enctype="multipart/form-data" id="contens">
                            @csrf
                            <div class="link-body" style="padding: 10px">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <input type="text" id="workstream_name" class="form-control"
                                            value="{{ $workstream['workstream_name'] }}" onkeyup="lookup(this);"
                                            name="workstream_name" placeholder="Workstream name">
                                        @if ($errors->has('workstream_name'))
                                            <p class="text-danger workstream_name"
                                                style="padding-left: 10px;width:100%;margin-bottom: -8px;">
                                                {{ $errors->first('workstream_name') }}</p>
                                        @else
                                            <p class="text-danger workstream_name"
