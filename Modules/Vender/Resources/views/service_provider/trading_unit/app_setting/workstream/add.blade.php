            ...
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"> <a style="color: black"
                                href="{{ url('vender/service/provider/trading/unit/app/setting/' . $trading_unit['id']) }}#collaptr_Workstream_info">
                                Workstream</a>
                        </li>
                        </li>
                        <li class="breadcrumb-item">Add Workstream
                        </li>
        ...
        <div class="col-md-9" id="contens"
            ...
            border-bottom-right-radius: 6px;"
                    ...
                    <div class="card-content">
                        <form action="{{ route('vender.service.provider.trading.unit.add.work.stream.submit') }}"
                            ...
                            <div class="link-body" style="padding: 10px">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <input type="text" id="workstream_name" class="form-control" value=""
                                            onkeyup="lookup(this);" name="workstream_name" placeholder="Workstream name">
