      ...
      <div class="link-body" style="padding: 10px">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="name" class="form-control" value="" onkeyup="lookup(this);" name="name"
              placeholder="Trade unit name">
            @if ($errors->has('name'))
        ...
        <div class="form-group row " id="company_name">
          ...
          <div class="col-md-8 mx-auto">
            {{-- <input type="text" id="company" class="form-control"   value="{{auth()->user()->profile->company_name}}"
            disabled onkeyup="lookup(this);" placeholder="Company Name"> --}}
        ...
        <div class="form-group row" id="site_show" @if ($user['profile']['operation_type'] !='On-site' )
        ...
        <div class="form-group row mobile_show" @if ($user['profile']['operation_type'] !='Mobile' )
          style="display: none" @endif>
          <label class="col-md-4 label-control" for="eventRegInput5">Mobile city / town * (?) </label>
          <div class="col-md-8 mx-auto">
            <input type="text" id="city" class="form-control" value="" onkeyup="lookup(this);" name="city"
        ...
        <div class="form-group row mobile_show" @if ($user['profile']['operation_type'] !='Mobile' )
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="postcode" class="form-control" value="" onkeyup="lookup(this);" name="postcode"
        ...
        <div class="form-group row mobile_show" @if ($user['profile']['operation_type'] !='Mobile' )
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="radius" class="form-control" value="" onkeyup="lookup(this);" name="radius"
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="tel" id="mobile" class="form-control" value="" onkeyup="lookup(this);" name="mobile"
              placeholder="Mobile">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="email" id="email" class="form-control" value="" onkeyup="lookup(this);" name="email"
              placeholder="Email">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="url" id="website" class="form-control" value="" name="website" placeholder="Website">
