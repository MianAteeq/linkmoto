    ...
    <form action="{{ route('vender.service.provider.trading.unit.update') }}" id="contens" method="POST"
      ...
      <div class="link-body" style="padding: 10px">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <select id="trading_template" name="trading_template" class="form-control" onkeyup="lookup(this);"
        ...
        <div class="form-group row" id="trading_name" @if ($trading_unit['trading_template']==1) style="display: none"
          @endif>
        ...
        <div class="form-group row " id="company_name">
          ...
          <div class="col-md-8 mx-auto">
            ...
            <p class="text-danger company" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
              Field is
              Required !</p>
          ...
          <div class="col-md-8 mx-auto">
            <div class="d-flex flex-column">
              <div class="custom-control custom-checkbox mb-2">
                <input type="checkbox" name="operation_type[]" value="On-site" class="custom-control-input" id="On-site"
              ...
              <div class="custom-control custom-checkbox mb-2">
                <input type="checkbox" name="operation_type[]" value="Mobile" class="custom-control-input" id="Mobile"
        ...
        <div class="form-group row" id="site_show" @if ($trading_unit['operation_type']=='Mobile' )
          ...
          <div class="col-md-8 mx-auto">
            <select id="site_id" name="site_id" class="form-control" style="width: 60%;border-radius: 7px;">
              ...
              <option value="{{ $site['id'] }}" @if ($trading_unit['site_id']==$site['id']) selected @endif>
                {{ $site['address_line_1'] }}
            ...
            <p class="text-danger site_id" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
              Field is
              Required !</p>
          </div>
        </div>
        <div class="form-group row mobile_show" @if ($trading_unit['operation_type']=='On-site' ) style="display: none"
          @endif>
          <label class="col-md-4 label-control" for="eventRegInput5">Mobile city / town * (?) </label>
          <div class="col-md-8 mx-auto">
            <input type="text" @if ($trading_unit['operation_type']=='Both' ) style="display: none" @endif id="city"
              class="form-control" value="{{ $trading_unit['city'] }}" onkeyup="lookup(this);" name="city"
              placeholder="Mobile city / town">
            ...
            <p class="text-danger city" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
              Field is
              Required !</p>
        ...
        <div class="form-group row mobile_show" @if ($trading_unit['operation_type']=='On-site' ) style="display: none"
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="postcode" @if ($trading_unit['operation_type']=='Both' ) style="display: none" @endif
              class="form-control" value="{{ $trading_unit['postcode'] }}" onkeyup="lookup(this);" name="postcode"
              placeholder="Mobile postcode">
            <p @if ($trading_unit['operation_type']=='Both' ) style="display: block" @else style="display: none" @endif
              class="postcode_show">{{ $trading_unit['postcode'] }}</p>
            <p class="text-danger postcode" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">
              This Field is
              Required !</p>
        ...
        <div class="form-group row mobile_show" @if ($trading_unit['operation_type']=='On-site' ) style="display: none"
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="radius" class="form-control" value="{{ $trading_unit['radius'] }}"
              onkeyup="lookup(this);" name="radius" placeholder="Mobile distance">
            <p class="text-danger radious" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
              Field is
              Required !</p>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="tel" id="mobile" class="form-control" value="{{ $trading_unit['mobile'] }}"
              onkeyup="lookup(this);" name="mobile" placeholder="Mobile">
            <p class="text-danger mobile" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
              Field is
              Required !</p>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="tel" id="landline" class="form-control" value="{{ $trading_unit['landline'] }}"
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="email" id="email" class="form-control" value="{{ $trading_unit['email'] }}"
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="website" class="form-control" value="{{ $trading_unit['website'] }}"
              onkeyup="lookup(this);" name="website" placeholder="Website">
            <p class="text-danger website" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">
              Invalid Website !
            </p>
