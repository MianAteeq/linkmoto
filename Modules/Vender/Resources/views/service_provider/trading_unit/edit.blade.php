                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <select id="trading_template" name="trading_template" class="form-control" onkeyup="lookup(this);" style="width: 60%;border-radius: 7px;">
                            ...
                            <option value="1"  @if($trading_unit['trading_template']==1) selected @endif>Registered {{$user['profile']['organization_status']}} name</option>
                            <option value="2"  @if($trading_unit['trading_template']==2) selected @endif>Registered {{$user['profile']['organization_status']}} & trading name</option>
