...
<div class="row">
    ...
    <div class="col-md-9"  style="border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;margin-top: 0px;">
        <div class="row ">
            <h4 class="h3" style="border-radius: 7px; border: 2px solid #ff6600; padding: 10px; font-weight: 600; font-size: 17px; color: #ff6600;margin-left: 15px;"> Trade units</h2>
        ...
        padding-right: 0;">
            <div class="row" style="margin-right: 0;margin-left: 0;">
                <div class="col-md-12" style="border-bottom: 2px solid black;">
                 <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Trade units</h3>
                </div>
    ...
    @endif
                                    ...
                                    <td>{{$unit['mobile']}}</td>
                                    <td>{{$unit['status']}}</td>
                                    <td><a href="{{route('vender.service.provider.trading.unit.edit',$unit['id'])}}"><i class="ft-edit"></i></a> <a href="{{route('vender.service.provider.trading.unit.view',$unit['id'])}}"><i class="ft-eye"></i></a></td>
                                </tr>
             ...
             <div class="footers">
                ...
                <a href="{{route('vender.service.provider.trading.unit.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
