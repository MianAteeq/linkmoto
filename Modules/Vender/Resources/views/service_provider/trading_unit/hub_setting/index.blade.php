...
/* Data Row Formatting for Mobile */
.col-sm-5 h6 {
  font-weight: 700;
  margin-top: 10px;
}
...
.text-secondary {
  ...
  /* Prevents long URLs or emails from breaking layout */
  padding-bottom: 5px;
}
...
@media (min-width: 768px) {
  ...
  /* Restore action buttons inside panels (Edit buttons) */
  #contens .card-content .footers {
    flex-direction: row;
    justify-content: flex-end;
    padding-right: 15px;
  }

  #contens .card-content .footers a,
  #contens .card-content .footers button {
    width: auto !important;
  }

  /* Remove mobile spacing on desktop */
  .col-sm-5 h6 {
    margin-top: 0;
  }
}
    ...
    <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
      ...
      <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a style="color: black" href="{{route('vender.service.provider.trading.unit')}}">
              Trade unit information</a>
          </li>
  ...
  <div class="col-md-9" id="contens"
    ...
    <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;margin-top: -6px;">
      <a id="headingCollapse2" class="card-header info mt-2"
        ...
        data-toggle="collapse" href="#trade_unit" aria-expanded="false" aria-controls="trade_unit">
        <div class="card-title lead ">Trade unit information</div>
      </a>
      <div id="trade_unit" role="tabpanel" aria-labelledby="headingCollapsebusinesss_info" style="border-left: 2px solid black;
            margin-top: -4px;
      ...
      <div id="social_media" role="tabpanel" aria-labelledby="headingCollapsebusinesss_info" style="border-left: 2px solid black;
            margin-top: -4px;
            border-right: 2px solid black;
            border-bottom: 2px solid black;
            border-bottom-left-radius: 6px;
        ...
        <div class="card-content">
          ...
          <div class="footers">
            ...
            <a href="{{route('vender.service.provider.trading.unit.hub.setting.social.media',$trading_unit['id'])}}">
