    ...
    <div class="content-header bg-white">
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                <h3 class="h3">Edit Vehicle Specialist</h3>
                <div class="breadcrumb-wrapper col-12 p-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"> <a
                                href="{{ url('vender/service/provider/trading/unit/app/setting/' . $trading_unit['id']) }}#vehicle_specialist"
                                style="color: black">Vehicle Specialist</a>
                        </li>
        ...
        Hub profile settings </h2> </a> --}}
            ...
            border-bottom-right-radius: 6px;"
                    ...
                    <div class="card-content">
                        <form
                            action="{{ route('vender.service.provider.trading.unit.hub.setting.vehicle.specialist.submit') }}"
