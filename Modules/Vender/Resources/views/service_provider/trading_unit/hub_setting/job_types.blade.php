        ...
        <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;margin-top: -6px;">
            ...
            class="collapse show" aria-expanded="false">
                <div class="card-content">
                    <form action="{{route('vender.service.provider.trading.unit.hub.setting.job.type.submit')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <fieldset class="checkboxsas">
                                        <label>
                                        <input type="checkbox" name="job_type_id[]" @foreach ($trading_unit['job_types'] as $jobtype)  @if($job_type['id']==$jobtype['job_type_id']) checked @endif  @endforeach value="{{$job_type['id']}}">
                                            {{$job_type['name']}}
                                        </label>
                                    </fieldset>
                                  </div>
