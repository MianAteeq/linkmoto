            ...
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"> <a
                                href="{{ url('vender/service/provider/trading/unit/app/setting/' . $trading_unit['id']) }}#job_type"
                                style="color: black">Job Types</a>
                        </li>
                        <li class="breadcrumb-item"> Edit Job Types
                        </li>
                    </ol>
                </div>
            </div>
        ...
        Hub profile settings </h2> </a> --}}
            ...
            <div class="card default-collapse collapse-icon accordion-icon-rotate"
                ...
                <a id="headingCollapse1" href="{{ redirect()->back()->getTargetUrl() }}" class="card-header info mt-2"
                    ...
                    <div class="card-title lead collapsed">Edit job types</div>
                </a>
            ...
            border-bottom-right-radius: 6px;"
                    ...
                    <div class="card-content">
                        <form action="{{ route('vender.service.provider.trading.unit.hub.setting.job.type.submit') }}"
                            ...
                            <div class="link-body" style="padding: 10px">
                                ...
                                @foreach ($job_types as $key => $job_type)
                                    <div class="form-group row">
                                        @foreach ($job_types[$key] as $job_type)
                                            <div class="col-md-3">
                                                <fieldset class="checkboxsas">
                                                    <label>
                                                        <input type="checkbox" name="job_type_id[]"
                                                            @foreach ($trading_unit['job_types'] as $jobtype)
                        @if ($job_type['id'] == $jobtype['job_type_id']) checked @endif @endforeach
                                                            value="{{ $job_type['id'] }}">
                                                        {{ $job_type['name'] }}
                                                    </label>
                                                </fieldset>
