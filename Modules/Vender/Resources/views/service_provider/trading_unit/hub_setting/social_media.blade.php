        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
            ...
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"> Edit Social media profiles
                    </li>
    ...
    <div class="col-md-9" id="contens" style="border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;margin-top: 0px;">
        ...
        <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;margin-top: -6px;">
            ...
            <a id="headingCollapse1" href="{{redirect()->back()->getTargetUrl()}}" class="card-header info mt-2" style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;" data-toggle=""  aria-expanded="false" >
                <div class="card-title lead collapsed">Social media profiles</div>
            </a>
            ...
            class="collapse show" aria-expanded="false">
                <div class="card-content">
                    <form action="{{route('vender.service.provider.trading.unit.hub.setting.social.media.submit')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
                        <div class="link-body"  style="padding: 10px">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <input type="text" id="website" class="form-control" value="{{$trading_unit['hub_setting']['website']}}" onkeyup="lookup(this);" name="website" placeholder="Website">
                                    <p class="text-danger website" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 label-control" for="eventRegInput5">Facebook </label>
                                <div class="col-md-8 mx-auto">
                                    <input type="text" id="facebook" class="form-control" value="{{$trading_unit['hub_setting']['facebook']}}" onkeyup="lookup(this);" name="facebook" placeholder="Facebook">
                                    <p class="text-danger facebook" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 label-control" for="eventRegInput5">Instagram </label>
                                <div class="col-md-8 mx-auto">
                                    <input type="text" id="instagram" class="form-control" value="{{$trading_unit['hub_setting']['instagram']}}" onkeyup="lookup(this);" name="instagram" placeholder="Instagram">
                                    <p class="text-danger instagram" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 label-control" for="eventRegInput5">Trust Pilot </label>
                                <div class="col-md-8 mx-auto">
                                    <input type="text" id="trust_pilot" class="form-control" value="{{$trading_unit['hub_setting']['trust_pilot']}}" onkeyup="lookup(this);" name="trust_pilot" placeholder="Trust Pilot">
                                    <p class="text-danger trust_pilot" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                                </div>
                            </div>
