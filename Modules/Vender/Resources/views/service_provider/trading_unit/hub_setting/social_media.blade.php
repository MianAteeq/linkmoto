    ...
    <div class="content-header bg-white">
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                ...
                <h3 class="h3">Edit Social media profiles</h3>
                ...
                <div class="breadcrumb-wrapper col-12 p-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"> <a
                                href="{{ url('vender/service/provider/trading/unit/app/setting/' . $trading_unit['id']) }}#social_media"
                                style="color: black">Social Media Profiles</a>
                        </li>
        ...
        Hub profile settings </h2> </a> --}}
            ...
            border-bottom-right-radius: 6px;"
                    ...
                    <div class="card-content">
                        <form action="{{ route('vender.service.provider.trading.unit.hub.setting.social.media.submit') }}"
                            ...
                            <div class="link-body" style="padding: 10px">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <input type="text" id="website" class="form-control"
                                            value="{{ $trading_unit['hub_setting']['website'] }}" onkeyup="lookup(this);"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <input type="text" id="facebook" class="form-control"
                                            value="{{ $trading_unit['hub_setting']['facebook'] }}"
                                            onkeyup="lookup(this);" name="facebook" placeholder="Facebook">
                                        <p class="text-danger facebook"
                                            style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
                                            Field is Required !
                                        </p>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <input type="text" id="instagram" class="form-control"
                                            value="{{ $trading_unit['hub_setting']['instagram'] }}"
                                            onkeyup="lookup(this);" name="instagram" placeholder="Instagram">
                                        <p class="text-danger instagram"
                                            style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
                                            Field is Required !
                                        </p>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <input type="text" id="trust_pilot" class="form-control"
                                            value="{{ $trading_unit['hub_setting']['trust_pilot'] }}"
                                            onkeyup="lookup(this);" name="trust_pilot" placeholder="Trust Pilot">
                                        <p class="text-danger trust_pilot"
                                            style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
                                            Field is Required !
                                        </p>
                                    </div>
