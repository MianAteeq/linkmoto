    ...
    <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;margin-top: -6px;">
      ...
      <div id="collaptr_businesss_info" role="tabpanel" aria-labelledby="headingCollapsebusinesss_info" style="border-left: 2px solid black;
        ...
        <div class="card-content">
          <form action="{{route('vender.service.provider.trading.unit.hub.setting.social.media.submit')}}" id="contens"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8 mx-auto">
                  <input type="text" id="website" class="form-control"
                    value="{{$trading_unit['hub_setting']['website']}}" onkeyup="lookup(this);" name="website"
                    placeholder="Website">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8 mx-auto">
                  <input type="text" id="facebook" class="form-control"
                    value="{{$trading_unit['hub_setting']['facebook']}}" onkeyup="lookup(this);" name="facebook"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8 mx-auto">
                  <input type="text" id="instagram" class="form-control"
                    value="{{$trading_unit['hub_setting']['instagram']}}" onkeyup="lookup(this);" name="instagram"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8 mx-auto">
                  <input type="text" id="trust_pilot" class="form-control"
                    value="{{$trading_unit['hub_setting']['trust_pilot']}}" onkeyup="lookup(this);" name="trust_pilot"
                    placeholder="Trust Pilot">
