        ...
        <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;margin-top: -6px;">
            ...
            class="collapse show" aria-expanded="false">
                <div class="card-content">
                    <form action="{{route('vender.service.provider.trading.unit.hub.setting.product.offer.submit')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
                        <div class="link-body"  style="padding: 10px">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <input type="text" id="product_name" class="form-control" value="" onkeyup="lookup(this);" name="product_name" placeholder="Product Name">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <textarea type="text" id="description" class="form-control" value="" onkeyup="lookup(this);" name="description" placeholder="Product Description"></textarea>
                             ...
                             <div class="form-group row" style="margin-bottom: 0.5rem;display:none; ">
                                ...
                                <input type="hidden" name="what_include_id" id="what_include_id" value="">
                                <div class="col-md-8 mx-auto">
                            ...
                            <div class="form-group row" style="margin-bottom: 0.5rem ">
                             ...
                             <div class="form-group row" id="price_div">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <input type="number" id="price" class="form-control" value="" onkeyup="lookup(this);" name="price" placeholder="Product Price">
                                    <p class="text-danger price" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                                </div>
                            </div>
                             <div class="form-group row" id="price_poa" style="display:none;">
                                <label class="col-md-4 label-control" for="eventRegInput5">Price * </label>
                                <div class="col-md-8 mx-auto">
                            ...
                            <div class="form-group row" style="display:none;">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <textarea type="text" id="term_condition" class="form-control" value="" onkeyup="lookup(this);" name="term_condition" placeholder="Additional information"></textarea>
