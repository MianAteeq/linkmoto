        ...
        <div class="col-md-9" id="contens"
            ...
            border-bottom-right-radius: 6px;"
                    ...
                    <div class="card-content">
                        <form action="{{ route('vender.service.provider.trading.unit.hub.setting.product.offer.submit') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <input type="text" id="product_name" class="form-control" value=""
                                            onkeyup="lookup(this);" name="product_name" placeholder="Product Name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="textarea-wrapper">
                                            ...
                                            <textarea id="description" class="form-control textarea-main" name="description" placeholder="Product Description"></textarea>
                                        </div>
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <select class="form-control" name="job_coverage_id" id="job_coverage_id">
                                            @foreach ($price_types as $price_type)
                                                <option value="{{ $price_type['id'] }}">{{ $price_type['name'] }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="form-group row" style="display:none;">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <textarea type="text" id="term_condition" class="form-control" value="" onkeyup="lookup(this);"
                                            name="term_condition" placeholder="Additional information"></textarea>
