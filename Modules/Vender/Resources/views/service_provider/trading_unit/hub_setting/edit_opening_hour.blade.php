...
@section('css_custom')
    ...
    <style>
        /* Hide the broken template icons completely */
        #headingCollapse1::before,
        #headingCollapse1::after {
            display: none !important;
        }

        /* Rotate our new SVG arrow when the accordion is open */
    ...
    <div class="content-header bg-white">
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                <h3 class="h3">Edit Opening Hours</h3>
                <div class="breadcrumb-wrapper col-12 p-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                ...
                                style="color: black">App Settings</a>
                        </li>
                        <li class="breadcrumb-item"> <a
                                href="{{ url('vender/service/provider/trading/unit/app/setting/' . $trading_unit['id']) }}#opening_hours"
                                style="color: black">Opening Hours</a>
                        </li>
        ...
        Hub profile settings </h2> </a> --}}
            ...
            <div class="card default-collapse collapse-icon accordion-icon-rotate"
                ...
                <a id="headingCollapse1" href="#collaptr_businesss_info"
                    class="card-header info mt-2 d-flex justify-content-between align-items-center"
                    style="border: 2px solid black; border-radius: 7px !important; padding: 1.2rem 1rem; color: black !important; text-decoration: none;"
                    data-toggle="collapse" aria-expanded="false">

                    <div class="card-title lead" style="margin-bottom: 0;">Edit opening hours</div>
                ...
                <div id="collaptr_businesss_info" role="tabpanel" aria-labelledby="headingCollapse1"
                    ...
                    <div class="card-content">
                        <form action="{{ route('vender.service.provider.trading.unit.hub.setting.opening.hour.submit') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input type="checkbox" class="switch" name="is_monday"
                                                            value="1" data-on-label="Open" data-off-label="Closed"
                                                            id="is_monday"
                                                            @if ($trading_unit['hub_setting']['is_monday'] == 1) checked @endif />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-4">
                                                <select id="monday_start_time" name="monday_start_time"
                                                    @if ($trading_unit['hub_setting']['is_monday'] == 0) style="display: none; border-radius: 4px;" @else style="border-radius: 4px;" @endif
                                                    class="form-control">

                                                    <option value="none" selected="" disabled="">Select Start
                                                        Time</option>

                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['monday_start_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-4">
                                                <select id="monday_end_time" name="monday_end_time" class="form-control"
                                                    @if ($trading_unit['hub_setting']['is_monday'] == 0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                                                    <option value="none" selected="" disabled="">Select End Time
                                                    </option>

                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['monday_end_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input type="checkbox" class="switch" name="is_tuesday"
                                                            value="1" data-on-label="Open" data-off-label="Closed"
                                                            id="is_tuesday"
                                                            @if ($trading_unit['hub_setting']['is_tuesday'] == 1) checked @endif />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-4">
                                                <select id="tuesday_start_time" name="tuesday_start_time"
                                                    class="form-control"
                                                    @if ($trading_unit['hub_setting']['is_tuesday'] == 0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                                                    <option value="none" selected="" disabled="">Select Start
                                                        Time</option>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['tuesday_start_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                        ...
                        style="border-radius: 4px;" @endif>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['tuesday_end_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input type="checkbox" class="switch" name="is_wednesday"
                                                            value="1" data-on-label="Open" data-off-label="Closed"
                                                            id="is_wednesday"
                                                            @if ($trading_unit['hub_setting']['is_wednesday'] == 1) checked @endif />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-4">
                                                <select id="wednesday_start_time" name="wednesday_start_time"
                                                    class="form-control"
                                                    @if ($trading_unit['hub_setting']['is_wednesday'] == 0) style="display: none;border-radius: 4px;"
                        @else style="border-radius: 4px;" @endif>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['wednesday_start_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                        ...
                        @else style="border-radius: 4px;" @endif>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['wednesday_end_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input type="checkbox" class="switch" name="is_thursday"
                                                            value="1" data-on-label="Open" data-off-label="Closed"
                                                            id="is_thursday"
                                                            @if ($trading_unit['hub_setting']['is_thursday'] == 1) checked @endif />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-4">
                                                <select id="thursday_start_time" name="thursday_start_time"
                                                    class="form-control"
                                                    @if ($trading_unit['hub_setting']['is_thursday'] == 0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                                                    <option value="none" selected="" disabled="">Select Start
                                                        Time</option>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['thursday_start_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                        ...
                        style="border-radius: 4px;" @endif>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['thursday_end_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input type="checkbox" class="switch" name="is_friday"
                                                            value="1" data-on-label="Open" data-off-label="Closed"
                                                            id="is_friday"
                                                            @if ($trading_unit['hub_setting']['is_friday'] == 1) checked @endif />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-4">
                                                <select id="friday_start_time" name="friday_start_time"
                                                    class="form-control"
                                                    @if ($trading_unit['hub_setting']['is_friday'] == 0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                                                    <option value="none" selected="" disabled="">Select Start
                                                        Time</option>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['friday_start_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-4">
                                                <select id="friday_end_time" name="friday_end_time" class="form-control"
                                                    @if ($trading_unit['hub_setting']['is_friday'] == 0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                                                    <option value="none" selected="" disabled="">Select End Time
                                                    </option>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['friday_end_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input type="checkbox" class="switch" name="is_saturday"
                                                            value="1" data-on-label="Open" data-off-label="Closed"
                                                            id="is_saturday"
                                                            @if ($trading_unit['hub_setting']['is_saturday'] == 1) checked @endif />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-4">
                                                <select id="saturday_start_time" name="saturday_start_time"
                                                    class="form-control"
                                                    @if ($trading_unit['hub_setting']['is_saturday'] == 0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                                                    <option value="none" selected="" disabled="">Select Start
                                                        Time</option>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['saturday_start_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                        ...
                        style="border-radius: 4px;" @endif>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['saturday_end_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input type="checkbox" class="switch" name="is_sunday"
                                                            value="1" data-on-label="Open" data-off-label="Closed"
                                                            id="is_sunday"
                                                            @if ($trading_unit['hub_setting']['is_sunday'] == 1) checked @endif />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-4">
                                                <select id="sunday_start_time" name="sunday_start_time"
                                                    class="form-control"
                                                    @if ($trading_unit['hub_setting']['is_sunday'] == 0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                                                    <option value="none" selected="" disabled="">Select Start
                                                        Time</option>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['sunday_start_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-4">
                                                <select id="sunday_end_time" name="sunday_end_time" class="form-control"
                                                    @if ($trading_unit['hub_setting']['is_sunday'] == 0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                                                    <option value="none" selected="" disabled="">Select End Time
                                                    </option>
                                                    ...
                                                    @foreach ($hours as $hour)
                                                        <option value="{{ $hour }}"
                                                            @if ($trading_unit['hub_setting']['sunday_end_time'] == $hour) selected @endif>
                                                            {{ $hour }}</option>
                                                    @endforeach
