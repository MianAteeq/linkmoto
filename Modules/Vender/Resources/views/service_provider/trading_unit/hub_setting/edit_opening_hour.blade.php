...
/* Opening Hours Form Adjustments */
.form-group.row {
  margin-bottom: 15px;
}
...
/* Stacks switches and dropdowns neatly with spacing on mobile */
.col-md-8 .row>div {
  margin-bottom: 10px;
}
...
@media (min-width: 768px) {
  ...
  /* Remove spacing on nested rows since they sit inline on desktop */
  .col-md-8 .row>div {
    margin-bottom: 0;
  }
    ...
    <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;margin-top: -6px;">
      ...
      <div id="collaptr_businesss_info" role="tabpanel" aria-labelledby="headingCollapsebusinesss_info" style="border-left: 2px solid black;
        ...
        <div class="card-content">
          <form action="{{route('vender.service.provider.trading.unit.hub.setting.opening.hour.submit')}}" id="contens"
            method="POST" enctype="multipart/form-data" id="contens"> @csrf
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8 mx-auto">
                  <div class="row">
                    <div class="col-md-3">
                      <fieldset>
                        <div class="float-left">
                          <input type="checkbox" class="switch" name="is_monday" value="1" data-on-label="Open"
                            data-off-label="Closed" id="is_monday" @if ($trading_unit['hub_setting']['is_monday']==1)
                            checked @endif />
                        </div>
                      </fieldset>
                    </div>
                    <div class="col-md-4">
                      <select id="monday_start_time" name="monday_start_time" @if
                        ($trading_unit['hub_setting']['is_monday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif class="form-control">
                        <option value="none" selected="" disabled="">Select Start Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['monday_start_time']==$hour) selected
                          @endif>{{$hour}}</option>
                        @endforeach
                    ...
                    <div class="col-md-4">
                      <select id="monday_end_time" name="monday_end_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_monday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select End Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['monday_end_time']==$hour) selected
                          @endif>{{$hour}}</option>
                        @endforeach
                  ...
                  <p class="text-danger start_time"
                    style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field is Required !
                  </p>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-md-8 mx-auto">
                  <div class="row">
                    <div class="col-md-3">
                      <fieldset>
                        <div class="float-left">
                          <input type="checkbox" class="switch" name="is_tuesday" value="1" data-on-label="Open"
                            data-off-label="Closed" id="is_tuesday" @if ($trading_unit['hub_setting']['is_tuesday']==1)
                            checked @endif />
                        </div>
                      </fieldset>
                    </div>
                    <div class="col-md-4">
                      <select id="tuesday_start_time" name="tuesday_start_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_tuesday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select Start Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['tuesday_start_time']==$hour)
                    ...
                    <div class="col-md-4">
                      <select id="tuesday_end_time" name="tuesday_end_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_tuesday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select End Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['tuesday_end_time']==$hour) selected
                          @endif>{{$hour}}</option>
                        @endforeach
                ...
                <div class="col-md-8 mx-auto">
                  <div class="row">
                    <div class="col-md-3">
                      <fieldset>
                        <div class="float-left">
                          <input type="checkbox" class="switch" name="is_wednesday" value="1" data-on-label="Open"
                            data-off-label="Closed" id="is_wednesday" @if
                            ($trading_unit['hub_setting']['is_wednesday']==1) checked @endif />
                        </div>
                      </fieldset>
                    </div>
                    <div class="col-md-4">
                      <select id="wednesday_start_time" name="wednesday_start_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_wednesday']==0) style="display: none;border-radius: 4px;"
                        @else style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select Start Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['wednesday_start_time']==$hour)
                          selected @endif>{{$hour}}</option>
                        @endforeach
                    ...
                    <div class="col-md-4">
                      <select id="wednesday_end_time" name="wednesday_end_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_wednesday']==0) style="display: none;border-radius: 4px;"
                        @else style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select End Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['wednesday_end_time']==$hour)
                          selected @endif>{{$hour}}</option>
                        @endforeach
                ...
                <div class="col-md-8 mx-auto">
                  <div class="row">
                    <div class="col-md-3">
                      <fieldset>
                        <div class="float-left">
                          <input type="checkbox" class="switch" name="is_thursday" value="1" data-on-label="Open"
                            data-off-label="Closed" id="is_thursday" @if
                            ($trading_unit['hub_setting']['is_thursday']==1) checked @endif />
                        </div>
                      </fieldset>
                    </div>
                    <div class="col-md-4">
                      <select id="thursday_start_time" name="thursday_start_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_thursday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select Start Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['thursday_start_time']==$hour)
                          selected @endif>{{$hour}}</option>
                        @endforeach
                    ...
                    <div class="col-md-4">
                      <select id="thursday_end_time" name="thursday_end_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_thursday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select End Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['thursday_end_time']==$hour) selected
                          @endif>{{$hour}}</option>
                        @endforeach
                ...
                <div class="col-md-8 mx-auto">
                  <div class="row">
                    <div class="col-md-3">
                      <fieldset>
                        <div class="float-left">
                          <input type="checkbox" class="switch" name="is_friday" value="1" data-on-label="Open"
                            data-off-label="Closed" id="is_friday" @if ($trading_unit['hub_setting']['is_friday']==1)
                            checked @endif />
                        </div>
                      </fieldset>
                    </div>
                    <div class="col-md-4">
                      <select id="friday_start_time" name="friday_start_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_friday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select Start Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['friday_start_time']==$hour) selected
                          @endif>{{$hour}}</option>
                        @endforeach
                    ...
                    <div class="col-md-4">
                      <select id="friday_end_time" name="friday_end_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_friday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select End Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['friday_end_time']==$hour) selected
                          @endif>{{$hour}}</option>
                        @endforeach
                ...
                <div class="col-md-8 mx-auto">
                  <div class="row">
                    <div class="col-md-3">
                      <fieldset>
                        <div class="float-left">
                          <input type="checkbox" class="switch" name="is_saturday" value="1" data-on-label="Open"
                            data-off-label="Closed" id="is_saturday" @if
                            ($trading_unit['hub_setting']['is_saturday']==1) checked @endif />
                        </div>
                      </fieldset>
                    </div>
                    <div class="col-md-4">
                      <select id="saturday_start_time" name="saturday_start_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_saturday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select Start Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['saturday_start_time']==$hour)
                          selected @endif>{{$hour}}</option>
                        @endforeach
                    ...
                    <div class="col-md-4">
                      <select id="saturday_end_time" name="saturday_end_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_saturday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select End Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['saturday_end_time']==$hour) selected
                          @endif>{{$hour}}</option>
                        @endforeach
                ...
                <div class="col-md-8 mx-auto">
                  <div class="row">
                    <div class="col-md-3">
                      <fieldset>
                        <div class="float-left">
                          <input type="checkbox" class="switch" name="is_sunday" value="1" data-on-label="Open"
                            data-off-label="Closed" id="is_sunday" @if ($trading_unit['hub_setting']['is_sunday']==1)
                            checked @endif />
                        </div>
                      </fieldset>
                    </div>
                    <div class="col-md-4">
                      <select id="sunday_start_time" name="sunday_start_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_sunday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select Start Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['sunday_start_time']==$hour) selected
                          @endif>{{$hour}}</option>
                        @endforeach
                    ...
                    <div class="col-md-4">
                      <select id="sunday_end_time" name="sunday_end_time" class="form-control" @if
                        ($trading_unit['hub_setting']['is_sunday']==0) style="display: none;border-radius: 4px;" @else
                        style="border-radius: 4px;" @endif>
                        <option value="none" selected="" disabled="">Select End Time</option>

                        @foreach ($hours as $hour)
                        <option value="{{$hour}}" @if($trading_unit['hub_setting']['sunday_end_time']==$hour) selected
                          @endif>{{$hour}}</option>
                        @endforeach
