            ...
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a style="color: black"
                                href="{{ route('vender.service.provider.trading.unit') }}"> Trade unit information</a>
                        </li>
                        <li class="breadcrumb-item"> <a style="color: black"
                                        ...
                                        @endforeach --}}
                                            ...
                                            @foreach ($contacts as $contact)
                                                <tr>
                                                    ...
                                                    <td> <a
                                                            href="{{ route('vender.service.provider.trading.unit.app.data.quote.detail', $contact['id']) }}"><i
                                                                class="ft-eye"></i></a></td>
                                                </tr>
                                            @endforeach
