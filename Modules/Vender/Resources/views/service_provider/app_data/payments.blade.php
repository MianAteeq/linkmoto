        ...
        <div class="col-lg-9 col-md-12" style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding: 0;">
            ...
            <div class="row m-0">
                <div class="col-12 p-0" style="border-bottom: 2px solid black;">
                    <h3 style="font-size: 20px; padding: 10px 15px; color: black; margin: 0;">Payment</h3>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($contacts as $contact)
                                    <tr>
                                        ...
                                        <td>{{ $contact->pay_no }}</td>
                                        <td>{{ $contact['payment_date'] }}</td>
                                        <td>{{ $contact['payment_type'] }}</td>
