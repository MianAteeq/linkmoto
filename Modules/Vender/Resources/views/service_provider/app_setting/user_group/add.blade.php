        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a>Business Manager</a>
                </li>
                <li class="breadcrumb-item"><a>App settings</a>
                </li>
                <li class="breadcrumb-item"><a> User groups</a>
                </li>
                <li class="breadcrumb-item"><a> Add new user group</a>
                </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/group.png" style="width: 22px;margin-top: -5px;" > New user group
        </h4>
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
         ...
         <form action="{{route('vender.service.provider.user.group.store')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                         <fieldset class="checkboxsas">
                             <label>
                                 <input type="checkbox" class="permission_id" name="permission_id[]" value="{{$per['id']}}">
                                 {{ucwords($per['name'])}}
                             </label>
                         </fieldset>
                        </div>
