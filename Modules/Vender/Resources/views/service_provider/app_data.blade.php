...
@section('content')
    <div class="row">
        ...
        font-size: 17px; ">
                <img src="/service_provider.png" style="width: 22px;margin-top: -5px;margin-right: 3px;">Service Provider
                </h2>
        ...
        <div class="col-md-9" id="contens"
            ...
            <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;">
                ...
                <a id="headingCollapse1" href="{{ route('vender.service.provider.app.data.quotes') }}"
                    class="card-header info mt-2"
                    style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;">
                ...
                <a id="headingCollapse1" href="{{ route('vender.service.provider.app.data.jobs') }}"
                    class="card-header info mt-2"
                    style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;">
