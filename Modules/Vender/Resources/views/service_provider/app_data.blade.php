...
@media (max-width: 767px) {
  ...
  /* Add breathing room below the sidebar title */
  .col-md-3 {
    margin-bottom: 20px;
  }

  /* Stack the horizontal navigation links cleanly on mobile */
  .col-md-9>.row:first-child {
    display: flex;
  ...
  .col-md-9>.row:first-child a {
    width: 100%;
    margin-bottom: 10px;
  }

  /* Override the inline margin-left so they center perfectly on phones */
  .col-md-9>.row:first-child a h4 {
    margin-left: 0 !important;
    text-align: center;
  }
}
...
<div class="row">
  ...
  <div class="col-md-9" id="contens"
    ...
    <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;">
      ...
      <a id="headingCollapse1" href="{{route('vender.service.provider.app.data.contact')}}"
      ...
      <a id="headingCollapse1" href="{{route('vender.service.provider.app.data.vehicle')}}"
        class="card-header info mt-2"
      ...
      <a id="headingCollapse1" href="{{route('vender.service.provider.app.data.quotes')}}" class="card-header info mt-2"
        style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;">
        <div class="card-title lead collapsed">Quotes</div>
      </a>
      <a id="headingCollapse1" href="{{route('vender.service.provider.app.data.booking')}}"
        class="card-header info mt-2"
        style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;">
        <div class="card-title lead collapsed">Bookings</div>
      </a>
      <a id="headingCollapse1" href="{{route('vender.service.provider.app.data.jobs')}}" class="card-header info mt-2"
        style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;">
        <div class="card-title lead collapsed">Jobs</div>
      </a>
      <a id="headingCollapse1" href="{{route('vender.service.provider.app.data.invoices')}}"
        class="card-header info mt-2"
        style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;">
        <div class="card-title lead collapsed">Invoices</div>
      </a>
      <a id="headingCollapse1" href="{{route('vender.service.provider.app.data.payments')}}"
        class="card-header info mt-2"
        style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;">
