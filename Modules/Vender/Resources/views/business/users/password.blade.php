        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Reset Password
                </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/user.png" style="width: 22px;margin-top: -5px;" > Reset Password
        </h4>
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Reset Password</h3>
            </div>


         </div>
         <form action="{{route('vender.user.password.update')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
            <input type="hidden" name="id" value="{{$user['id']}}">
            <div class="link-body"  style="padding: 10px">

                <div class="form-group row">
                    <label class="col-md-4 label-control" for="eventRegInput5">New Password *</label>
                    <div class="col-md-8 mx-auto">
                        <input type="password" id="password" class="form-control"  onkeyup="lookup(this);" name="password" placeholder="New Password ">
                        <p class="text-danger password" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                        @if($errors->has('password'))

                        <p class="text-danger email" style="padding-left: 10px;width:100%;margin-bottom: -8px;">{{ $errors->first('password') }}</p>
                    @endif
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-4 label-control" for="eventRegInput5">Confirm Password *</label>
                    <div class="col-md-8 mx-auto">
                        <input type="password" id="password_confirmation" class="form-control"  onkeyup="lookup(this);" name="password_confirmation" placeholder="Confirm Password ">
                        <p class="text-danger password_confirmation" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                    </div>
                </div>
            ...
            <div class="footers">
                ...
                <button type="button" onclick="submitDetailsForm()" class="btn btn-dark round btn-min-width mr-1 mb-1" style="float: right;">Reset Password</button>
...
<script>
    function submitDetailsForm() {
        let array=['password','password_confirmation'];
