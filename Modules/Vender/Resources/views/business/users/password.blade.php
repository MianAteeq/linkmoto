  ...
  <div class="col-md-9"
    ...
    <div class="row" style="margin-right: 0;margin-left: 0;">
      <div class="col-md-12" style="border-bottom: 2px solid black;">
        <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Reset Password
        </h3>
      </div>


    </div>
    <form action="{{route('vender.user.password.update')}}" id="contens" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="link-body" style="padding: 10px">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="password" id="password" class="form-control" onkeyup="lookup(this);" name="password"
              placeholder="New Password ">
            <p class="text-danger password" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="password" id="password_confirmation" class="form-control" onkeyup="lookup(this);"
              name="password_confirmation" placeholder="Confirm Password ">
            <p class="text-danger password_confirmation"
      ...
      <div class="footers">
        ...
        <button type="button" onclick="submitDetailsForm()" class="btn btn-dark round btn-min-width mr-1 mb-1"
          style="float: right;">Reset Password</button>
