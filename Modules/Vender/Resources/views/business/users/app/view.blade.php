...
@section('css_custom')
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Overrides the inline height: 405px so the box can stretch vertically */
            .col-md-9 {
            ...
            /* Styles for the right column footer buttons */
            .col-md-9 .footers {
                padding-bottom: 15px;
                position: relative;
                /* Fixes overlap on mobile */
            }
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9" id="contens"
            style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;height:405px">
            <div class="row" style="margin-right: 0;margin-left: 0;">
                <div class="col-md-12" style="border-bottom: 2px solid black;">
                    <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">App
                    </h3>
                </div>
                <div class="col-md-12">
                                                ...
                                                @foreach ($app['user']['trading_units'] as $trade_unit)
                                                    <div class="col-md-4 ">
                                                        <span class="badge badge-success mt-1">
                                                            {{ $trade_unit['trading_unit']['name'] ?? '' }}</span>
                                                    </div>
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 text-secondary">
                                            ...
                                            <span class="badge badge-success">
                                                {{ $app['user']['trading_unit']['name'] ?? '' }}</span>
                ...
                <div class="footers">
                    <a href="{{ route('vender.user.app.edit', $app['id']) }}"> <button type="button"
                            class="btn btn-dark round btn-min-width mr-1 mb-1" style="float: right;">Edit</button></a>
