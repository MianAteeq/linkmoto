  ...
  <div class="col-md-9" id="contens" style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;
    ...
    <div class="row" style="margin-right: 0;margin-left: 0;">
      <div class="col-md-12" style="border-bottom: 2px solid black;">
        <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Users</h3>
      </div>
          ...
          <table class="table table-striped table-bordered zero-configuration">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Active</td>
                <td><a href="{{route('vender.user.edit',$user['id'])}}"><i class="ft-edit"></i></a> <a
                    href="{{route('vender.user.view',$user['id'])}}"><i class="ft-eye"></i></a></td>
              </tr>
              ...
              <tr>
                ...
                <td><a href="{{route('vender.user.edit',$account['id'])}}"><i class="ft-edit"></i></a> <a
                    href="{{route('vender.user.view',$account['id'])}}"><i class="ft-eye"></i></a></td>
              </tr>
    ...
    <div class="footers">
      ...
      <a href="{{route('vender.user.add')}}"> <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
