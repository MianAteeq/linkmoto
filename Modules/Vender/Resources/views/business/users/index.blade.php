                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td>Active</td>
                                <td><a href="{{route('vender.user.edit',$user['id'])}}"><i class="ft-edit"></i></a> <a href="{{route('vender.user.view',$user['id'])}}"><i class="ft-eye"></i></a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('vender.user.edit',$account['id'])}}"><i class="ft-edit"></i></a> <a href="{{route('vender.user.view',$account['id'])}}"><i class="ft-eye"></i></a></td>
                            </tr>
