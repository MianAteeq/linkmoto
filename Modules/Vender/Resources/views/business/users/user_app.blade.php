...
@media (max-width: 768px) {
  ...
  /* Styles for the left column buttons to make them full width on mobile */
              ...
              <table class="table table-striped table-bordered zero-configuration">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{route('vender.user.app.edit',$app['id'])}}"><i class="ft-edit"></i></a> <a
                        href="{{route('vender.user.app.view',$app['id'])}}"><i class="ft-eye"></i></a></td>
                  </tr>
