        ...
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb" style="padding-left: 0; background: transparent; margin-bottom: 10px;">
    ...
    <div class="row mt-2">
        <div class="col-12 col-lg-4 mb-3 mb-lg-0">
            <div style="border-radius: 7px;border: 2px solid black; ">
                <h4 class="h3"
                    style="font-weight: 600; font-size: 17px;padding: 1.36rem 0.5rem;border-bottom:2px solid; margin-bottom: 0;">
                    <img src="/home.png" style="width: 22px;margin-top: -5px;"> Business Information
                </h4>
                <p style="padding-left: 10px; padding-right: 10px; padding-top: 15px; line-height: 1.5rem; color: black;">
        ...
        <div class="col-12 col-lg-8" id="contens" style="margin-bottom: 10px;">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 text-secondary">
                                            {{ $user['profile']['document_proof_name'] }} <a
                                                ...
                                                style="float: right; color: white !important;" target="_blank"
                                ...
                                @if (
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 text-secondary">
                                            <p>Registered company number supplied. Proof not required.</p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
