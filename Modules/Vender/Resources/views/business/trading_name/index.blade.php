            ...
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Trading names
                        </li>
...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <div style="border-radius: 7px;border: 2px solid black; ">
                ...
                <p
                    ...
                    Add and manage the different
                    names your business operates
                    under. These names can be linked
                    to invoices, trade units, and
                    marketplace listings. Your
                    registered business name is
                    included automatically, but you can
                    add other trading names as
                    needed.
        ...
        <div class="col-md-9" id="contens"
            style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;
    padding-right: 0;">
                            ...
                            <tbody>
                                ...
                                @foreach ($trading_names as $trading_name)
                                    <tr>
                                        ...
                                        <td>{{ $trading_name['name'] }} @if ($trading_name['is_change'] == 1)
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('vender.trading.name.view', $trading_name['id']) }}"><i
                                                    class="ft-eye"></i></a>
                                        </td>
            ...
            <div class="footers">
                ...
                <a href="{{ route('vender.trading.name.add') }}"> <button type="button"
