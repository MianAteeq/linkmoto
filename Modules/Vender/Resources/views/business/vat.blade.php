...
@section('css_custom')
    ...
    <style>
        ...
        .custom-accordion-header.active {
            ...
            /* This makes it bolder when open */
        ...
        .custom-collapse-content {
            ...
            border: 2px solid black;
            border-top: none;
            /* Remove the thin gray border here */
            color: black;
        }

        .custom-collapse-content.show {
            display: flex !important;
            /* Change to flex instead of block to maintain your layout */
        }
...
@section('content')
    <div class="container-fluid px-md-4 mt-1" style="padding-left: 2px !important; padding-top: 2px !important;">
                    ...
                    <div class="flex-grow-1 d-flex flex-column" style="padding: 15px 10px; color: black;">
                        ...
                        @if ($status == 'Rejected')
                            <p
                                ...
                                <strong>Rejected reason</strong>: Incorrect VAT number - could not be verified. Please
                                provide valid VAT
                                number.
                            </p>
                        @endif
            ...
            <div class="col-xl-9 col-lg-12 mb-4 d-flex">
                <div class="accordion-wrapper w-100 d-flex flex-column" style="box-shadow: none;">
                    ...
                    <div class="custom-accordion-item d-flex flex-column flex-grow-1 mb-0">
                        ...
                        <div id="collaptr_businesss_info"
                            class="custom-collapse-content show flex-grow-1 d-flex flex-column">

                            <div class="flex-grow-1">
                                <div class="row info-row align-items-center">
                                    <div class="col-sm-5">
                                        <h6 class="mb-0" style="color: black;font-weight: 600;">UK VAT Registered</h6>
                                    </div>
                                ...
                                @if ($user['profile']['vat_register'] == 'YES')
                                    <div class="row info-row align-items-center">
                                        <div class="col-sm-5">
                                            <h6 class="mb-0" style="color: black;font-weight: 600;">UK VAT Number</h6>
                                        </div>
                                        <div class="col-sm-7 text-secondary" style="color: black !important;">
                                ...
                                <div class="row info-row align-items-center" style="border-bottom: none;">
                                    <div class="col-sm-5">
                                        <h6 class="mb-0" style="color: black;font-weight: 600;">Status</h6>
                                    </div>
                                    <div class="col-sm-7 text-secondary" style="color: black !important;">
