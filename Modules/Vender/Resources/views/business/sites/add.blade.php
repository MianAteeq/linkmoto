    ...
    <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
      ...
      <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Add new site
          </li>
...
<div class="row">
  <div class="col-md-3">
    <div style="border-radius: 7px;border: 2px solid black; ">
      <h4 class="h3" style="font-weight: 600; font-size: 17px;padding: 10px;color:black ">
        <img src="/home.png" style="width: 22px;margin-top: -5px;"> New Site
      </h4>
            ...
            <div id="collapsebusiness_vat" data-parent="#accordionWrap1" role="tabpanel" aria-labelledby="business_VAT"
              ...
              <div class="card-content">
                <div class="card-body" style="color:black">
                  <h6 class="h3" style="font-size: 14px;font-weight: bold;color:black">Acceptable proof (any
                    1 of the following):</h6>
      ...
      <div class="link-body" style="padding: 10px">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="address_line_1" value="" onkeyup="lookup(this);" class="form-control"
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="address_line_2" class="form-control" name="address_line_2" required value=""
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="eventRegInput5" class="form-control" name="address_line_3" value=""
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="eventRegInput5" class="form-control" name="address_line_4" value=""
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="postcode" id="postcode" class="form-control" onkeyup="lookup(this);" name="postcode" required
              value="" style="margin-top: 5px " placeholder="Postcode *">
        ...
        <div class="form-group row Poof_div">
          ...
          <div class="col-md-8 mx-auto">
            ...
            <input type="button" id="proof_of_main_contact" class="form-control form-btn" value="Document Upload"
              name="contact" placeholder="Document Upload ">
            <button type="button" class="btn btn-primary btn-sm view-btn" style="display: none"> <a href=""
