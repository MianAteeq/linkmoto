...
@section('css_custom')
    ...
    <style>
        ...
        /* Fix form inputs globally - consistent width */
        .form-control,
        .form-btn,
        select.form-control {
            width: 60%;
        ...
        @media (max-width: 768px) {
            ...
            /* Prevent the main content box from overflowing */
            #contens,
            .col-md-9[style] {
            ...
            /* Fix the inner form padding causing overflow */
            .link-body {
                padding: 10px !important;
                overflow: hidden !important;
            }

            /* Stack label and input, both full width, no bleed */
            .form-group.row {
            ...
            /* All inputs same width, no overflow */
            .form-control,
            .form-btn,
            select.form-control,
            input[type="text"],
                            ...
                            <div id="collapsebusiness_vat" data-parent="#accordionWrap1" role="tabpanel"
                                ...
                                <div class="card-content">
                                    <div class="card-body" style="color:black">
                                        <h6 class="h3" style="font-size: 14px;font-weight: bold;color:black">Acceptable
                                            proof (any
                ...
                <div class="link-body" style="padding: 10px">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="address_line_1" value="" onkeyup="lookup(this);"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="address_line_2" class="form-control" name="address_line_2" required
                                value="" style="margin-top: 5px " placeholder="Address line two ">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="eventRegInput5" class="form-control" name="address_line_3"
                                value="" style="margin-top: 5px " placeholder="Address line three ">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="eventRegInput5" class="form-control" name="address_line_4"
                                value="" style="margin-top: 5px " placeholder="Address line four ">
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 label-control" for="eventRegInput5"> Postcode <span
                                style="color:red;">*</span>
                        </label>
                        <div class="col-md-8 mx-auto">
                            <input type="postcode" id="postcode" class="form-control" onkeyup="lookup(this);"
                                name="postcode" required value="" style="margin-top: 5px "
