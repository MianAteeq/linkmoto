...
@media (max-width: 768px) {
  ...
  #contens {
    ...
    /* Overrides the JS fixed height calculation on mobile */
  }

  .footers {
    padding-bottom: 15px;
    /* Gives buttons breathing room at the bottom on mobile */
  }

  .col-md-9 {
    margin-top: 20px;
    /* Adds spacing between the left and right columns when stacked */
  }
}
</style>
@endsection
  ...
  <div class="col-md-3">
    <div style="border-radius: 7px;border: 2px solid black; ">
      <h4 class="h3" style="font-weight: 600; font-size: 17px;padding: 10px; ">
        <img src="/home.png" style="width: 22px;margin-top: -5px;"> Edit site
      </h4>
        ...
        <div id="accordionWrap1" role="tablist" aria-multiselectable="true">
          <div class="card accordion collapse-icon accordion-icon-rotate" style="box-shadow: none;">
            <a id="business_VAT" class="card-header info collapsed" data-toggle="collapse" href="#collapsebusiness_vat"
              ...
              <div class="card-title lead"> Proof of site (?)</div>
            </a>
            <div id="collapsebusiness_vat" data-parent="#accordionWrap1" role="tabpanel" aria-labelledby="business_VAT"
              ...
              <div class="card-content">
                <div class="card-body" style="color:black">
                  <h6 class="h3" style="font-size: 14px;font-weight: bold;">Acceptable proof (any
                    1 of the following):s</h6>
    ...
    {{-- <div class="cname_info mt-3"> ... </div> --}}
  </div>

  <div class="col-md-9"
    style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0; min-height: 545px; height: auto;">
    ...
    <form action="{{ route('vender.site.update') }}" id="contens" method="POST" enctype="multipart/form-data"> @csrf

      <input type="hidden" name="id" value="{{ $site['id'] }}">
      <div class="link-body" style="padding: 10px">

        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5"> Address Line 1 (?)<span
              style="color:red;">*</span></label>
          <div class="col-md-8 mx-auto">
            <input type="text" id="address_line_1" value="{{ $site['address_line_1'] }}" onkeyup="lookup(this);"
              class="form-control" name="address_line_1" required placeholder="Address line one *">
        ...
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5"> Address Line 2 </label>
          <div class="col-md-8 mx-auto">
            <input type="text" id="address_line_2" class="form-control" name="address_line_2" required
              value="{{ $site['address_line_2'] }}" style="margin-top: 5px " placeholder="Address line two ">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5"> Address Line 3 </label>
          <div class="col-md-8 mx-auto">
            <input type="text" id="eventRegInput5" class="form-control" name="address_line_3"
              value="{{ $site['address_line_3'] }}" style="margin-top: 5px " placeholder="Address line three ">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5"> Address Line 4 </label>
          <div class="col-md-8 mx-auto">
            <input type="text" id="eventRegInput5" class="form-control" name="address_line_4"
              value="{{ $site['address_line_4'] }}" style="margin-top: 5px " placeholder="Address line four ">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5"> City / Town <span
              style="color:red;">*</span></label>
          <div class="col-md-8 mx-auto">
            <select name="city" id="city" class="form-control select2" style="max-width:60%!important">
              @foreach ($cities as $city)
              <option value="{{ $city }}" @if ($site['city']=='{{ $city }}' ) selected @endif>
                {{ $city }}
              </option>
              @endforeach
            </select>
        ...
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5"> Postcode <span style="color:red;">*</span>
          </label>
          <div class="col-md-8 mx-auto">
            <input type="postcode" id="postcode" class="form-control" onkeyup="lookup(this);" name="postcode" required
              value="{{ $site['postcode'] }}" style="margin-top: 5px " placeholder="Postcode *">
          </div>
        </div>

        <div class="form-group row Poof_div">
          <label class="col-md-4 label-control" for="eventRegInput5">Proof of site
          ...
          <div class="col-md-8 mx-auto">
            ...
            <button type="button" class="btn btn-primary btn-sm view-btn"> <a href="{{ URL::to($site['proof']) }}"
