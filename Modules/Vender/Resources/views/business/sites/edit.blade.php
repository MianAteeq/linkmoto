...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9"
            style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;height: 545px;">
            ...
            <form action="{{ route('vender.site.update') }}" id="contens" method="POST" enctype="multipart/form-data"
                id="contens"> @csrf
                ...
                <div class="link-body" style="padding: 10px">
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 label-control" for="eventRegInput5"> Address Line 1 (?)<span style="color:red;">*</span></label>
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="address_line_1" value="{{ $site['address_line_1'] }}"
                                onkeyup="lookup(this);" class="form-control" name="address_line_1" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="address_line_2" class="form-control" name="address_line_2" required
                                value="{{ $site['address_line_2'] }}" style="margin-top: 5px "
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="eventRegInput5" class="form-control" name="address_line_3"
                                value="{{ $site['address_line_3'] }}" style="margin-top: 5px "
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="eventRegInput5" class="form-control" name="address_line_4"
                                value="{{ $site['address_line_4'] }}" style="margin-top: 5px "
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 label-control" for="eventRegInput5"> City / Town <span style="color:red;">*</span></label>
                        <div class="col-md-8 mx-auto">
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 label-control" for="eventRegInput5"> Postcode <span style="color:red;">*</span> </label>
                        <div class="col-md-8 mx-auto">
                            <input type="postcode" id="postcode" class="form-control" onkeyup="lookup(this);"
                                name="postcode" required value="{{ $site['postcode'] }}" style="margin-top: 5px "
                    ...
                    <div class="form-group row Poof_div">
                        ...
                        <div class="col-md-8 mx-auto">
                            ...
                            <input type="button" id="proof_of_main_contact" class="form-control form-btn"
                                value="{{ $site['proof_name'] ?? 'Document Upload' }}" name="contact"
                                placeholder="Document Upload ">
                            <button type="button" class="btn btn-primary btn-sm view-btn"> <a
                                    href="{{ URL::to($site['proof']) }}" id="view_file" target="_blank"
