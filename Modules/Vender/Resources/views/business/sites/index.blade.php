...
@media (max-width: 768px) {
  ...
  #contens {
    ...
    /* Overrides fixed JS height */
    margin-top: 20px;
    /* Spacing below the info box */
  }
    ...
    <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
      ...
      <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Sites
          </li>
        </ol>
      </div>
    </div>
...
<div class="row">
  <div class="col-md-3">
    <div style="border-radius: 7px;border: 2px solid black; ">
      ...
      <p
        ...
        locations. <strong> Your registered
          business address will be added
          automatically as a site once your
          business is verified.</strong><br>
        Each trade unit must be linked to
        a verified site, so add additional
        sites if they operate from different
        addresses.
      </p>
    </div>
  </div>
  <div class="col-md-9" id="contens"
          ...
          <table class="table table-striped table-bordered zero-configuration">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $site['address_line_1'] }} {{ $site['address_line_2'] }} @if ($site['is_change'] == 1)
                ...
                <td> {{ $site['status'] }}</td>
                <td>
                  <a href="{{ route('vender.site.view', $site['id']) }}"><i class="ft-eye"></i></a>
                </td>
              </tr>
              @endforeach
            </tbody>
    ...
    <div class="footers">
      <a href="{{ route('vender.site.add') }}"> <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
