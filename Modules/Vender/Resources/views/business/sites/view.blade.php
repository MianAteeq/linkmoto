...
@section('css_custom')
    ...
    <style>
        ...
        /* Internal Card Elements Preserved */
        .card-body h6 {
            font-weight: 600;
            color: black;
        }
        ...
        @media (max-width: 991.98px) {
            ...
            /* Footer buttons stretch to 100% on mobile */
            .footers .btn-dark {
            ...
            /* FIX: Make sure the "View" button shrinks to fit its text */
            .btn-primary_2 {
                float: none !important;
            ...
            <div class="col-12 col-md-12 col-lg-3 info-sidebar-wrapper d-flex mb-3 mb-lg-0">
                <div class="info-sidebar d-flex flex-column">
                    <h4
                        ...
                        <img src="/home.png" style="width: 20px;"> Site
                    </h4>

                    <div
                        style="border-top: 2px solid black; padding: 14px 16px; line-height: 1.6; color: #333; font-size: 0.9rem;">
                        <strong>{{ $site['address_line_1'] }} , {{ $site['address_line_2'] }}</strong> <br>
                ...
                <div class="main-content-box w-100" id="contens">
                        ...
                        <div class="card-content">
                            <div class="card-body" style="padding: 20px;">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-8 text-secondary">{{ $site['address_line_1'] }}</div>
                                </div>
                                <hr style="margin-top: 10px; margin-bottom: 10px;">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-8 text-secondary">{{ $site['address_line_2'] }}</div>
                                </div>
                                <hr style="margin-top: 10px; margin-bottom: 10px;">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-8 text-secondary">{{ $site['address_line_3'] }}</div>
                                </div>
                                <hr style="margin-top: 10px; margin-bottom: 10px;">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-8 text-secondary">{{ $site['address_line_4'] }}</div>
                                </div>
                                <hr style="margin-top: 10px; margin-bottom: 10px;">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-8 text-secondary">{{ $site['city'] }}</div>
                                </div>
                                <hr style="margin-top: 10px; margin-bottom: 10px;">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-sm-8 text-secondary">{{ $site['postcode'] }}</div>
                                </div>
                                <hr style="margin-top: 10px; margin-bottom: 10px;">
                                ...
                                <div class="row mb-1 align-items-center">
                                    ...
                                    <div class="col-sm-8 text-secondary">
                                        @if ($site['proof_name'] == null)
                                            <p class="m-0">Registered address. Covered by business verification.</p>
                                        @else
                                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                                <span>{{ $site['proof_name'] ?? 'N/A' }}</span>
                    ...
                    @if ($site['status'] != 'Pending' && $site['status'] != 'Verified')
                        <div class="footers mt-auto">
                            <a href="{{ route('vender.site.edit', $site['id']) }}">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // FIX: Only calculate fixed height on desktop screens to prevent footer cut-off on mobile
            if ($(window).width() > 768) {
