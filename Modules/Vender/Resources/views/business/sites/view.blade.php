...
@media (max-width: 768px) {
  ...
  .text-secondary {
    ...
    /* Prevents long file names/text from breaking the box layout */
    margin-top: 5px;
  }
  ...
  <div class="col-md-3">
    <div style="border-radius: 7px;border: 2px solid black; ">
      <h4 class="h3" style="font-weight: 600; font-size: 17px;padding: 10px; ">
        <img src="/home.png" style="width: 22px;margin-top: -5px;color:black;"> Site
      </h4>
      <p
          ...
          <div class="card-content">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-7 text-secondary">
                  ...
                  @else
                  {{ $site['proof_name'] ?? 'N/A' }} <a class="btn btn-primary btn-primary_2" style="float: right;"
            ...
            <div class="card-footer">
              <div class="text-secondary" style="text-align: right">
                <a href="{{ route('vender.site.edit', $site['id']) }}" style=" background-color: black !important;
