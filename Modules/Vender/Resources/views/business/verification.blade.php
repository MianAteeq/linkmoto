  ...
  <div class="col-12 col-md-4 col-lg-3 info-sidebar-wrapper">
    <div class="info-sidebar">
      ...
      <p style="padding: 15px 10px; line-height: 1.5rem; color: black; margin: 0;">
        ...
        Each item may require supporting documents. Statuses: <strong>To-Do, Pending, Verified, Rejected, Cancelled,
          Inactive</strong>
      </p>
    </div>
  </div>
  ...
  <div class="col-12 col-md-8 col-lg-9">
    <div class="main-content-box" id="contens">
      ...
      <div class="section">
        ...
        <div class="section-body">
          <div class="item">
            ...
            case 'Rejected': $badgeClass = 'badge badge-danger'; break;
            default: $badgeClass = 'badge badge-light text-dark'; break;
            }
            @endphp
            <span class="{{ $badgeClass }}" style="margin-top: 0;">{{ $status }}</span>
      ...
      <div class="section">
        ...
        <div class="section-body">
          ...
          <div class="item">
            ...
            <span class="badge verified" style="margin-top: 0;">Verified</span>
            <div class="timestamp">Last updated {{ $user['profile']->updated_at->format('d M Y, H:i') }}</div>
          </div>
          @else
          <div class="item">
      ...
      <div class="section">
        ...
        <div class="section-body">
          <div class="item">
            <a href="{{ route('vender.main.contact.view', $user['id']) }}">{{ $user['name'] }}
          ...
          <div class="item">
            <a href="{{ route('vender.main.contact.view', $main['id']) }}">{{ $main['name'] }}
              {{ $main['middle_name'] }} {{ $main['last_name'] }}</a>
            @php
      ...
      <div class="section">
        ...
        <div class="section-body">
          ...
          <div class="item">
            <a href="{{ route('vender.site.view', $site['id']) }}">{{ $site['address_line_1'] }}
              {{ $site['address_line_2'] }}</a>
            @php
            $status = $site['status'];
            switch ($status) {
            case 'Todo': $badgeClass = 'badge todo'; break;
      ...
      <div class="section">
        ...
        <div class="section-body">
          ...
          <div class="item">
            <a href="{{ route('vender.bank.view', $bank['id']) }}">{{ $bank['bank_name'] }} |
              {{ $bank['account_name'] }} | {{ $bank['account_number'] }} </a>
            @php
            $status = $bank['status'];
            switch ($status) {
            case 'Todo': $badgeClass = 'badge todo'; break;
...
$(document).ready(function() {
  // If you ever add a table to this page, this will initialize it
  ...
  // Initialize help info function if values exist
