...
@media (max-width: 770px) {
  ...
  /* Ensure the content container doesn't get artificially locked to a small height */
  .col-md-9[style] {
  ...
  /* Align view button neatly under file input on small screens */
  .view-btn {
  ...
  /* Prevent layout break on long error messages */
  p.text-danger {
...
<div class="row">
        ...
        <div id="accordionWrap1" role="tablist" aria-multiselectable="true">
          <div class="card accordion collapse-icon accordion-icon-rotate" style="box-shadow: none;">
            ...
            <a id="business_proof_id" class="card-header info collapsed" data-toggle="collapse"
              href="#collapsebusiness_proof_id" aria-expanded="false" aria-controls="collapsebusiness_proof_id">
            ...
            <a id="business_proof_auth" class="card-header info collapsed" data-toggle="collapse"
              href="#collapsebusiness_proof_auth" aria-expanded="false" aria-controls="collapsebusiness_proof_auth">
  ...
  <div class="col-md-9"
    ...
    <form action="{{ route('vender.main.contact.update') }}" id="contens" method="POST" enctype="multipart/form-data"
      id="contens"> @csrf
      <input type="hidden" name="id" value="{{ $user['id'] }}">
      <div class="link-body" style="padding: 10px">

        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5">First name <span style="color: red">*</span>
          </label>
        ...
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5">Last name <span style="color: red">*</span>
          </label>
          <div class="col-md-8 mx-auto">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="email" id="email" readonly class="form-control" value="{{ $user['email'] }}"
              onkeyup="lookup(this);" name="email" placeholder="Email">
            <p class="text-danger email" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
              Field is
              Required !</p>
            @if ($errors->has('email'))
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="tel" id="phone_no" class="form-control" value="{{ $user['sub_profile']['phone_no'] ?? '' }}"
        ...
        {{-- <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="tel" id="landline" class="form-control"
                                value="{{ $user['profile']['landline'] ?? '' }}" name="landline"
        placeholder="Landline">
        <p class="text-danger landline" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This
          Field is
          Required !</p>
      </div>
  </div> --}}
  <div class="form-group row">
    <label class="col-md-4 label-control">Role / position <span style="color: red">*</span> <a style="color: black"
        href="#collapsebusiness" data-toggle="collapse" aria-expanded="false"
        aria-controls="collapsebusiness">(?)</a></label>
    <div class="col-md-8 mx-auto">
      <div class="input-group">


        <select name="job_title" id="job_title" class="form-control select2" style="max-width:60%!important">
          ...
          <option value="Other – Authorised Person" @if ($user['profile']['job_title']=='Other – Authorised Person' )
            selected @endif>Other – Authorised Person
          </option>
  ...
  <div class="form-group row">
    ...
    <div class="col-md-8 mx-auto">
      <input type="file" name="proof_of_id" accept="image/*,.doc, .docx,.pdf" class="d-none" id="">
      <input type="button" id="proof_of_id" class="form-control form-btn btn-2"
        value="{{ $user['proof_id'] ?? 'Document Upload' }}" name="contact" placeholder="Document Upload ">
      <button type="button" class="btn btn-primary btn-sm view-btn" @if (($user['proof_id'] ?? '' )==null)
        style="display: none" @endif> <a href="{{ URL::to($user['proof_id'] ?? '') }}" id="view_file" target="_blank"
  ...
  <div class="form-group row Poof_div">
    <label class="col-md-4 label-control" for="eventRegInput5"> Proof of Authorisation <span style="color: red">*</span>
      (?)</label>
    <div class="col-md-8 mx-auto">
      <input type="file" name="proof_of_main_contact" accept="image/*,.doc, .docx,.pdf" class="d-none" id="">
      <input type="button" id="proof_of_main_contact" class="form-control form-btn btn-1"
        value="{{ $user['profile']['proof_of_main_contact_name'] ?? 'Document Upload' }}" name="contact"
        placeholder="Document Upload ">
      <button type="button" class="btn btn-primary btn-sm view-btn" @if (($user['profile']['proof_of_main_contact']
        ?? '' )==null) style="display: none" @endif> <a
