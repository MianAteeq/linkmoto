...
@section('css_custom')
    ...
    <style>
        ...
        /* Override the master layout's strict height to fix double scrollbars */
        .content-wrapper {
                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb" style="padding-left: 0; background-color: transparent; margin-bottom: 10px;">
                        ...
                        <li class="breadcrumb-item"><a style="color: black" href="{{ route('vender.main.contact') }}">Main
                                contact</a></li>
                        <li class="breadcrumb-item">Edit main contact</li>
                    </ol>
                </div>
    ...
    <div class="row mt-2">
        ...
        <div class="col-12 col-lg-4 mb-3 mb-lg-0">
            <div style="border-radius: 7px;border: 2px solid black; ">
                <h4 class="h3" style="font-weight: 600; font-size: 17px;padding: 10px; margin-bottom: 0;">
                ...
                <div class="footers" id="show_help" style="border-top:2px solid black;">
                    <h4 style="padding-left: 13px; color: black; font-weight: 600; margin-top: 5px;">Help information: </h4>
                    ...
                    <div id="accordionWrap1" role="tablist" aria-multiselectable="true">
                        <div class="card accordion collapse-icon accordion-icon-rotate" style="box-shadow: none;">
                            ...
                            <div id="collapsebusiness_vat" data-parent="#accordionWrap1" role="tabpanel"
                                ...
                                <div class="card-content">
                                    <div class="card-body" style="color:black">
                                        Select the main contact’s official role in the business. This determines their
                            ...
                            <a id="business_proof_id" class="card-header info collapsed" data-toggle="collapse"
                                ...
                                <div class="card-title lead" style="padding-right: 25px;">Proof of Id&nbsp;(?)</div>
                            </a>
                            <div id="collapsebusiness_proof_id" data-parent="#accordionWrap1" role="tabpanel"
                                ...
                                <div class="card-content">
                                    <div class="card-body" style="color:black">
                                        Upload a valid photo ID to verify the main contact’s identity. Accepted documents
                                        include passport, driving licence, or national ID card. This is mandatory for all
                                        main contacts.
                                    </div>
                                </div>
                            </div>
                            ...
                            <a id="business_proof_auth" class="card-header info collapsed" data-toggle="collapse"
                                ...
                                <div class="card-title lead" style="padding-right: 25px;">Proof of Authorisation&nbsp;(?)
                                </div>
                            </a>
                            <div id="collapsebusiness_proof_auth" data-parent="#accordionWrap1" role="tabpanel"
                                ...
                                <div class="card-content">
                                    <div class="card-body" style="color:black">
                                        Required only if the main contact is not automatically authorised (e.g., a CEO who
                                        is not listed as a Director or Owner). Accepted documents include a board resolution
                                        or formal authorisation letter <strong>confirming the person can act on behalf of
                                            the business.</strong>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-12 col-lg-8 mb-4">
            <div style="border: 2px solid black; border-radius: 6px; padding-left: 0; padding-right: 0; background-color: white;"
                class="flex-column-container">

                <div class="row" style="margin-right: 0;margin-left: 0;">
                    <div class="col-md-12" style="border-bottom: 2px solid black;">
                        <h3 style="font-size: 20px; padding: 10px; margin-left: 0; color: black; padding-bottom: 10px;">Main
                            contacts</h3>
                    </div>
                </div>

                <form action="{{ route('vender.main.contact.update') }}" id="contens" method="POST"
                    enctype="multipart/form-data" class="flex-column-container" style="flex-grow: 1;">
                    @csrf
                    ...
                    <div class="link-body" style="padding: 10px; flex-grow: 1;">
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4 label-control" for="eventRegInput5">First name <span
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4 label-control" for="eventRegInput5">Middle name </label>
                            <div class="col-12 col-md-8 mx-auto">
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4 label-control" for="eventRegInput5">Last name <span
                                    style="color: red">*</span>
                            </label>
                            <div class="col-12 col-md-8 mx-auto">
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4 label-control" for="eventRegInput5">Email <span
                                    style="color: red">*</span> </label>
                            <div class="col-12 col-md-8 mx-auto">
                                <input type="email" id="email" readonly class="form-control"
                                    value="{{ $user['email'] }}" onkeyup="lookup(this);" name="email"
                                    placeholder="Email">
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4 label-control" for="eventRegInput5">Mobile <span
                                    style="color: red">*</span> </label>
                            <div class="col-12 col-md-8 mx-auto">
                                <input type="tel" id="phone_no" class="form-control"
                                    value="{{ $user['sub_profile']['phone_no'] ?? '' }}" onkeyup="lookup(this);"
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4 label-control" for="eventRegInput5">Proof of Id <span
                                    style="color: red">*</span> (?)</label>
                            <div class="col-12 col-md-8 mx-auto">
                                <input type="file" name="proof_of_id" accept="image/*,.doc, .docx,.pdf"
                                    class="d-none" id="">
                                ...
                                <button type="button" class="btn btn-primary btn-sm view-btn"
                                    @if (($user['proof_id'] ?? '') == null) style="display: none" @endif> <a
                                        ...
                                        style="color: white !important;">View</a></button>
                                <br>
                                <br>
                                <p class="text-danger proof_d"
                                    style="padding-left: 10px;width:100%;display: none; margin-top: 5px;">Proof of Id is
                                    Required !</p>
                            </div>
                        </div>

                        <div class="form-group row Poof_div">
                            <label class="col-12 col-md-4 label-control" for="eventRegInput5"> Proof of Authorisation
                            ...
                            <div class="col-12 col-md-8 mx-auto">
                                ...
                                <button type="button" class="btn btn-primary btn-sm view-btn"
                                    @if (($user['profile']['proof_of_main_contact'] ?? '') == null) style="display: none" @endif> <a
                                        ...
                                        id="view_file" target="_blank" style="color: white !important;">View</a></button>
                                <br>
                                <br>
                                <p class="text-danger file_proof"
                                    style="padding-left: 10px;width:100%;display: none; margin-top: 5px;"> Proof of
                                    Authorisation is Required !</p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row Poof_div-2">
                            <label class="col-12 col-md-4 label-control" for="eventRegInput5"> Proof of Authorisation
                                <span style="color: red">*</span> (?)</label>
                            <div class="col-12 col-md-8 mx-auto">
                                <p class="proof_error" style="color:red; margin-top: 5px;">Automatic
                                    ({{ $user['profile']['job_title'] }}) Proof Not Required!</p>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-12 col-md-4 label-control" for="eventRegInput5"> Status</label>
                            <div class="col-12 col-md-8 mx-auto">
                                <p class="" style="margin-top: 5px;">{{ $user['user_verified'] }}</p>
                            </div>
                        </div>

                    </div>

                    <div class="footers mt-auto" style="padding: 10px 15px;">
                        <button type="button" onclick="submitDetailsForm()"
                            class="btn btn-dark round btn-min-width mr-1 mb-1"
                            style="float: right; color: white !important;">Update</button>
                        <a href="{{ redirect()->back()->getTargetUrl() }}"><button type="button"
                                class="btn btn-dark round btn-min-width mr-1 mb-1"
                                style="float: right; color: white !important;">Cancel</button></a>
                    </div>
                </form>
...
@section('script')
    ...
    <script>
        // JS fixed height calculation removed to allow natural Flexbox responsive scaling.
        /*
