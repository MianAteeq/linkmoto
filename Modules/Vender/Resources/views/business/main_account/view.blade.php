...
@section('content')
    ...
    <div class="container-fluid px-3 mt-3">
        <div class="row">
            ...
            {{-- FIX 2 & 3: removed ps-md-3 class, changed padding-left from 0 to 15px to create gap between cards --}}
            <div class="col-12 col-lg-9 order-2 order-lg-2" id="contens"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 text-secondary">
                                            ...
                                            @else
                                                Proof.{{ Str::after($user['proof_id'], '.') }} <a
                                                    class="btn btn-primary btn-primary_2" style="float: right;"
                                            ...
                                            @if ($proofRequired)
                                                @if (!empty($user['profile']['proof_of_main_contact']))
                                                    ...
                                                    <a class="btn btn-primary btn-primary_2"
                                                        style="float: right; margin-top: 5px;" target="_blank"
    ...
    </div>{{-- FIX 1: closes container-fluid --}}
@endsection
