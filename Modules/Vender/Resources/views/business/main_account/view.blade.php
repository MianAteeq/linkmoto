  ...
  <div class="col-md-3">
    <div style="border-radius: 7px;border: 2px solid black; ">
      ...
      <p
        ...
        <a href="{{ route('vender.main.contact.verify', $user['id']) }}" style=" background-color: black !important;
          ...
          <div class="card-content">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-7 text-secondary">
                  ...
                  Proof.{{Str::after($user['proof_id'], '.')}} <a class="btn btn-primary btn-primary_2"
                    style="float: right;" target="_blank" href="{{ URL::to($user['proof_id'] ?? '') }}">View</a>
                  @endif
                </div>
              </div>
              <hr>
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-7 text-secondary">
                  ...
                  <a class="btn btn-primary btn-primary_2" style="float: right;" target="_blank"
            ...
            <div class="card-footer">
              <div class="text-secondary" style="text-align: right">
                <a href="{{ route('vender.main.contact.edit', $user['id']) }}" style=" background-color: black !important;
