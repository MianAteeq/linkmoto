...
<div class="row">
  ...
  <div class="col-md-9"
    ...
    <form action="{{ route('vender.main.contact.store') }}" id="contens" method="POST" enctype="multipart/form-data"
      id="contens"> @csrf
      <div class="link-body" style="padding: 10px">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="last_name" class="form-control" value="" onkeyup="lookup(this);" name="last_name"
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="tel" id="phone_no" class="form-control" value="" onkeyup="lookup(this);" name="phone_no"
              placeholder="Mobile">
          ...
          <div class="col-md-8 mx-auto">
            <div class="input-group">
              ...
              <select name="job_title" id="job_title" class="form-control select2" style="max-width:60%!important">
                ...
                <option value="Other – Authorised Person">Other – Authorised Person
                </option>
        ...
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5">Proof of Id <span style="color: red">*</span>
            (?)</label>
          <div class="col-md-8 mx-auto">
            <input type="file" name="proof_of_id" accept="image/*,.doc, .docx,.pdf" class="d-none" id="">
            <input type="button" value="Document Upload" id="proof_of_id" class="form-control form-btn btn-2"
        ...
        <div class="form-group row Poof_div">
          <label class="col-md-4 label-control" for="eventRegInput5"> Proof of Authorisation <span
              style="color: red">*</span> (?)</label>
          <div class="col-md-8 mx-auto">
            <input type="file" name="proof_of_main_contact" accept="image/*,.doc, .docx,.pdf" class="d-none" id="">
            <input type="button" id="proof_of_main_contact" class="form-control form-btn btn-1" value="Document Upload"
              name="contact" placeholder="Document Upload ">
            <button type="button" class="btn btn-primary btn-sm view-btn" style="display: none"> <a href=""
                id="view_file" target="_blank" style="color: white">View</a></button>
            <br>
...
function submitDetailsForm() {
  ...
  let r_status = $('input[type=radio]:checked').val();
  if (r_status === "YES") {
