...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9"
            ...
            <form action="{{ route('vender.main.contact.store') }}" id="contens" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="email" id="email" class="form-control" value=""
                                onkeyup="lookup(this);" name="email" placeholder="Email" required>
                            <p class="text-danger email"
                                style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">Email Not Valid !
                            </p>
                            @if ($errors->has('email'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="file" name="proof_of_id" accept="image/*,.doc, .docx,.pdf" class="d-none"
                                id="">
                            <input type="button" value="Document Upload" id="proof_of_id"
                                class="form-control form-btn btn-2" name="contact" placeholder="Document Upload ">
