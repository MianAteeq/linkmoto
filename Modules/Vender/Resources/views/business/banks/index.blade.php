...
@media (max-width: 770px) {
  ...
  /* Override JS-calculated fixed height on mobile so stacking content doesn't overflow */
  #contens[style] {
  ...
  /* Force search bar and filter icon to sit perfectly side-by-side on mobile screens */
  .row.m-0.mt-2 {
    display: flex;
    flex-wrap: nowrap;
    align-items: center;
    ...
    <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
      ...
      <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"> Bank Accounts
...
<div class="row">
  <div class="col-md-3">
    <div style="border-radius: 7px;border: 2px solid black; ">
      ...
      <p
        ...
        Add and manage your business
        bank accounts here. These will be
        linked in other sections such as
        invoice document settings and
        payout account selection.
        Multiple accounts can be stored
        for different purposes (e.g. main
        business account, remittance,
        trade unit specific account, etc).

        <br>
        At least 1 bank account needs to
        be added for the <a>Payout Account</a>.
  ...
  <div class="col-md-9" id="contens" style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;
    ...
    <div class="footers">
      ...
      <a href="{{ route('vender.bank.add') }}"> <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
