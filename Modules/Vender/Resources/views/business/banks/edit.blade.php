      ...
      <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a style="color: black" href="{{ route('vender.bank') }}">Bank
              Accounts</a></li>
          <li class="breadcrumb-item">Edit Bank Account
          </li>
...
<div class="row">
  <div class="col-md-3">
    <div style="border-radius: 7px;border: 2px solid black; ">
      <h4 class="h3" style="font-weight: 600; font-size: 17px;padding: 10px; ">
        <img src="/home.png" style="width: 22px;margin-top: -5px;"> Edit Bank Account
      </h4>
        ...
        <div id="accordionWrap1" role="tablist" aria-multiselectable="true">
          <div class="card accordion collapse-icon accordion-icon-rotate" style="box-shadow: none;">
            ...
            <a id="business_bank_proof" class="card-header info collapsed" data-toggle="collapse"
              href="#collapsebusiness_bank_proof" aria-expanded="false" aria-controls="collapsebusiness_bank_proof">
              <div class="card-title lead">Proof of bank account (?)
              </div>
            </a>
  ...
  <div class="col-md-9"
    ...
    <form action="{{ route('vender.bank.update') }}" id="contens" method="POST" enctype="multipart/form-data"
      id="contens"> @csrf
      ...
      <div class="link-body" style="padding: 10px">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="label" value="{{ $site['label'] }}" onkeyup="lookup(this);" class="form-control"
        ...
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5"> Bank name <span style="color:red;">*</span>
          </label>
          <div class="col-md-8 mx-auto">
            <input type="text" id="bank_name" class="form-control" name="bank_name" required
              value="{{ $site['bank_name'] }}" style="margin-top: 5px " placeholder="Enter Your Bank Name ">

            <p class="text-danger bank_name" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">
              Bank name Field is
              Required !</p>
        ...
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5"> Account name <span style="color:red;">*</span>
          </label>
          <div class="col-md-8 mx-auto">
            <input type="text" id="account_name" class="form-control" name="account_name"
              value="{{ $site['account_name'] }}" style="margin-top: 5px " placeholder="Enter Your Account name  ">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="sort_code" class="form-control" name="sort_code" value="{{ $site['sort_code'] }}"
        ...
        <div class="form-group row">
          <label class="col-md-4 label-control" for="eventRegInput5"> Account Number <span style="color:red;">*</span>
          </label>
          <div class="col-md-8 mx-auto">
            <input type="postcode" id="account_number" class="form-control" onkeyup="lookup(this);"
              name="account_number" required value="{{ $site['account_number'] }}" style="margin-top: 5px "
        ...
        <div class="form-group row Poof_div">
          <label class="col-md-4 label-control" for="eventRegInput5">Proof of bank account
          ...
          <div class="col-md-8 mx-auto">
            ...
            <input type="button" id="proof_of_main_contact" class="form-control form-btn"
              value="{{ $site['proof'] ?? 'Document Upload' }}" name="contact" placeholder="Document Upload ">
