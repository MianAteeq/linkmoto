...
<div class="content-header bg-white">
  <div class="row" style="border-bottom: 3px solid #949494; margin: 0;">
    <div class="col-12 bg-white headerbg-custom">
      <h3 class="h3">Edit Bank Account</h3>
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a>Business</a></li>
          <li class="breadcrumb-item"><a style="color: black" href="{{ route('vender.bank') }}">Bank Accounts</a></li>
...
<div class="row mt-3">
  ...
  <div class="col-md-3">
    <div class="sidebar-box">
      <h4 class="sidebar-title">
        <img src="/home.png" alt="Icon"> Edit Bank Account
      </h4>
        ...
        <div class="card accordion collapse-icon accordion-icon-rotate mb-0" style="box-shadow: none;">
          ...
          <div id="collapsebusiness_vat" data-parent="#accordionWrap1" class="collapse">
            <div class="card-content">
              <div class="card-body">
                Give this account a short name so you can recognise it later when selecting for invoices or payouts. For
                example: Main Business Account, Refunds Account, Payout Account, or Site A – Payments.
              </div>
            </div>
          </div>
          ...
          <div id="collapsebusiness_bank_proof" data-parent="#accordionWrap1" class="collapse">
            <div class="card-content">
              <div class="card-body">
                Even if your bank account matches your registered business or trading name, we still require proof to
                confirm the account belongs to your business. This keeps payouts secure and ensures compliance with UK
                regulations. <br><br>
                Upload a document that clearly shows your business name, sort code, and account number. Accepted
                documents include:
                <ul>
  ...
  <div class="col-md-9">
    <div class="main-container">
      ...
      <form action="{{ route('vender.bank.update') }}" method="POST" enctype="multipart/form-data" id="bankEditForm">
        @csrf
        ...
        <div class="form-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" id="label" name="label" value="{{ $site['label'] }}" class="form-control-custom"
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" id="bank_name" name="bank_name" value="{{ $site['bank_name'] }}"
                class="form-control-custom" placeholder="Enter Your Bank Name" onkeyup="lookup(this);" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" id="account_name" name="account_name" value="{{ $site['account_name'] }}"
                class="form-control-custom" placeholder="Enter Your Account name" onkeyup="lookup(this);" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" id="sort_code" name="sort_code" value="{{ $site['sort_code'] }}"
                class="form-control-custom" placeholder="Enter Your Sort Code">
            </div>
          </div>

          <div class="form-group row">
            <label class="col-md-4 col-form-label">Account Number <span class="required-star">*</span></label>
            <div class="col-md-8">
              <input type="text" id="account_number" name="account_number" value="{{ $site['account_number'] }}"
                class="form-control-custom" placeholder="Enter Your Account Number *" onkeyup="lookup(this);" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              ...
              <div class="file-upload-wrapper">
                <input type="file" name="proof" accept="image/*,.doc,.docx,.pdf" class="d-none" id="hidden_file_input">
                <input type="button" id="proof_of_main_contact" class="form-control-custom form-btn-file"
                  value="{{ $site['proof'] ? 'Document Attached' : 'Document Upload' }}">

                <a href="{{ $site['proof'] ? URL::to($site['proof']) : '#' }}" id="view_file" target="_blank"
                  class="view-btn" style="{{ $site['proof'] ? '' : 'display: none;' }}">View</a>
              </div>
        ...
        <div class="form-actions">
          ...
          <button type="button" onclick="submitDetailsForm()" class="btn btn-dark-custom">Update</button>
        </div>
...
@section('script')
<script>
// Variables for file state
let hasExistingFile = @json($site['proof'] ? true : false);
...
// Real-time validation checking on keyup
...
function submitDetailsForm() {
  ...
  // Check file upload (Must have either an existing file OR a newly selected file)
  let newFileSelected = $('#hidden_file_input').val() !== "";
  if (!hasExistingFile && !newFileSelected) {
