                ...
                <div class="link-body" style="padding: 10px">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="label" value="{{ $site['label'] }}" onkeyup="lookup(this);"
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 label-control" for="eventRegInput5"> Bank name <span
                                style="color:red;">*</span> </label>
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="bank_name" class="form-control" name="bank_name" required
                                value="{{ $site['bank_name'] }}" style="margin-top: 5px "
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="account_name" class="form-control" name="account_name"
                                value="{{ $site['account_name'] }}" style="margin-top: 5px "
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="text" id="sort_code" class="form-control" name="sort_code"
                                value="{{ $site['sort_code'] }}" style="margin-top: 5px "
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mx-auto">
                            <input type="postcode" id="account_number" class="form-control" onkeyup="lookup(this);"
                                name="account_number" required value="{{ $site['account_number'] }}"
                                style="margin-top: 5px " placeholder="Enter Your Account Number *">
                    ...
                    <div class="form-group row Poof_div">
                        ...
                        <div class="col-md-8 mx-auto">
                            ...
                            <input type="button" id="proof_of_main_contact" class="form-control form-btn"
                                value="{{ $site['proof'] ?? 'Document Upload' }}" name="contact"
