    ...
    <div class="col-12 bg-white headerbg-custom">
      ...
      <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a style="color: black" href="{{ route('vender.bank') }}">Payout Account</a></li>
        ...
        <div class="card accordion collapse-icon accordion-icon-rotate mb-0" style="box-shadow: none;">
          ...
          <div id="collapsebusiness_vat" data-parent="#accordionWrap1" class="collapse">
            <div class="card-content">
              <div class="card-body">
                Select a <strong>verified bank account</strong> to receive payouts and refunds from the platform. Only
                verified accounts appear in this list. If you don’t see your bank account, please add and verify it
                first under <strong>Business > Bank Accounts.</strong>
              </div>
            </div>
          </div>
      ...
      <form action="{{ route('vender.payout.save') }}" method="POST" id="payoutForm">
        ...
        <div class="form-body">
          ...
          <div class="form-group row">
            <label class="col-md-4 col-form-label">Bank account (?) <span style="color:red;">*</span></label>
            <div class="col-md-8">
