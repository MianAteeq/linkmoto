...
@media (max-width: 770px) {
  ...
  /* Override JS-calculated fixed height on mobile so content expands safely */
  #contens[style] {
  ...
  /* Stack and center main edit button for mobile touch target */
  .card-footer .text-secondary {
    text-align: center !important;
  }

  .card-footer .text-secondary a.btn {
    display: block;
    width: 100%;
  }

  /* Ensure labels and values have breathing room when stacked */
  .card-body .row {
    margin-bottom: 10px;
  }
  ...
  /* View button alignment inside list */
  .btn-primary_2[style] {
  ...
  /* Sidebar Cancel Verification button stacking */
  .col-md-3 p a.btn {
    display: block;
    width: 100%;
    margin-top: 10px;
  ...
  <div class="col-md-3">
    <div style="border-radius: 7px;border: 2px solid black; ">
      <h4 class="h3" style="font-weight: 600; font-size: 17px;padding: 10px; ">
        <img src="/home.png" style="width: 22px;margin-top: -5px;"> Bank Account
      ...
      <p
        ...
        <a href="{{ route('vender.main.bank.verify', $site['id']) }}" style=" background-color: black !important;
                                       border-color: black !important;" class="btn btn-primary"> Cancel
          Verification</a>
      ...
      <p
        ...
        <strong>Rejected reason</strong>: Details do not
        match supplied document.
          ...
          <div class="card-content">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-7 text-secondary">
                  ...
                  Upload.{{ Str::after($site['proof'], '.') ?? 'N/A' }} <a class="btn btn-primary btn-primary_2"
                    style="float: right;" target="_blank" href="{{ URL::to($site['proof'] ?? '') }}">View</a>
                  @endif
                </div>
              </div>
              <hr>
            ...
            <div class="card-footer">
              <div class="text-secondary" style="text-align: right">
                <a href="{{ route('vender.bank.edit', $site['id']) }}" style=" background-color: black !important;
