    ...
    <form action="{{ route('vender.bank.store') }}" id="contens" method="POST" enctype="multipart/form-data"
      ...
      <div class="link-body" style="padding: 10px">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="bank_name" class="form-control" name="bank_name" required value=""
              style="margin-top: 5px " placeholder="Enter Your Bank Name ">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="account_name" class="form-control" name="account_name" value=""
              style="margin-top: 5px " placeholder="Enter Your Account name  ">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 mx-auto">
            <input type="text" id="sort_code" class="form-control" name="sort_code" value="" style="margin-top: 5px "
        ...
        <div class="form-group row Poof_div">
          <label class="col-md-4 label-control" for="eventRegInput5">Proof of bank account (?) <span
              style="color:red;">*</span></label>
          <div class="col-md-8 mx-auto">
