...
.form-control-custom {
  ...
  padding: 8px 12px;
  width: 100%;
  /* Default to full width of column */
}
...
<div class="row mt-3">
  ...
  <div class="col-md-9">
    <div class="main-container">
      ...
      <form action="{{ route('vender.bank.store') }}" method="POST" enctype="multipart/form-data" id="bankDetailsForm">
        @csrf
        <div class="form-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" id="label" name="label" class="form-control-custom" placeholder="Enter Your Label *"
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" id="account_number" name="account_number" class="form-control-custom"
                placeholder="Enter Your Account Number *" onkeyup="lookup(this);" required>
          ...
          <div class="form-group row Poof_div">
            ...
            <div class="col-md-8">
              ...
              <div class="file-upload-wrapper">
                ...
                <a href="#" id="view_file" target="_blank" class="btn btn-sm view-btn" style="display: none;">View</a>
              </div>
...
function submitDetailsForm() {
  ...
  // Check file upload (if Poof_div is visible)
