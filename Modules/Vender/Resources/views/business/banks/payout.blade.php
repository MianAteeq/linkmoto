...
@media (max-width: 770px) {
  ...
  /* Stack and center button for mobile touch target */
          ...
          <div class="card-content">
            ...
            <div class="card-footer">
              <div class="text-secondary" style="text-align: right">
                <a href="{{ route('vender.payout.edit') }}" style=" background-color: black !important;
                                       border-color: black !important;" class="btn btn-primary"> Add</a>
              </div>
            </div>
            @else
            <div class="card-footer">
