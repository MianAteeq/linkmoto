                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a style="color: black" href="{{ route('vender.mail') }}">Email
                                Address</a></li>
                        <li class="breadcrumb-item">Edit Email Address
                        </li>
        ...
        <div class="col-md-3">
            <div style="border-radius: 7px;border: 2px solid black; ">
                <h4 class="h3" style="font-weight: 600; font-size: 17px;padding: 10px; ">
                    <img src="/home.png" style="width: 22px;margin-top: -5px;"> Edit Email Address
                </h4>
        ...
        <div class="col-md-9"
            ...
            <form action="{{ route('vender.mail.update') }}" id="contens" method="POST" enctype="multipart/form-data"
                ...
                <div class="link-body" style="padding: 10px">
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 label-control" for="eventRegInput5"> Email Address <span style="color:red;">*</span> </label>
                        <div class="col-md-8 mx-auto">
                            <input type="email" id="email" class="form-control" name="email" required
                                value="{{ $site['email'] }}" style="margin-top: 5px "
                                placeholder="Enter Your Email Address ">

                            <p class="text-danger email"
                                style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">Email Address Field
                                is
                                Required !</p>
