  ...
  <div class="col-12 col-md-4 col-lg-3 info-sidebar-wrapper">
    <div class="info-sidebar">
      ...
      <p style="border-top: 2px solid black; padding: 10px; line-height: 1.5rem; color: black; margin: 0;">
        Add and manage your business email addresses here. These will be linked in other sections such as remittance
        advise, invoice settings, and billing notifications. Multiple addresses can be stored for different purposes
        (e.g. accounts@, billing@, etc).
      </p>
    </div>
  </div>
...
// Note: Hardcoded JS height script removed.
</script>
@endsection