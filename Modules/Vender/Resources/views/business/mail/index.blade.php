    ...
    <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
      ...
      <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"> Email Addresses
...
<div class="row">
  <div class="col-md-3">
    <div style="border-radius: 7px;border: 2px solid black; ">
      ...
      <p
        ...
        email addresses here. These will
        be linked in other sections such as
        remittance advise, invoice
        settings, and billing notifications.
        Multiple addresses can be stored
        for different purposes (e.g.
        accounts@, billing@, etc)
  ...
  <div class="col-md-9" id="contens" style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{ route('vender.mail.view', $bank['id']) }}"><i class="ft-eye"></i></a>
                </td>
    ...
    <div class="footers">
      ...
      <a href="{{ route('vender.mail.add') }}"> <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
