    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-12 mb-4">
                <div class="sidebar-overview" style="border-radius: 7px;border: 2px solid black;">
                    ...
                    <div class="sidebar-content">
                        ...
                        <p>Welcome to your Business Manager Portal. We just need a few details to get your business up and
                            running.
                        </p>
                        <p>Verify your information, set up your services, staff, bookings, and invoices — once that’s done,
                            your
                            mobile app will be ready to go!</p>
                        <p>Follow the checklist to complete your Business Setup. Once all steps are done, your business will
                            be
                            activated.</p>
                    </div>
                </div>
                    ...
                    <div class="custom-accordion-item">
                        ...
                        <div id="collapseContent14" class="custom-collapse-content">
                            <p><strong>A Site</strong> is the physical location where your business operates. Every
                                <strong>Trade
                                    Unit</strong> must be linked to a Site.
                            </p>
                            <ul>
                            ...
                            <p>This setup ensures each <strong>Trade Unit</strong> is tied to the correct location, making
                                it easier to
                        ...
                        <div id="bank_payout" class="custom-collapse-content">
                            ...
                            <ul>
                                <li>The bank account must belong to your <strong>registered business</strong> or be in the
                                    <strong>trading
                                        name</strong> associated with your business.
                                </li>
                            ...
                            <p>Once saved, you can <strong>keep track of verification status</strong> by going to the
                                ...
                                completed
                                verifications in one place. Verification is <strong>required</strong> before the account can
                                be used as a
                                payout account. Once verified, go to <strong>Billings &amp; Payments > Payout
                                    Account</strong> to link the
                    ...
                    <div class="custom-accordion-item">
                        ...
                        <div id="upload_proof" class="custom-collapse-content">
                            <p>Certain actions in the platform require <strong>verification</strong>. This includes
                                <strong>adding a
                                    Site, adding a Bank Account for Payouts, and verifying your business</strong>. Uploading
                                proof documents
                                is <strong>mandatory</strong> to make your account <strong>LIVE</strong>.
                            </p>
                            <ul>
                                <li><strong>Business Verification:</strong> Documents to confirm your business registration
                                    and identity,
                                    such as a <strong>certificate of incorporation, business registration certificate, or
                                        official
                    ...
                    <div class="custom-accordion-item">
                        ...
                        <div id="trading_name" class="custom-collapse-content">
                            ...
                            <p>A <strong>Trading Name</strong> is an alternative name your business operates under,
                                different from your
                                registered business name. Adding trading names helps customers and partners recognize your
                                business if it
                    ...
                    <div class="custom-accordion-item">
                        ...
                        <div id="trade_unit" class="custom-collapse-content">
                            ...
                            <p>The <strong>Trade Unit</strong> is the core operational and customer-facing entity of your
                                business in
                                the platform. It represents a specific branch, workshop, or service outlet. All other
                                elements—such as
                                Sites, Trading Names, and email addresses—are linked to it. Trade Units help manage
                    ...
                    <div class="custom-accordion-item">
                        ...
                        <div id="book_time" class="custom-collapse-content">
                            <p><strong>Booking Times</strong> configure the diary for each Trade Unit in the Service
                                Provider app. They
                                define the time slots available for scheduling work, helping you structure and manage your
                                day
                                efficiently.</p>
                    ...
                    <div class="custom-accordion-item">
                        ...
                        <div id="email_address" class="custom-collapse-content">
                            <p>Email addresses are used purely for <strong>linking purposes</strong> in the platform. They
                                are currently
                                required for <strong>Invoice Document Settings</strong> to ensure invoices display correct
                                contact details
                                for remittance.</p>
                            <ul>
                                ...
                                <li><strong>Optional</strong> – If you do not want your email address on invoice documents
                                    for contact
                                    purposes, or do not need a remittance email address, you can <strong>skip this
                                        section</strong>.</li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>If you have <strong>two separate email addresses</strong> (one for general garage
                                    contact, one for
                                    remittance), add <strong>both email addresses</strong> and link each to its
                    ...
                    <div class="custom-accordion-item">
                        ...
                        <div id="invoice_doc" class="custom-collapse-content">
                            <p><strong>Invoice Document Settings</strong> allow you to configure how invoices appear and
                                what business
                                and contact information is displayed. Each invoice is linked to a <strong>specific Trade
                                    Unit</strong>, so
                    ...
                    <div class="custom-accordion-item">
                        ...
                        <div id="add_user" class="custom-collapse-content">
                            <p>All user management is handled from the <strong>Directory</strong>, a <strong>standalone main
                                    menu
                                    section</strong>. This is where you create, update, link, and control access for all
                                users across your
                                platform.</p>
                            <ul>
                                ...
                                <li><strong>Linking a user to Trade Units</strong> is <strong>specific to the Service
                                        Provider
                                        app</strong>, so only Service Provider users need to be associated with Trade Units.
                                </li>
