...
/* Ensure Checkbox labels don't overflow on small screens */
.custom-control-label {
  word-break: break-word;
  white-space: normal;
}

/* Tablet Adjustments for Checkbox Grids */
@media (max-width: 991px) and (min-width: 768px) {

  /* Change 4-column grid to 2-column grid on tablets for checkboxes */
  #page-account-settings .col-md-3 {
    flex: 0 0 50%;
    max-width: 50%;
  }
}
...
@media (max-width: 767px) {
  ...
  #page-account-settings .col-md-3>.nav-pills {
  ...
  #page-account-settings .nav-pills .nav-item {
    white-space: nowrap;
    margin-right: 10px;
    margin-bottom: 0;
  }

  #page-account-settings .nav-pills .nav-link {
    justify-content: center;
  }

  /* Stack Avatar Upload elements cleanly */
  ...
  #page-account-settings .media .mr-75 {
    margin-right: 0 !important;
    margin-bottom: 15px;
  }

  #page-account-settings .media-body .flex-column {
    align-items: center;
    width: 100%;
  }

  #page-account-settings .media-body .btn {
    width: 100%;
    margin-left: 0 !important;
    margin-top: 10px;
  }

  /* Ensure form inputs have breathing room when stacked */
  .form-group {
    margin-bottom: 1.5rem;
  }

  /* Make Save/Cancel buttons full width for easy tapping */
  .justify-content-end {
  ...
  /* Adjust DataTables Length and Filter for mobile */
  ...
  <div class="row">
    ...
    <div class="col-md-3 mb-2 mb-md-0">
      <ul class="nav nav-pills flex-column mt-md-0 mt-1">
        <li class="nav-item">
          <a class="nav-link d-flex @if(session('settingValue')==" PROFILE"||session('settingValue')==null) active
            @endif" id="account-pill-general" data-toggle="pill" href="#account-vertical-general" aria-expanded="true">
            <i class="ft-globe mr-50"></i> Profile
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link d-flex @if(session('settingValue')==" JOB") active @endif" id="account-pill-general"
            data-toggle="pill" href="#account-vertical-general-job" aria-expanded="true">
            <i class="ft-globe mr-50"></i> Providing Jobs
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link d-flex @if(session('settingValue')==" SUBSCRIPTION") active @endif"
            id="account-pill-connections" data-toggle="pill" href="#account-vertical-connections" aria-expanded="false">
            <i class="ft-feather mr-50"></i> Subscription
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link d-flex @if(session('settingValue')==" PAYMENT") active @endif" id="account-pill-info"
            data-toggle="pill" href="#account-vertical-info" aria-expanded="false">
            <i class="ft-info mr-50"></i> Bank/Payement Detail
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link d-flex @if(session('settingValue')==" SOCIAL") active @endif" id="account-pill-social"
            data-toggle="pill" href="#account-vertical-social" aria-expanded="false">
            <i class="ft-camera mr-50"></i> Social links
          </a>
        </li>
      </ul>
    </div>
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane @if(session('settingValue')=="
                  PROFILE"||session('settingValue')==null) active @endif" id="account-vertical-general"
                  aria-labelledby="account-pill-general" aria-expanded="true">
                  <form novalidate method="post" action="{{ route('vender.setting.profile.update') }}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="media">
                      <a href="javascript: void(0);">
                        <img
                          src="{{URL::to(auth()->user()->profile_pic??'/modules/vender/app-assets/images/portrait/small/avatar-s-18.png')}}"
                          class="rounded mr-75" id="output" alt="profile image" height="64" width="64">
                      </a>
                      <div class="media-body mt-75">
                        <div class="col-12 px-0 d-flex flex-sm-row flex-column justify-content-start">
                          ...
                          <button type="button" class="btn btn-sm btn-secondary ml-50" onclick="reset()">Reset</button>
                        </div>
                    ...
                    <div class="row m-1">
                        ...
                        <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ auth()->user()->name }}"
                              id="account-website" placeholder="First Name">
                          </div>
                        </div>
                        <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="owner_middle_name"
                              value="{{ auth()->user()->profile['owner_middle_name']??'' }}" id="account-website"
                        ...
                        <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="last_name"
                              value="{{ auth()->user()->last_name }}" id="account-website" placeholder="Last Name">
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="phone_no"
                              value="{{ auth()->user()->profile['phone_no']??'' }}" id="account-company"
                              placeholder="Phone">
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="controls">
                              ...
                              <input type="email" class="form-control" name="email"
                                value="{{ auth()->user()->email??'' }}" id="account-e-mail" placeholder="Email" required
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <input type="text" class="form-control" id="account-username" name="company_name"
                              value="{{ auth()->user()->profile['company_name']??'' }}" placeholder="Company Name"
                              required data-validation-required-message="This Company Name field is required">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <input type="text" class="form-control" id="account-username" name="trading_name"
                              value="{{ auth()->user()->profile['trading_name']??'' }}" placeholder="Company Name"
                              required data-validation-required-message="This Company Name field is required">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <input type="text" class="form-control" id="account-name" name="registration_no"
                        ...
                        <div class="form-group">
                          <div class="controls">
                            ...
                            <select class="form-control" name="operation_type">
                              <option value="Mobile" @if(auth()->user()->profile['company_name']=="Mobile") selected
                                @endif>Mobile</option>
                              <option value="On-Premises" @if(auth()->user()->profile['company_name']=="On-Premises")
                                selected @endif>On-Premises</option>
                              <option value="Both" @if(auth()->user()->profile['company_name']=="Both") selected
                                @endif>Both</option>
                            </select>
                          </div>
                        </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="account-company" name="area"
                            value="{{ auth()->user()->profile['area']??'' }}" placeholder="Trading/operating address">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label for="account-website">Website</label>
                          <input type="url" class="form-control" id="account-website" name="website"
                            value="{{ auth()->user()->profile['website']??'' }}" placeholder="Website address">
                        </div>
                      </div>
                        ...
                        <div class="col-md-3 mt-1">
                          <fieldset>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" name="warranty_job_id[]" @foreach
                                ($user['warranty_jobs'] as $warrantyjob) @if($warrantyjob['id']==$warranty_job['id'])
                                checked @endif @endforeach id="custom-warratanty{{ $warranty_job['id'] }}"
                                value="{{ $warranty_job['id'] }}">
                              <label class="custom-control-label"
                                for="custom-warratanty{{ $warranty_job['id'] }}">{{ $warranty_job['name'] }}</label>
                            </div>
                          </fieldset>
                        </div>
                        @endforeach
                      ...
                      <div class="row col-12">
                        ...
                        <div class="col-md-3 mt-1">
                          <fieldset>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" name="vehicle_specialist_id[]"
                                @foreach ($user['vehicle_specialists'] as $vehiclespecialist)
                                @if($vehiclespecialist['id']==$vehicle_specialist['id']) checked @endif @endforeach
                                id="custom-vehicle{{ $vehicle_specialist['id'] }}"
                                value="{{ $vehicle_specialist['id'] }}">
                              <label class="custom-control-label"
                                for="custom-vehicle{{ $vehicle_specialist['id'] }}">{{ $vehicle_specialist['name'] }}</label>
                            </div>
                          </fieldset>
                        </div>
                        @endforeach
                      ...
                      <div class="row col-12">
                        ...
                        <div class="col-md-3 mt-1">
                          <fieldset>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" name="accrediction_id[]" @foreach
                                ($user['accreditation_schemes'] as $warrantyjob)
                                @if($warrantyjob['id']==$accrediction['id']) checked @endif @endforeach
                                id="custom-acc{{ $accrediction['id'] }}" value="{{ $accrediction['id'] }}">
                              <label class="custom-control-label"
                                for="custom-acc{{ $accrediction['id'] }}">{{ $accrediction['name'] }}</label>
                            </div>
                          </fieldset>
                        </div>
                        @endforeach
                      ...
                      <div class="row col-12">
                        ...
                        <div class="col-md-3 mt-1">
                          <fieldset>
                            <div class="custom-control custom-checkbox">
                              <input type="checkbox" class="custom-control-input" name="payment_method_id[]" @foreach
                                ($user['payment_methods'] as $warrantyjob)
                                @if($warrantyjob['id']==$payment_method['id']) checked @endif @endforeach
                                id="custom-payment{{ $payment_method['id'] }}" value="{{ $payment_method['id'] }}">
                              <label class="custom-control-label"
                                for="custom-payment{{ $payment_method['id'] }}">{{ $payment_method['name'] }}</label>
                            </div>
                          </fieldset>
                        </div>
                        @endforeach
                            ...
                            <div class="custom-file-container" data-upload-id="myFirstImage">
                              ...
                              <label class="input-container">
                                <input accept="*" aria-label="Choose File" class="input-hidden"
                                  id="file-upload-with-preview-myFirstImage" type="file" name="address_proff"
                              ...
                              'djvu', 'ico', 'ief','jpe', 'pbm', 'pgm', 'pnm', 'ppm', 'ras', 'rgb', 'tif', 'tiff',
                              'wbmp', 'xbm', 'xpm', 'xwd'];
                              $explodeImage = explode('.', auth()->user()->profile['address_proff']);
                              $extension = end($explodeImage);
                              @endphp
                              @if (in_array($extension, $imageExtensions))
                              <img class="image-preview image_address_proff"
                                style="width: 100%;height: 100px;object-fit: contain;"
                                src="{{ URL::to(auth()->user()->profile['address_proff']??'') }}" id="address_proff" />
                              <iframe class="iframe_address_proff" style="display: none"
                                ...
                                id="address_proff_iframe" width="50%" height="600" scrolling="no">
                              ...
                              <iframe class="iframe_address_proff"
                                src="{{ URL::to(auth()->user()->profile['address_proff']??'') }}" id="address_proff"
                                width="50%" height="600">
                                This browser does not support PDFs. Please download the PDF to view it: <a
                                  href="{{ asset('folder/file_name.pdf') }}">Download PDF</a>
                              ...
                              @endif
                              <input type="hidden" name="old_address_proff"
                                value="{{ auth()->user()->profile['address_proff']??'' }}">
                              @else
                              <img class="image-preview image_address_proff"
                        ...
                        <div class="col-md-6">
                          <div class="demo-upload-container" role="main">
                            ...
                            <div class="custom-file-container" data-upload-id="mySecondImage">
                              ...
                              <label class="input-container">
                                <input accept="*" onchange="loadMechanicDocs(event)" aria-label="Choose File"
                                  class="input-hidden" id="file-upload-with-preview-mySecondImage" type="file"
                                  name="mechanic_docs">
                                <span class="input-visible">Choose file...<span
                                    class="browse-button">Browse</span></span>
                              </label>
                              @if(auth()->user()->profile['mechanic_docs']!=null)
                              @php
                              $imageExtensions2 = ['jpg', 'jpeg', 'gif', 'png', 'bmp', 'svg', 'svgz', 'cgm', 'djv',
                              'djvu', 'ico', 'ief','jpe', 'pbm', 'pgm', 'pnm', 'ppm', 'ras', 'rgb', 'tif', 'tiff',
                              'wbmp', 'xbm', 'xpm', 'xwd'];
                              ...
                              <img class="image-preview image_mechanic"
                                style="width: 100%;height: 100px;object-fit: contain;"
                                src="{{ URL::to(auth()->user()->profile['mechanic_docs']??'') }}" id="mechanic_docs" />
                              <iframe class="iframe_mechanic" style="display: none"
                                src="data:image/png;base64,"
                                id="mechanic_docs_iframe" width="50%" height="600" scrolling="no">
                                This browser does not support PDFs. Please download the PDF to view it: <a
                                  href="{{ asset('folder/file_name.pdf') }}">Download PDF</a>
                              </iframe>
                              @else
                              ...
                              @endif
                              <input type="hidden" name="old_mechanic_docs"
                                value="{{ auth()->user()->profile['mechanic_docs']??'' }}">
                              @else
                              <img class="image-preview image_mechanic"
                                style="width: 100%;height: 150px;object-fit: contain;"
                                src="data:image/png;base64,"
                ...
                <div role="tabpanel" class="tab-pane @if(session('settingValue')==" JOB") active @endif"
                  id="account-vertical-general-job" aria-labelledby="account-pill-general" aria-expanded="true">
                  <form novalidate method="post" action="{{ route('vender.service.update') }}"
                    enctype="multipart/form-data">
                    @csrf
                    <h4>Services</h4>
                    <hr />
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <fieldset>
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input selectall{{  $service['id'] }}" @foreach
                              ($user['vender_services'] as $warrantyjob) @if($warrantyjob['id']==$service['id']) checked
                              @endif @endforeach onchange="onchangeCheckbox(`{{ $service['id'] }}`)" name="service_id[]"
                              value="{{ $service['id'] }}" id="custom-warratanty{{ $service['id'] }}">
                            <label class="custom-control-label"
                              for="custom-warratanty{{ $service['id'] }}">{{ $service['name'] }} (Main Services)
                            </label>
                          </div>
                        </fieldset>
                      </div>
                      ...
                      <div class="col-md-3">
                        <fieldset>
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input tf{{ $service['id'] }}" @foreach
                              ($user['vender_services'] as $warrantyjob) @if($warrantyjob['id']==$c_service['id'])
                              checked @endif @endforeach name="service_id[]" value="{{ $c_service['id'] }}"
                              id="custom-warratanty{{ $c_service['id'] }}">
                            <label class="custom-control-label"
                              for="custom-warratanty{{ $c_service['id'] }}">{{ $c_service['name'] }}</label>
                          </div>
                        </fieldset>
                      </div>
                      @endforeach
                ...
                <div class="tab-pane @if(session('settingValue')==" PAYMENT") active show @endif"
                  id="account-vertical-info" role="tabpanel" aria-labelledby="account-pill-info" aria-expanded="false">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <div class="controls">
                          <label for="account-phone">Credit Card Number</label>
                          <div type="text" class="form-control" id="card-number-element"></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <div type="text" class="form-control" id="card-cvc-element" placeholder="cvv"></div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="account-website">Expiry Date</label>
                        <div type="text" class="form-control" id="card-expiry-element" placeholder="Expiry Date"></div>
                      </div>
                    </div>
                    ...
                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                      <button class="btn btn-primary mr-sm-1 mb-1 mb-sm-0" id="card-button"
                        ...
                        <img class="show-loader" style="width: 40px;height: 30px;display:none"
                ...
                <div class="tab-pane @if(session('settingValue')==" SOCIAL") active show @else fade @endif " id="
                  account-vertical-social" role="tabpanel" aria-labelledby="account-pill-social" aria-expanded="false">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="account-facebook" name="facebook"
                            value="{{ auth()->user()->profile['facebook']??'' }}" class="form-control"
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="account-google" name="trust_plot_link"
                            value="{{ auth()->user()->profile['trust_plot_link']??'' }}" class="form-control"
                            placeholder="Add link">
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="account-instagram" name="instagram"
                            value="{{ auth()->user()->profile['instagram']??'' }}" class="form-control"
                            placeholder="Add link">
                        </div>
                      </div>
                      <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                ...
                <div class="tab-pane @if(session('settingValue')==" SUBSCRIPTION") active show @else fade @endif"
                  id="account-vertical-connections" role="tabpanel" aria-labelledby="account-pill-connections"
                  aria-expanded="false">
                  @if(auth()->user()->profile['mechanic_docs']!=null)
                  <div class="row">
                    <div class="col-12 ">
                    ...
                    <div class="col-12">
                      ...
                      <button class="btn btn-primary" style="margin:25px 0px;">
                        <a style="color: white" href="{{ route('vender.resume.subscription') }}">Resume Subscription</a>
                      </button>
                      @else
                      <button class="btn btn-primary" style="margin:25px 0px;">
                        <a style="color: white" href="{{ route('vender.end.subscription') }}">End Subscription</a>
                      </button>
                      @endif
                      @endif
                    </div>
                              ...
                              <thead>
                                <tr role="row">
                                  <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                    ...
                                    style="width: 394.391px;">Package Name</th>
                                  <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                    colspan="1" aria-label="Position: activate to sort column ascending"
                                    style="width: 394.391px;">Package Amount</th>
                                  <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                    colspan="1" aria-label="Start date: activate to sort column ascending"
                                    style="width: 173.984px;">Start date</th>
                                  <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                    colspan="1" aria-label="Start date: activate to sort column ascending"
                                    style="width: 173.984px;">End date</th>
                                </tr>
                              </thead>
                              <tbody>
                                ...
                                <tr role="row" class="odd">
                                  ...
                                  <td>{{ \Carbon\Carbon::parse($transaction->created_at)->format('F jS, Y') }}</td>
                                  <td>
                                    {{ \Carbon\Carbon::parse($transaction->created_at)->addDays(1)->format('F jS, Y') }}
                                  </td>
                                </tr>
                                @endforeach
                              </tbody>
