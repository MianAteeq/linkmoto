                ...
                @if (auth()->user()->profile['mechanic_docs'] != null)
                    <div class="col-md-3 mb-2 mb-md-0">
                        <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                            <li class="nav-item">
                                <a class="nav-link d-flex @if (session('settingValue') == ' PROFILE' || session('settingValue') == null) active @endif"
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex @if (session('settingValue') == ' JOB') active @endif"
                                    id="account-pill-general" data-toggle="pill" href="#account-vertical-general-job"
                                    aria-expanded="true">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane @if (session('settingValue') ==
                                    "
                                              PROFILE" || session('settingValue') == null) active @endif"
                                id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="email" class="form-control" name="email"
                                                            value="{{ auth()->user()->email ?? '' }}" id="account-e-mail"
                                                            placeholder="Email" required
                                                            data-validation-required-message="This email field is required">
                                                        @if ($errors->has('owner_email'))
                                                            <span
                                                                class="text-danger">{{ $errors->first('owner_email') }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    @if ($errors->has('trading_name'))
                                                        <span
                                                            class="text-danger">{{ $errors->first('trading_name') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <select class="form-control" name="operation_type">
                                                        <option value="Mobile"
                                                            @if (auth()->user()->profile['company_name'] == 'Mobile') selected @endif>Mobile
                                                        </option>
                                                        <option value="On-Premises"
                                                            @if (auth()->user()->profile['company_name'] == 'On-Premises') selected @endif>On-Premises
                                                        </option>
                                                        <option value="Both"
                                                            @if (auth()->user()->profile['company_name'] == 'Both') selected @endif>Both</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" class="form-control" id="account-website"
                                                    name="website" value="{{ auth()->user()->profile['website'] ?? '' }}"
                                                    ...
                                                    <fieldset>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                name="warranty_job_id[]"
                                                                @foreach ($user['warranty_jobs'] as $warrantyjob) @if ($warrantyjob['id'] == $warranty_job['id'])
                                checked @endif @endforeach
                                                                id="custom-warratanty{{ $warranty_job['id'] }}"
                                            ...
                                            @foreach ($accredictions as $key => $accrediction)
                                                <div class="col-md-3 mt-1">
                                                    <fieldset>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                name="accrediction_id[]"
                                                                @foreach ($user['accreditation_schemes'] as $warrantyjob)
                                @if ($warrantyjob['id'] == $accrediction['id']) checked @endif @endforeach
                                                                id="custom-acc{{ $accrediction['id'] }}"
                                                                value="{{ $accrediction['id'] }}">
                                                            <label class="custom-control-label"
                                                    ...
                                                    <fieldset>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                ...
                                                                @foreach ($user['payment_methods'] as $warrantyjob)
                                @if ($warrantyjob['id'] == $payment_method['id']) checked @endif @endforeach
                                                                id="custom-payment{{ $payment_method['id'] }}"
                                                    ...
                                                    <div class="custom-file-container" data-upload-id="myFirstImage">
                                                        ...
                                                        <label class="input-container">
                                                            <input accept="*" aria-label="Choose File"
                                                                class="input-hidden"
                                                                id="file-upload-with-preview-myFirstImage" type="file"
                                                                name="address_proff" onchange="loadAddressProff(event)">
                                                        ...
                                                        @if (auth()->user()->profile['address_proff'] != null)
                                                            @php
                                                                ...
                                                                $explodeImage = explode(
                                                                    '.',
                                                                    auth()->user()->profile['address_proff'],
                                                                );
                                                            ...
                                                            @else
                                                                ...
                                                                <iframe class="iframe_address_proff"
                                                                    src="{{ URL::to(auth()->user()->profile['address_proff'] ?? '') }}"
                                                                    id="address_proff" width="50%" height="600">
                                                                    This browser does not support PDFs. Please download the
                                                                    PDF to view it: <a
                                                                        href="{{ asset('folder/file_name.pdf') }}">Download
                                                                        PDF</a>
                                                        ...
                                                        @else
                                                            ...
                                                            <iframe class="iframe_address_proff" style="display: none"
                                                                src="data:image/png;base64,"
                                                                id="address_proff_iframe" width="50%" height="600"
                                                                scrolling="no">
                                                    ...
                                                    <div class="custom-file-container" data-upload-id="mySecondImage">
                                                        ...
                                                        <label class="input-container">
                                                            <input accept="*" onchange="loadMechanicDocs(event)"
                                                                ...
                                                                id="file-upload-with-preview-mySecondImage" type="file"
                                                                name="mechanic_docs">
                                                            <span class="input-visible">Choose file...<span
                                                                    class="browse-button">Browse</span></span>
                                                        </label>
                                                        @if (auth()->user()->profile['mechanic_docs'] != null)
                                                            @php
                                                                ...
                                                                $explodeImage2 = explode(
                                                                    '.',
                                                                    auth()->user()->profile['mechanic_docs'],
                                                                );
                                                            ...
                                                            @if (in_array($extension2, $imageExtensions2))
                                                                ...
                                                                <iframe class="iframe_mechanic" style="display: none"
                                                                    src="data:image/png;base64,"
                                                                    id="mechanic_docs_iframe" width="50%"
                                                                    height="600" scrolling="no">
                                                                    This browser does not support PDFs. Please download the
                                                                    PDF to view it: <a
                                                                        href="{{ asset('folder/file_name.pdf') }}">Download
                                                        ...
                                                        @else
                                                            ...
                                                            <iframe class="iframe_mechanic" style="display: none"
                                                                src="data:image/png;base64,"
                                                                id="mechanic_docs_iframe" width="50%" height="600"
                                                                scrolling="no">
                                                                This browser does not support PDFs. Please download the PDF
                                                                to view it: <a
                                                                    href="{{ asset('folder/file_name.pdf') }}">Download
                            ...
                            <div role="tabpanel" class="tab-pane @if (session('settingValue') == ' JOB') active @endif"
                                id="account-vertical-general-job" aria-labelledby="account-pill-general"
                                aria-expanded="true">
                                        ...
                                        @foreach ($all_services as $service)
                                            <div class="col-md-12">
                                                <fieldset>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox"
                                                            class="custom-control-input selectall{{ $service['id'] }}"
                                                            @foreach ($user['vender_services'] as $warrantyjob) @if ($warrantyjob['id'] == $service['id']) checked
                              @endif @endforeach
                                                            onchange="onchangeCheckbox(`{{ $service['id'] }}`)"
                                                            name="service_id[]" value="{{ $service['id'] }}"
                                                            id="custom-warratanty{{ $service['id'] }}">
                                                        <label class="custom-control-label"
                                                            for="custom-warratanty{{ $service['id'] }}">{{ $service['name'] }}
                                                            (Main Services)
                                                        </label>
                                                    </div>
                                                </fieldset>
                                            ...
                                            @foreach ($service['child_services'] as $c_service)
                                                <div class="col-md-3">
                                                    <fieldset>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox"
                                                                class="custom-control-input tf{{ $service['id'] }}"
                                                                @foreach ($user['vender_services'] as $warrantyjob) @if ($warrantyjob['id'] == $c_service['id'])
                              checked @endif @endforeach
                                                                name="service_id[]" value="{{ $c_service['id'] }}"
                            ...
                            <div class="tab-pane @if (session('settingValue') == ' SOCIAL') active show @else fade @endif "
                                id="
                  account-vertical-social" role="tabpanel"
                                        ...
                                        <div class="col-12">
                                            @if (auth()->user()->subscription($sub) != null)
                                                ...
                                                @else
                                                    <button class="btn btn-primary" style="margin:25px 0px;">
                                                        <a style="color: white"
                                                            href="{{ route('vender.end.subscription') }}">End
                                                            Subscription</a>
                                                    </button>
                                                @endif
                                            @endif
                                                            ...
                                                            <tbody>
                                                                @foreach ($transactions as $transaction)
                                                                    <tr role="row" class="odd">
                                                                        ...
                                                                        <td>{{ \Carbon\Carbon::parse($transaction->created_at)->format('F jS, Y') }}
                                                                        </td>
                                                                        <td>
