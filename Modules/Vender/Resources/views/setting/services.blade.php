                ...
                <form novalidate method="post" action="{{ route('vender.service.update') }}"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <fieldset>
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input selectall{{  $service['id'] }}"
                            onchange="onchangeCheckbox(`{{ $service['id'] }}`)" name="service_id[]"
                            value="{{ $service['id'] }}" id="custom-warratanty{{ $service['id'] }}" value="">
                          <label class="custom-control-label"
                            for="custom-warratanty{{ $service['id'] }}">{{ $service['name'] }} (Main Services) </label>
                        </div>
                    </div>
                    <hr />
                    ...
                    <div class="col-md-3">
                      <fieldset>
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input tf{{ $service['id'] }}" name="service_id[]"
                            value="{{ $c_service['id'] }}" id="custom-warratanty{{ $c_service['id'] }}" value="">
                          <label class="custom-control-label"
