            ...
            <div class="invoice-side">
                ...
                <table id="meta">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="due"> £ {{ $invoice['total'] }}</div>
                        </td>
                    </tr>
                ...
                <table id="meta" style="margin-top:20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <p>{{ $invoice['booking']['contact_detail']['name'] }}</p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <p id="date">{{ $invoice['booking']['contact_detail']['name'] }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="meta-head">Mobile</td>
                        <td>
                            <div class="due">{{ $invoice['booking']['contact_detail']['mobile_no'] }}</div>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="tright">
                <table id="items" style="border:none !important;margin-left:9px">
                    ...
                    <tr>
                        ...
                        <td class="total-value">
                            <div id="subtotal">£ {{ $invoice['total'] }}</div>
                        </td>
                    </tr>
                    <tr>
