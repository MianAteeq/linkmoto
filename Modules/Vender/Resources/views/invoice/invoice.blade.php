            ...
            <div id="customer">
                ...
                <table id="meta" style="margin-top: 20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <p id="date">{{ $quotation['vehicle']['vehicle_make']['name'] }} /
            ...
            <div class="invoice-side">
                ...
                <table id="meta">
                    ...
                    <tr>
                        ...
                        <td>
                            <p id="date">{{ \Carbon\Carbon::parse($quotation->quotation_date)->format('D m Y') }}
                            </p>
                        </td>
                    </tr>
                    <tr>
                ...
                <table id="meta" style="margin-top:20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="due">{{ $quotation['contact_detail']['address'] }},
                                {{ $quotation['contact_detail']['city'] }}
                                {{ $quotation['contact_detail']['postal_code'] }}</div>
                        </td>
                    </tr>
       ...
       <div class="due">$875.00</div>
        ...
        <div class="footer">
            ...
            <div class="footer_bottom">
                <p>&copy; 2022 motonos.com | All Right Reserved</p>
            </div>
