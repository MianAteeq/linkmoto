...
@media (max-width: 768px) {
  ...
  /* Spacing between the stacked left column and right column */
  .col-md-9 {
    margin-top: 20px;
  ...
  /* Adds vertical spacing between stacked metric cards */
  .card.pull-up {
    margin-bottom: 15px !important;
  }

  /* Fixes the transaction header button overlap on small screens */
  ...
  .card-header .heading-elements ul li {
    display: block;
  }

  .card-header .heading-elements ul li a.pull-right {
          ...
          <div class="card-header">
            ...
            <div class="heading-elements">
              <ul class="list-inline mb-0">
                <li><a class="btn btn-sm btn-danger box-shadow-2 round btn-min-width pull-right" href=""
