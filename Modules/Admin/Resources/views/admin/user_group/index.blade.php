...
<div class="row">
    <div class="col-md-3">
        ...
        font-size: 17px; "> <img src="/users.png" style="width: 22px;margin-top: -5px;"> Directory</h2>
    ...
    <div class="col-md-9" id="contens" style="border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;margin-top: 0px;">
        ...
        <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;">
            ...
            <a id="headingCollapse1"  class="card-header info mt-2" style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;margin-top: 1px !important;border-bottom-left-radius: 0px !important; border-bottom-right-radius: 0px !important;"  data-toggle="collapse"  aria-expanded="false" aria-controls="collapse14" >
                ...
                <div class="card-content">
                    <div class="card-body" style="padding-left: 0px;padding-right: 0px;">
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                               ...
                                               <td><a href="{{route('admin.user.group.edit',$role['id'])}}"><i class="ft-edit"></i></a> <a href="{{route('admin.user.group.view',$role['id'])}}"><i class="ft-eye"></i></a></td>
                                           </tr>
                        ...
                        <div class="footers">
                            ...
                            <a href="{{route('admin.user.group.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
