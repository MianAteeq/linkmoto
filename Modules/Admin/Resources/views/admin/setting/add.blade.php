            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-2 mb-md-0">
                    <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex " id="account-pill-aboutpage-info" data-toggle="pill"
                                href="#account-vertical-term-info" aria-expanded="true">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex " id="account-pill-aboutpage-info" data-toggle="pill"
                                href="#account-vertical-subscription-info" aria-expanded="true">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex " id="account-pill-aboutpage-info" data-toggle="pill"
                                href="#account-vertical-nda-info" aria-expanded="true">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="tab-content">
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="headerlogo"
                                                                data-default-file="{{ URL::to($setting['headerlogo'] ?? '') }}"
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="footerlogo"
                                                                class="form-control date-inputmask dropify"
                                                                data-default-file="{{ URL::to($setting['footerlogo'] ?? '') }}"
                                                                type="file" placeholder="Footer logo">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="favicon"
                                                                class="form-control date-inputmask dropify"
                                                                data-default-file="{{ URL::to($setting['favicon'] ?? '') }}"
                                                                type="file" placeholder="Fav icon">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="email" class="form-control date-inputmask"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="phone" class="form-control date-inputmask"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="address" class="form-control date-inputmask"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="description" class="form-control date-inputmask"
                                                                value="{{ $setting['description'] ?? '' }}" type="text"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="facebook" class="form-control date-inputmask"
                                                                value="{{ $setting['facebook'] ?? '' }}" type="text"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="twitter" class="form-control date-inputmask"
                                                                value="{{ $setting['twitter'] ?? '' }}" type="text"
                                                                placeholder="twitter">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="insta" class="form-control date-inputmask"
                                                                value="{{ $setting['insta'] ?? '' }}" type="text"
                                                                placeholder="insta">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="linkdin" class="form-control date-inputmask"
                                                                value="{{ $setting['linkdin'] ?? '' }}" type="text"
                                                                placeholder="linkdin">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="title" class="form-control date-inputmask"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="keyword" class="form-control date-inputmask"
                                                                value="{{ $setting['keyword'] ?? '' }}" type="text"
                                                                placeholder="keyword">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="homelocation" class="form-control date-inputmask"
                                                                value="{{ $setting['homelocation'] ?? '' }}"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="homecallus" class="form-control date-inputmask"
                                                                value="{{ $setting['homecallus'] ?? '' }}" type="text"
                                                                placeholder="Call Us">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="homescedule" class="form-control date-inputmask"
                                                                value="{{ $setting['homescedule'] ?? '' }}"
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="hometestimonialvedio"
                                                                class="form-control date-inputmask" type="text"
                                                                value="{{ $setting['hometestimonialvedio'] ?? '' }}"
                                                                placeholder="Vedio">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="homeFeatureImage"
                                                                class="form-control date-inputmask dropify" type="file"
                                                                data-default-file="{{ URL::to($setting['homeFeatureImage'] ?? '') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="hometestimonialimage"
                                                                class="form-control date-inputmask dropify" type="file"
                                                                data-default-file="{{ URL::to($setting['hometestimonialimage'] ?? '') }}"
                                                                placeholder="Feature Image">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="aboutTitle" class="form-control date-inputmask"
                                                                value="{{ $setting['aboutTitle'] ?? '' }}" type="text"
                                                                placeholder="Title">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="aboutImage" class="form-control date-inputmask"
                                                                data-default-file="{{ URL::to($setting['aboutImage'] ?? '') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="aboutVedioLink"
                                                                class="form-control date-inputmask"
                                                                value="{{ $setting['aboutVedioLink'] ?? '' }}"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="aboutBanner"
                                                                class="form-control date-inputmask dropify" type="file"
                                                                placeholder="Banner"
                                                                data-default-file="{{ URL::to($setting['aboutBanner'] ?? '') }}">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <textarea name="privacy_policy" class="form-control summernote" type="text" rows="4" cols="4"
                                    ...
                                    <div role="tabpanel" class="tab-pane " id="account-vertical-term-info"
                                        aria-labelledby="account-pill-general" aria-expanded="true">
                                        <form method="POST" action="{{ route('admin.settings.store') }}"
                                            enctype="multipart/form-data" class="needs-validation" novalidate>
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset>
                                                        <h5>Term and Condition
                                                            <small class="text-muted">(Term and Condition)</small>
                                                        </h5>
                                                        <div class="form-group">
                                                            <textarea name="term_condition" class="form-control summernote" type="text" rows="4" cols="4"
                                                                placeholder="Description">{{ $setting['term_condition'] ?? '' }}</textarea>
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane " id="account-vertical-subscription-info"
                                        aria-labelledby="account-pill-general" aria-expanded="true">
                                        <form method="POST" action="{{ route('admin.settings.store') }}"
                                            enctype="multipart/form-data" class="needs-validation" novalidate>
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <textarea name="subscription_term_condition" class="form-control summernote" type="text" rows="4"
                                                                cols="4" placeholder="Description">{{ $setting['subscription_term_condition'] ?? '' }}</textarea>
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane " id="account-vertical-nda-info"
                                        aria-labelledby="account-pill-general" aria-expanded="true">
                                        <form method="POST" action="{{ route('admin.settings.store') }}"
                                            enctype="multipart/form-data" class="needs-validation" novalidate>
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset>
                                                        <h5>NDA
                                                            <small class="text-muted">(NDA)</small>
                                                        </h5>
                                                        <div class="form-group">
                                                            <textarea name="nda" class="form-control summernote" type="text" rows="4" cols="4"
                                                                placeholder="Description">{{ $setting['nda'] ?? '' }}</textarea>
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="servicesBanner"
                                                                class="form-control date-inputmask dropify" type="file"
                                                                data-default-file="{{ URL::to($setting['servicesBanner'] ?? '') }}"
                                                                placeholder="Banner">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="contactBanner"
                                                                class="form-control date-inputmask dropify" type="file"
                                                                data-default-file="{{ URL::to($setting['contactBanner'] ?? '') }}"
                                                                placeholder="Banner">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="pricingBanner"
                                                                class="form-control date-inputmask dropify" type="file"
                                                                data-default-file="{{ URL::to($setting['pricingBanner'] ?? '') }}"
                                                                placeholder="Banner">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="STRIPE_KEY" class="form-control date-inputmask"
                                                                type="text" value="{{ $setting['STRIPE_KEY'] ?? '' }}"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <input name="PAYPAL_KEY" class="form-control date-inputmask"
                                                                type="text" value="{{ $setting['PAYPAL_KEY'] ?? '' }}"
