...
@section('css_custom')
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ URL::to('modules/admin/app-assets/fonts/simple-line-icons/style.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ URL::to('modules/admin/app-assets/css/core/colors/palette-gradient.css') }}">
@endsection
        ...
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a>Motonos</a>
                        </li>
...
@section('content')
    ...
    <div class="row">
        ...
        font-size: 17px; ">
                <img src="/home.png" style="width: 22px;margin-top: -5px;"> Dashboard</h2>
        </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li>
                                        <a class="btn btn-info" href="{{ route('admin.jobs') }}" target="_blank">View
                                            all</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($quotations as $quotation)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-info btn-outline-success round">{{ $quotation['service']['name'] ?? 'No Service' }}</button>
                                                </td>
