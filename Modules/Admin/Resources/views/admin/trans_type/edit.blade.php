...
<div class="content-header bg-white" >
    <div  class="row" style="border-bottom: 3px solid #949494;">
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           <h3 class="h3">Transmission Type</h3>
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a style="color: black" href="{{route('admin.ref.data')}}">Product settings</a>
                </li>
                <li class="breadcrumb-item"><a style="color: black" href="{{route('admin.trans.type')}}">Transmission Type</a>
                </li>




                <li class="breadcrumb-item">Edit Transmission Type
                </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/settings.png" style="width: 22px;margin-top: -5px;" > Edit Transmission Type
        </h4>
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Transmission Type information</h3>
            </div>


         </div>
         <form action="{{route('admin.trans.type.update')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
            <div class="link-body"  style="padding: 10px">
                <input type="hidden" name="id" value="{{$car_maker['id']}}">

                <div class="form-group row">
                    <label class="col-md-4 label-control" for="eventRegInput5">Transmission Type *</label>
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="transmission_types" class="form-control" value="{{$car_maker['transmission_types']}}" onkeyup="lookup(this);" name="transmission_types" placeholder="Transmission Type">
                        <p class="text-danger transmission_types" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                    </div>
                </div>
