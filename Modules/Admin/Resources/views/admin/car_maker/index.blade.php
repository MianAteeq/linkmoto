        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Vehicle Makes
                </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/settings.png" style="width: 29px; margin-top: 1px;" > Vehicle Makes
    ...
    padding-right: 0;">
        ...
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Vehicle Makes
            </h3>
            </div>
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $car_maker['name'] }}</td>
                                <td>
                                    @if($car_maker['image']!=null)
                                    <div class="avatar">
                                        <img src="{{asset($car_maker['image'])}}" alt="avtar img holder">
                                    </div>
                                    @else
                                ...
                                <td>
                                    <a href="{{route('admin.makers.edit',$car_maker['id'])}}" class="primary edit mr-1"><i class="la la-pencil"></i></a>
                                    <a onclick="delete_this(`{{ $car_maker['id'] }}`,`{{ route('admin.makers.destroy',$car_maker->id) }}`)" class="danger delete mr-1"><i class="la la-trash-o"></i></a>
                                </td>
                            </tr>
         ...
         <div class="footers">
             ...
             <a href="{{route('admin.makers.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
...
<script>
    function delete_this(id) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    window.location.href = "{{ url('admin/vehicle/makers/destroy/')}}/" + id;
                } else {
