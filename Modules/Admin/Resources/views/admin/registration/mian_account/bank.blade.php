            ...
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"> {{ $site['account_name'] }}
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div style="border-radius: 7px;border: 2px solid black; ">
                ...
                <p
                    ...
                    <strong> {{ $site['account_name'] }}</strong> <br>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 text-secondary">
                                        @if ($site['proof'] == null)
                                        @else
                                            {{ $site['proof'] ?? 'N/A' }} <a class="btn btn-primary btn-primary_2"
                            ...
                            @if ($site['status'] == 'Pending')
                                <div class="card-footer">
                                    <div class="text-secondary" style="text-align: right">
                                        <a href="{{ route('admin.register.detail.bank.rejected', $site['id']) }}"
                                            style=" background-color: black !important;
                                       border-color: black !important;"
                                            class="btn btn-primary"> Reject</a>
                                        <a href="{{ route('admin.register.detail.bank.verify', $site['id']) }}"
                                            style=" background-color: black !important;
                                       border-color: black !important;"
