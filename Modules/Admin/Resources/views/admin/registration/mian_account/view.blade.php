                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 text-secondary">
                                        ...
                                        @else
                                            {{ $user['proof_id'] }} <a class="btn btn-primary btn-primary_2"
                            ...
                            @if ($user['user_verified'] == 'Pending')
                                <div class="card-footer">
                                    <div class="text-secondary" style="text-align: right">
                                        <a href="{{ route('admin.register.detail.main.contact.rejected', $user['id']) }}"
                                            style=" background-color: black !important;
                                       border-color: black !important;"
                                            class="btn btn-primary"> Reject</a>
                                        <a href="{{ route('admin.register.detail.main.contact.verify', $user['id']) }}"
                                            style=" background-color: black !important;
                                       border-color: black !important;"
