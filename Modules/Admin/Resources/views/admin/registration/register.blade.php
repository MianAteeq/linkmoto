...
<div class="row">
    ...
    <div class="col-md-9" id="contens" style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;">
        <div class="row">
           <div class="col-md-12" style="border-bottom: 2px solid black;">
            <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Registered</h3>
           </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered zero-configuration">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>BSN{{sprintf("%05d",$user['id'])}}</td>
                                <td>{{$user['profile']['trading_name']}}</td>
                                <td>@if($user['profile']['operation_type'] === 'Both')
        On-site<br>
        Mobile
    @else
    ...
    @endif</td>
                                ...
                                <td><button class="btn btn-primary" onclick="window.location.href=`{{route('admin.register.detail',$user['id'])}}`"> <i class="ft-eye"></i></button></td>
                            </tr>
                            @endforeach
