    ...
    <div class="content-header bg-white">
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                <h3 class="h3">Main contact person</h3>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a style="color: black"
                                href="{{ route('admin.application.detail', $user['id']) }}">{{ $user['profile']['trading_name'] }}</a>
                        </li>
                        <li class="breadcrumb-item">Main contact person
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div style="border-radius: 7px;border: 2px solid black; ">
                ...
                <p style="color: black;padding-left: 25px;">Verification status : @if ($user['profile']['main_account_status'] == 0)
                        Pending
                ...
                @if ($user['profile']['main_account_status'] == 0)
                    <div class="footers" style="border-top: 2px solid black;padding: 10px ">
                        <button class="btn btn-primary btn-block"
                            onclick="window.location.href=`{{ route('admin.main.account.verify', $user['id']) }}`">ACCEPT</button>
                        <button class="btn btn-primary btn-block"
                            onclick="window.location.href=`{{ route('admin.main.account.decline', $user['id']) }}`">DECLINE</button>
        ...
        <div class="col-md-9" id="contens" style="border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;">
            <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;">
                ...
                <a id="headingCollapse1" href="{{ redirect()->back()->getTargetUrl() }}" class="card-header info mt-2"
                    ...
                    <div class="card-title lead collapsed">Main contact person</div>
                </a>
            ...
            border-bottom-right-radius: 6px;"
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @if ($user['profile']['main_account_status'] == 0)
                                <div class="ac-footer">
                                    <a class="btn btn-primary btn-primary_2" style="float: right;"
                                        href="{{ route('admin.main.account.info.verify', $user['id']) }}">VERIFY</a>
