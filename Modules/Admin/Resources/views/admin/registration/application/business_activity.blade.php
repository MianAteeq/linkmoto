...
<div class="content-header bg-white" >
    <div  class="row" style="border-bottom: 3px solid #949494;">
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           <h3 class="h3">Business activities</h3>
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Business activities
                </li>
            </ol>
        </div>
        </div>
...
<div class="row">
    <div class="col-md-3">
        ...
        <p style="color: black;padding-left: 25px;">Status :  @if ($user['application_status']=="IN_REVIEW") Info in Review @else {{$user['application_status']}}  @endif</p>
          <p style="color: black;padding-left: 25px;">Verification status :  @if($user['profile']['business_activities_status']==0)  Pending @elseif ($user['profile']['business_activities_status']==1) Accepted  @else Decline @endif</p>

          @if($user['profile']['business_activities_status']==0)
          <div class="footers" style="border-top: 2px solid black;padding: 10px ">
            <button class="btn btn-primary btn-block" onclick="window.location.href=`{{route('admin.business.activity.verify',$user['id'])}}`">ACCEPT</button>
            <button class="btn btn-primary btn-block" onclick="window.location.href=`{{route('admin.business.activity.decline',$user['id'])}}`">DECLINE</button>
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 text-secondary">
                                {{$user['profile']['business_proof_name']}} <a class="btn btn-primary btn-primary_2" style="border-color: #ff6600 !important; background-color: #ff6600 !important;float: right;" target="_blank" href="{{URL::to($user['profile']['business_proof'])}}">View</a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 text-secondary">
                             @if($user['profile']['business_activities_status']==0)  Pending @elseif ($user['profile']['business_activities_status']==1) Accepted  @else Decline @endif
                            </div>
                        </div>
                        @if($user['profile']['business_activities_status']==0)
                        <div class="ac-footer">
                            <a class="btn btn-primary btn-primary_2" style="float: right;"  href="{{route('admin.business.activity.info.verify',$user['id'])}}">VERIFY</a>
