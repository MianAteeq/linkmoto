    ...
    <div class="content-header bg-white">
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                <h3 class="h3">Verify Subscription</h3>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Verify Subscription
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="col-md-9" id="contens" style="border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;">
            <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;">
                ...
                <a id="headingCollapse1" href="{{ redirect()->back()->getTargetUrl() }}" class="card-header info mt-2"
                    ...
                    <div class="card-title lead collapsed">Agreement</div>
                </a>
            ...
            border-bottom-right-radius: 6px;"
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-5">
                                    <h6 class="mb-0"> Agreements – Privacy Policy</h6>
                                </div>
                                <div class="col-sm-7 text-secondary">
                                    {{ $user['profile']['is_privacy_policy'] == 1 ? 'YES' : 'NO' }}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7 text-secondary">
                                    {{ $user['profile']['is_sub'] == 1 ? 'YES' : 'NO' }}
                                </div>
                            </div>
                            @if ($user['profile']['agreement_status'] == 0)
                                <div class="ac-footer">
                                    <a class="btn btn-primary btn-primary_2" style="float: right;"
                                        href="{{ route('admin.agreement.verify', $user['id']) }}">ACCEPT</a>
                                    <a class="btn btn-primary btn-primary_2 mr-2" style="float: right;"
                                        href="{{ route('admin.agreement.decline', $user['id']) }}">DECLINE</a>
