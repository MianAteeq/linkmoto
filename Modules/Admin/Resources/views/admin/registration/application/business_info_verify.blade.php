    ...
    <div class="content-header bg-white">
        <div class="row" style="border-bottom: 3px solid #949494;">
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                <h3 class="h3">Verify business information</h3>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Verify business information
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            @if ($user['profile']['business_status'] == 0)
                                <div class="ac-footer">
                                    <a class="btn btn-primary btn-primary_2" style="float: right;"
                                        href="{{ route('admin.business.verify', $user['id']) }}">ACCEPT</a>
                                    <a class="btn btn-primary btn-primary_2 mr-2" style="float: right;"
                                        href="{{ route('admin.business.decline', $user['id']) }}">DECLINE</a>
