                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a style="color: black"
                                href="{{ route('admin.interests') }}">Interests</a>
                        </li>
                    </ol>
                </div>
            </div>
...
@section('content')
    <div class="row">
        ...
        font-size: 17px; ">
                <img src="/home.png" style="width: 22px;margin-top: -5px;"> Business</h2>
        </div>
        <div class="col-md-9" id="contens"
            style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;">
            <div class="row">
                                ...
                                @foreach ($users as $user)
                                    @isset($user['profile'])
                                        <tr>
                                            ...
                                            <td>
                                                @if ($user['profile']['operation_type'] === 'Both')
                                                    On-site<br>
                                                    Mobile
                                                @else
                                                    {{ ucfirst($user['profile']['operation_type']) }}
                                                @endif
                                            </td>
                                            ...
                                            <td><button class="btn btn-primary"
                                                    onclick="window.location.href=`{{ route('admin.interests.detail', $user['id']) }}`">
                                                    <i class="ft-eye"></i></button></td>
                                        </tr>
                                    @endisset
                                @endforeach
