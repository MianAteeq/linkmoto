...
<div class="row">
    ...
    <div class="col-md-9" id="contens" style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-bottom: 10px;">
        <div class="row">
           <div class="col-md-12" style="border-bottom: 2px solid black;">
            <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Interests</h3>
           </div>
    ...
    @endif
                                ...
                                <td>{{$user['status']}}</td>
                                <td><button class="btn btn-primary" onclick="window.location.href=`{{route('admin.interests.detail',$user['id'])}}`"> <i class="ft-eye"></i></button></td>
                            </tr>
                            @endforeach
