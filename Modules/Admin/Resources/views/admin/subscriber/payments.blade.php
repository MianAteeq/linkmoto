        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a style="color: black" href="{{route('admin.payments')}}">Payments</a>
                </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/wallet.png" style="width: 29px; margin-top: 1px;" > Billing
    ...
    padding-right: 0;height: 460px;">
        ...
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Payments
            </h3>
            </div>
                    ...
                    <table class="table table-striped table-bordered zero-configuration">
                        ...
                        @foreach ($subscriptions as $account)
                           <tr>
                               ...
                               <td> PAY-{{sprintf("%04d",$account['id'])}} </td>

                               <td>{{number_format(($account['amount_due']/100),2)}}</td>
                               <td>{{number_format(($account['amount_paid']/100),2)}}</td>
                               <td>{{number_format($account['amount_due']-$account['amount_paid'],2)}}</td>

                               <td><a href="{{route('admin.payments.detail',$account['id'])}}"><i class="ft-eye"></i></a></td>
                           </tr>
