        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a style="color:black" href="{{route('admin.subscribers')}}">Subscriptions</a>
                </li>
...
<div class="row">
    ...
    padding-right: 0;height: 560.75px;">

        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Subscriptions
            </h3>
            </div>
                    ...
                    <table class="table table-striped table-bordered zero-configuration">
                        ...
                        @foreach ($subscriptions as $account)
                           <tr>
                               ...
                               <td>{{$account['user']['name']??''}} {{$account['user']['last_name']??''}} <br>
                                {{$account['user']['email']??''}}
                            </td>
                               ...
                               @if(\Carbon\Carbon::now()>\Carbon\Carbon::parse($account['end_at']))
                               <td>InActive</td>
                               @else
                               <td>Active</td>

                               @endif
                               <td><a href="{{route('admin.subscription.detail',$account['id'])}}"><i class="ft-eye"></i></a></td>
                           </tr>
