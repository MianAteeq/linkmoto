    ...
    <div class="col-md-3">
        ...
        <div class="col-md-9" id="contens" style="margin-bottom: 10px;padding-left: 0;padding-right: 0;">
            ...
            <div class="card default-collapse collapse-icon accordion-icon-rotate" style="box-shadow: none;">
                ...
                <a id="headingCollapse1" href="{{route('admin.hub.user.app.data.vehicle',$user['id'])}}" class="card-header info mt-2" style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"   >
                    <div class="card-title lead collapsed">Vehicles</div>
                </a>
                <a id="headingCollapse1" href="{{route('admin.hub.user.app.data.quote',$user['id'])}}" class="card-header info mt-2" style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"   >
                    <div class="card-title lead collapsed">Quotes</div>
                </a>
                <a id="headingCollapse1" href="{{route('admin.hub.user.app.data.booking',$user['id'])}}" class="card-header info mt-2" style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"   >
                    <div class="card-title lead collapsed">Bookings</div>
                </a>
                <a id="headingCollapse1" href="{{route('admin.hub.user.app.data.job',$user['id'])}}" class="card-header info mt-2" style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"   >
                    <div class="card-title lead collapsed">Jobs</div>
                </a>
                <a id="headingCollapse1" href="{{route('admin.hub.user.app.data.invoice',$user['id'])}}" class="card-header info mt-2" style="border: 2px solid black;border-radius: 7px !important;padding: 1.2rem 1rem;color: black !important;"   >
