...
<div class="row">
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
         ...
         <form action="{{route('admin.user.update')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens">
             @csrf
            ...
            <div class="link-body"  style="padding: 10px">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="middle_name" class="form-control" value="{{$user['middle_name']}}" onkeyup="lookup(this);" name="middle_name" placeholder="Middle name ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="tel" id="landline" class="form-control" value="{{$user['landline_no']}}" onkeyup="lookup(this);" name="landline" placeholder="Landline">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        ...
                        border-radius: 7px;">
                            ...
                            <option value="{{$role['id']}}" @foreach($user['roles'] as $role_id) @if($role['id']==$role_id['id']) selected  @endif @endforeach >{{$role['name']}}</option>
                            @endforeach
