...
<div class="row">
    <div class="col-md-3">
        ...
        font-size: 17px; "> <img src="/service_provider.png" style="width: 22px;margin-top: -5px;margin-right: 3px;">Vehicles</h2>
        ...
        padding-right: 0;">
            <div class="row" style="margin-right: 0;margin-left: 0;">
                <div class="col-md-12" style="border-bottom: 2px solid black;">
                 <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Vehicles</h3>
                </div>
                     ...
                     <div class="table-responsive">
                         <table class="table table-striped table-bordered zero-configuration">
                             ...
                             <tbody>
                                ...
                                @foreach ($vehicles as $contact)
                                <tr>
                                    <td>{{$loop->iteration}}</td>
                                    <td>{{$contact['vehicle_no']}}</td>
                                    <td>{{$contact['vrm']}}</td>
                                    <td>{{$contact['vin_number']}}</td>
                                    <td>{{$contact['vehicle_make']['name']}} {{$contact['vehicle_model']['name']}}  </td>


                                    <td> <a href="{{route('admin.hub.user.app.data.vehicle.detail',[$user['id'],$contact['id']])}}"><i class="ft-eye"></i></a></td>
                                </tr>
