...
@section('content')
    <div class="row">
        ...
        font-size: 17px; ">
                <img src="/service_provider.png" style="width: 22px;margin-top: -5px;margin-right: 3px;">Vehicles</h2>
                                 ...
                                 @endforeach --}}
                                    ...
                                    @foreach ($vehicles as $contact)
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('admin.hub.user.app.data.vehicle.detail', [$user['id'], $contact['id']]) }}">
                                                    <i class="ft-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
