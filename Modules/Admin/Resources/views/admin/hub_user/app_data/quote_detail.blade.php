        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
            ...
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"> Quote
                    </li>
                    <li class="breadcrumb-item"> Quote Detail
                    </li>
                    <li class="breadcrumb-item"> {{$contact['quotation_no']}}
                    </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        font-size: 17px; "> <img src="/service_provider.png" style="width: 22px;margin-top: -5px;margin-right: 3px;">Quote Detail</h2>
        ...
        padding-right: 0;">
            <div class="row" style="margin-right: 0;margin-left: 0;">
                <div class="col-md-12" style="border-bottom: 2px solid black;">
                 <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Quote</h3>
                </div>
                                            ...
                                            <div role="tabpanel" class="tab-pane active" id="detail" aria-labelledby="detail-tab1" aria-expanded="true">
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <h6 class="mb-0">Quotataion No</h6>
                                                            </div>
                                                            <div class="col-sm-7 text-secondary">
                                                              {{$contact['quotation_no']??'N/A'}}
                                                            </div>
                                                        </div>
                                                       <hr>
                                                        <div class="row">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-bordered zero-configuration">
                                                                ...
                                                                <tbody>
                                                                   ...
                                                                   @foreach ($contact['quotation_item'] as $job_request)
                                                                   <tr>
                                                                       <td>{{$loop->iteration}}</td>
