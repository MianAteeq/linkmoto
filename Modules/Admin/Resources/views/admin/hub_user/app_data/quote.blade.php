            ...
            <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
                ...
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"> Quotes
                        </li>
                                 ...
                                 @endforeach --}}
                                    ...
                                    @foreach ($contacts as $contact)
                                        <tr>
                                            ...
                                            <td> <a
                                                    href="{{ route('admin.hub.user.app.data.quote.detail', [$user['id'], $contact['id']]) }}"><i
                                                        class="ft-eye"></i></a></td>
                                        </tr>
                                    @endforeach
