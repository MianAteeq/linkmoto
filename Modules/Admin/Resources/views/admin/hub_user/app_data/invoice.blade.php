...
<div class="row">
    <div class="col-md-3">
        ...
        font-size: 17px; "> <img src="/service_provider.png" style="width: 22px;margin-top: -5px;margin-right: 3px;">Invoices</h2>
                         ...
                         <table class="table table-striped table-bordered zero-configuration">
                             ...
                             <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$contact['invoice_date']}}</td>

                                    <td>{{$contact['name']}} {{$contact['company']}}
                                        <br> {{$contact['mobile_no']}}
                                       </td>
                                    <td> {{number_format($contact['total'],2)}} </td>
                                    <td> {{$contact['status']}} </td>


                                    <td> <a href="{{route('admin.hub.user.app.data.invoice.detail',[$user['id'],$contact['id']])}}"><i class="ft-eye"></i></a></td>
                                </tr>
