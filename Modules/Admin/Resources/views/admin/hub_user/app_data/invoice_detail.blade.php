        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
            ...
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"> {{$contact['invoice_no']}}
                    </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        font-size: 17px; "> <img src="/service_provider.png" style="width: 22px;margin-top: -5px;margin-right: 3px;">Invoice Detail</h2>
        ...
        padding-right: 0;">
            <div class="row" style="margin-right: 0;margin-left: 0;">
                <div class="col-md-12" style="border-bottom: 2px solid black;">
                 <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Invoice</h3>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs " style="border: none;margin:10px">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="contact-tab1" data-toggle="tab" href="#contact" aria-controls="contact" aria-expanded="true">Job Detail</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="quote-tab1" data-toggle="tab" href="#quote" aria-controls="quote" aria-expanded="true">Invoice Item</a>
                        </li>
                                                    ...
                                                    <div class="card-body">
                                                       ...
                                                       <hr>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-7 text-secondary">
                                                                {{$contact['booking']['vehicle']['vehicle_no']}} <br>
                                                                {{$contact['booking']['vehicle']['vrm']}} <br>
                                                                {{$contact['booking']['vehicle']['vehicle_make']['name']}}  {{$contact['booking']['vehicle']['vehicle_model']['name']}}
                                                            </div>
                                                        </div>
                                                       <hr>
                                                       <div class="row">
                                                    ...
                                                    <div class="card-body">
                                                       ...
                                                       <hr>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-7 text-secondary">
                                                                {{$contact['booking']['contact_detail']['contact_no']}} <br>  {{$contact['booking']['contact_detail']['name']}} {{$contact['booking']['contact_detail']['last_name']}}
                                                                <br> {{$contact['booking']['contact_detail']['mobile_no']}}
                                                            </div>
                                                        </div>
                                                       <hr>
                                                        <div class="row">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-bordered zero-configuration">
                                                                ...
                                                                <tbody>
                                                                   ...
                                                                   @foreach ($contact['booking']['booking_items'] as $job_request)
                                                                   <tr>
                                                                       <td>{{$loop->iteration}}</td>
                                                                       <td>{{str_replace('JIT','INT',$job_request['job_item_no'])}}</td>
                                                                       <td>{{$job_request['product']}}</td>
                                                                       <td>@foreach ($job_request['job_types'] as $type)
                                                                        <li>{{$type['job_type']['name']??'N.A'}}</li>

                                                                       @endforeach</td>
                                                                       <td>{{$job_request['price_type']['name']??'N.A'}}</td>
