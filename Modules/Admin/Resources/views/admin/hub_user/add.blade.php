...
<div class="row">
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
         ...
         <form action="{{route('admin.user.store')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
            <div class="link-body"  style="padding: 10px">

                <div class="form-group row">
                    <label class="col-md-4 label-control" for="eventRegInput5">First name *</label>
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="name" class="form-control" value="" onkeyup="lookup(this);" name="name" placeholder="First name">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="middle_name" class="form-control" value="" onkeyup="lookup(this);" name="middle_name" placeholder="Middle name ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="last_name" class="form-control" value=""  onkeyup="lookup(this);" name="last_name" placeholder="Last name">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="email" id="email" class="form-control" value="" onkeyup="lookup(this);" name="email" placeholder="Email">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="tel" id="phone_no" class="form-control" value="" onkeyup="lookup(this);" name="phone_no" placeholder="Mobile">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <input type="tel" id="landline" class="form-control" value="" onkeyup="lookup(this);" name="landline" placeholder="Landline">
                        <p class="text-danger landline" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-4 label-control" for="eventRegInput5">User group *</label>
                    <div class="col-md-8 mx-auto">
                        <select id="role_id" name="role_id" class="form-control" style="width: 60%;
                        border-radius: 7px;">
...
<script>
    function submitDetailsForm() {
        let array=['name','last_name','middle_name','email','phone_no','role_id'];
