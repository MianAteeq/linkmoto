...
<head>
    ...
    <title>Login Page - Motonos</title>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/modules/admin/app-assets/vendors/css/forms/icheck/icheck.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/modules/admin/app-assets/vendors/css/forms/icheck/custom.css') }}">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('/modules/admin/app-assets/css/pages/login-register.css') }}">
    <!-- END: Page CSS-->
                                    ...
                                    <div class="card-title text-center">
                                        <div class="p-1">
                                            @isset($setting['headerlogo'])
                                                <img src="{{ URL::to($setting['headerlogo']) ?? '' }}" style="width: 200px;"
                                                    alt="Logo">
                                            @endisset
                                        </div>
                                    </div>
                                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                                        <span>Login with Motonos</span>
                                    </h6>
                                </div>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left mt-1">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" class="form-control" name="password"
                                                        id="inputGroupFile02">
                                                    <label class="input-group-text" onclick="myFunction()"
                                                        for="inputGroupFile02">Hide/Show</label>
                                                </div>
                                            </fieldset>
