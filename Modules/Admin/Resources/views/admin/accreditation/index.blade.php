        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Accreditation
                </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/settings.png" style="width: 29px; margin-top: 1px;" > Accreditation & Schemes
    ...
    padding-right: 0;">
        ...
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Accreditation & Schemes
            </h3>
            </div>
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <a href="{{route('admin.accreditation.edit',$warranty_job['id'])}}" class="primary edit mr-1"><i class="la la-pencil"></i></a>
                                     <a class="danger delete mr-1" onclick="delete_this(`{{ $warranty_job['id'] }}`,`{{ route('admin.accreditation.destroy',$warranty_job->id) }}`)"><i class="la la-trash-o"></i></a>
                                 </td>
                             </tr>
         ...
         <div class="footers">
             ...
             <a href="{{route('admin.accreditation.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
