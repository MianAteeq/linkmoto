        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Engine Size
                </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/settings.png" style="width: 29px; margin-top: 1px;" > Engine Size
    ...
    padding-right: 0;">
        ...
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Engine Size
            </h3>
            </div>
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $car_maker['eng_size'] }}</td>

                                <td>
                                    <a href="{{route('admin.engine.size.edit',$car_maker['id'])}}" class="primary edit mr-1"><i class="la la-pencil"></i></a>
         ...
         <div class="footers">
             ...
             <a href="{{route('admin.engine.size.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
...
<script>
    function delete_this(id) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    window.location.href = "{{ url('admin/engine/size/destroy/')}}/" + id;
                } else {
