        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"> <a style="color: black" href="{{route('admin.users')}}">Users</a> </li>
    ...
    padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('admin.user.edit',$account['id'])}}"><i class="ft-edit"></i></a> <a href="{{route('admin.user.view',$account['id'])}}"><i class="ft-eye"></i></a></td>
                            </tr>
         ...
         <div class="footers">
             ...
             <a href="{{route('admin.user.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
