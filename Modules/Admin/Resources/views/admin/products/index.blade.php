        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a style="color: black" href="{{route('admin.products')}}">Products</a>
                </li>
    ...
    padding-right: 0;">
        ...
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Products</h3>
            </div>
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                             ...
                             <tr>
                                ...
                                <td class="text-center">Service Provider App</td>
                                <td class="text-center">Active</td>

                            </tr>
                             <tr>
                                <td class="text-center">2</td>
                                <td class="text-center">Service Provider Hub App</td>
                                <td class="text-center">Active</td>

                            </tr>
                             <tr>
                                <td class="text-center">3</td>
                                <td class="text-center">Business Manager</td>
                                <td class="text-center">Active</td>
