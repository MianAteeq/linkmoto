...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/settings.png" style="width: 29px; margin-top: 1px;" > Product settings
        </h4>
    ...
    padding-right: 0;">
        ...
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Plans</h3>
            </div>
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td class="text-center">{{ Str::ucfirst($package['time']) }}</td>
                                 <td class="text-center">£ {{ $package['price'] }}</td>
                                 <td>
                                     <a href="{{route('admin.package.edit',$package['id'])}}" class="primary edit mr-1"><i class="la la-pencil"></i></a>
                                     <a class="danger delete mr-1" onclick="delete_this('{{$package->id}}')" ><i class="la la-trash-o"></i></a>
                                 </td>
                             </tr>
                             @endforeach
         ...
         <div class="footers">
             ...
             <a href="{{route('admin.package.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
