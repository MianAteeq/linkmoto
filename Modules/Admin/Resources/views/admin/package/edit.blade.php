        ...
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           ...
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Edit New Plans
                </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/settings.png" style="width: 22px;margin-top: -5px;" > Edit Plan
        </h4>
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
         ...
         <form action="{{route('admin.package.update')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
            <div class="link-body"  style="padding: 10px">

                <input type="hidden" name="package_id" value="{{$package['id']}}">
                <input type="hidden" name="stripe_package_id" value="{{$package['stripe_package_id']}}">
                <input type="hidden" name="stripe_price_id" value="{{$package['stripe_price_id']}}">
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-4 label-control" for="eventRegInput5">Package Name *</label>
                            <div class="col-md-8 mx-auto">
                                <input type="text" id="name" class="form-control" value="{{$package['name']}}" onkeyup="lookup(this);" name="name" placeholder="Package Name" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mx-auto">
                                <input type="text" id="sub_title" class="form-control" value="{{$package['sub_title']}}" onkeyup="lookup(this);" name="sub_title" placeholder="Package Sub Title" required>
                                <p class="text-danger name" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mx-auto">
                                <input type="text" id="price" class="form-control" value="{{$package['price']}}" onkeyup="lookup(this);" name="price" placeholder="Package price" required>
                                <p class="text-danger name" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mx-auto">
                                <select class="form-control" name="time" required>
                                    <option value="day" @if($package['time']=="day") selected  @endif>Day</option>
                                    <option value="month" @if($package['time']=="month") selected  @endif>Monthly</option>
                                    <option value="quarter" @if($package['time']=="quarter") selected  @endif>3 Month</option>
                                    <option value="semiannual" @if($package['time']=="semiannual") selected  @endif>6 Month</option>
                                    <option value="year" @if($package['time']=="year") selected  @endif>1 Year</option>
                                </select>
                                <p class="text-danger name" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mx-auto">
                                <input type="number" name="commission" value="{{$package['commission']}}" class="form-control currency-inputmask" onkeyup="lookup(this);" placeholder="Invoice Commissions" required>
                                <p class="text-danger name" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mx-auto">
                                <textarea type="text" name="description" class="form-control currency-inputmask" onkeyup="lookup(this);" placeholder="Description" required>{{$package['description']}}</textarea>
                                <p class="text-danger name" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mx-auto">
                                <input type="checkbox" name="is_repair_app" value="1" class="toggle-two" @if($package['is_repair_app']==1) checked @endif>
                                <p class="text-danger name" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mx-auto">
                                <input type="checkbox" name="is_hub" value="1" class="toggle-two" @if($package['is_hub']==1) checked @endif>
                                <p class="text-danger name" style="padding-left: 10px;width:100%;display: none;margin-bottom: -8px;">This Field  is Required !</p>
                            </div>
                        </div>
                                    ...
                                    <tbody id="TextBoxContainer">
                                        @foreach ($package['features'] as $key=> $feature)
                                            <tr>
                                                ...
                                                <td><input type="text" style="width: 93%;" name="feature_name[{{ $key }}]" value="{{ $feature['name'] }}" class="form-control" placeholder="Name" required></td>
                                                <td><input type="checkbox" name="feature_status[{{ $key }}]" value="1" class="toggle-two" @if($feature['status']==1 ) checked  @endif ></td>
                                                <td><button type="button" style="margin-bottom: 0px !important;" class="btn btn-danger remove mb-2">-</button></td>
                                            </tr>
            ...
            <div class="footers">
                ...
                <button type="submit" class="btn btn-dark round btn-min-width mr-1 mb-1" style="float: right;">UPDATE</button>
