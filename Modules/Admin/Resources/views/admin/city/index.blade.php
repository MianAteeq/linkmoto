...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/settings.png" style="width: 29px; margin-top: 1px;" > City/Towns
    ...
    padding-right: 0;">
        ...
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">City/Towns
            </h3>
            </div>
                     ...
                     <table class="table table-striped table-bordered zero-configuration">
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.city.edit',$car_maker['id'])}}" class="primary edit mr-1"><i class="la la-pencil"></i></a>
         ...
         <div class="footers">
             ...
             <a href="{{route('admin.city.add')}}">  <button type="button" class="btn btn-dark round btn-min-width mr-1 mb-1"
...
<script>
    function delete_this(id) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    window.location.href = "{{ url('admin/city/destroy/')}}/" + id;
                } else {
