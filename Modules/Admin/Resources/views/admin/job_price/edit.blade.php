...
<div class="content-header bg-white" >
    <div  class="row" style="border-bottom: 3px solid #949494;">
        <div class="col-xl-12 col-12 bg-white headerbg" style="padding-left: 32px;padding-top: 13px;">
           <h3 class="h3">Job Coverages</h3>
           <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a style="color: black" href="{{route('admin.ref.data')}}">Product settings</a>
                </li>
                <li class="breadcrumb-item"><a style="color: black" href="{{route('admin.job.price')}}">Job Coverages</a>
                </li>




                <li class="breadcrumb-item">Edit Job Coverages
                </li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <img src="/settings.png" style="width: 22px;margin-top: -5px;" > Edit Job Coverages
        </h4>
    ...
    <div class="col-md-9"  style="border: 2px solid black;border-radius: 6px;margin-bottom: 10px;padding-left: 0;padding-right: 0;">
        <div class="row" style="margin-right: 0;margin-left: 0;">
            <div class="col-md-12" style="border-bottom: 2px solid black;">
             <h3 style="font-size: 20px; padding: 10px; margin-left: -11px; color: black;padding-bottom: 0px;">Job Coverages information</h3>
            </div>


         </div>
         <form action="{{route('admin.job.price.update')}}" id="contens" method="POST" enctype="multipart/form-data" id="contens"> @csrf
            <div class="link-body"  style="padding: 10px">

                <input type="hidden" name="id" value="{{$price_type['id']}}">
                <div class="form-group row">
                    <label class="col-md-4 label-control" for="eventRegInput5">Name *</label>
                    <div class="col-md-8 mx-auto">
                        <input type="text" id="name" class="form-control" value="{{$price_type['name']}}" onkeyup="lookup(this);" name="name" placeholder="Name">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mx-auto">
                        <textarea type="text" id="description" class="form-control" value=""  name="description" placeholder="Description ">{{$price_type['description']}}</textarea>
