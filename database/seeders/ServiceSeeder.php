    ...
    public function run()
    {
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => 0]);
            } else {

                $mots = Services::where('name', 'MOT')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Servicing')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Checks & Inspection')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Diagnostic
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Diagnostic')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Bodywork Repair
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Bodywork Repair')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Tyres')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Allow Wheels
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Allow Wheels')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Detailing
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Detailing')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Interior')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Glass & Window
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Glass & Window')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Breakdown & Recovery
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Breakdown & Recovery')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Warranty Job')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Car Wash & Valet
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Car Wash & Valet')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Performance & Tuning
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Performance & Tuning')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Securiy
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Securiy')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Audio & Sound
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Audio & Sound')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        // Keys
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Keys')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Electrical')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
        ...
        foreach ($mot_Array as $key => $mot) {
            ...
            if ($key == 0) {
                ...
                $mots = Services::where('name', 'Mechanical Repair')->first();
                $role = Services::create(['name' => $mot['val0'], 'parent_id' => $mots['id']]);
            }
        }
    }
